...
const Surb = () => {
  ...
  const categories = [
    { title: "Hospital Scrubs", img: "https://www.indosurgicals.com/images/categories/hospital-scrubs-manufacturer.jpg", link: "#" },
    { title: "Surgeon & Patient Gown", img: "https://www.indosurgicals.com/images/categories/surgeon-patient-gown-manufacturer.jpg", link: "#" },
    { title: "Hospital Uniforms & Dresses", img: "https://www.indosurgicals.com/images/categories/other-hospital-uniforms-dresses.jpg", link: "#" },
    { title: "Hospital Bed Sheets", img: "https://www.indosurgicals.com/images/categories/hospital-bed-sheets.jpg", link: "#" },
    { title: "Patient Identification Wristbands", img: "https://www.indosurgicals.com/images/categories/patient-identification-wristbands.jpg", link: "#" },
    { title: "Medical Drape Sheets", img: "https://www.indosurgicals.com/images/categories/medical-drape-sheets.jpg", link: "#" },
    { title: "Pillow & Pillow Cover", img: "https://www.indosurgicals.com/images/categories/hospital-pillow-and-cover.jpg", link: "#" },
    { title: "Operation Theatre Towels", img: "https://www.indosurgicals.com/images/categories/operation-theatre-towels.jpg", link: "#" },
  ];
    ...
    <div className="max-w-7xl mx-auto p-4 font-sans text-gray-800">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        {categories.map((item, index) => (
          <div key={index} className="group border rounded-lg overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300">

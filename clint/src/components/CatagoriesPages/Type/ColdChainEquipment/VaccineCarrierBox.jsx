...
const VaccineCarrierBox = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'VACCINECARRIERBOX_01',
            name: ' Vaccine Carrier Box Basic',
            category: ' Vaccine Carrier Box',
            description: 'High quality and reliable  Vaccine Carrier Box designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'VACCINECARRIERBOX_01'
        },
        {
            id: 'VACCINECARRIERBOX_02',
            name: ' Vaccine Carrier Box Premium',
            category: ' Vaccine Carrier Box',
            description: 'Advanced  Vaccine Carrier Box with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'VACCINECARRIERBOX_02'
        },
        {
            id: 'VACCINECARRIERBOX_03',
            name: ' Vaccine Carrier Box Professional',
            category: ' Vaccine Carrier Box',
            description: 'Industry-standard  Vaccine Carrier Box for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'VACCINECARRIERBOX_03'
        },
        {
            id: 'VACCINECARRIERBOX_04',
            name: ' Vaccine Carrier Box Economy',
            category: ' Vaccine Carrier Box',
            description: 'Cost-effective  Vaccine Carrier Box solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'VACCINECARRIERBOX_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Vaccine Carrier Box</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Vaccine Carrier Box?</h3>
...
export default VaccineCarrierBox;

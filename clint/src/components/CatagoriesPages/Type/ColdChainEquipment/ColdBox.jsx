...
const ColdBox = () => {
    ...
    const mockProducts = [
        {
            ...
            name: ' Cold Box Basic',
            category: ' Cold Box',
            description: 'High quality and reliable  Cold Box designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'COLDBOX_02',
            name: ' Cold Box Premium',
            category: ' Cold Box',
            description: 'Advanced  Cold Box with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'COLDBOX_02'
        },
        {
            id: 'COLDBOX_03',
            name: ' Cold Box Professional',
            category: ' Cold Box',
            description: 'Industry-standard  Cold Box for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'COLDBOX_03'
        },
        {
            id: 'COLDBOX_04',
            name: ' Cold Box Economy',
            category: ' Cold Box',
            description: 'Cost-effective  Cold Box solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'COLDBOX_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Cold Box</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Cold Box?</h3>

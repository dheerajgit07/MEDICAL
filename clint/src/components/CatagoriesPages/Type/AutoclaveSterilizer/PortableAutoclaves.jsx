...
const PortableAutoclaves = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'PORTABLEAUTOCLAVES_01',
            name: ' Portable Autoclaves Basic',
            category: ' Portable Autoclaves',
            description: 'High quality and reliable  Portable Autoclaves designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PORTABLEAUTOCLAVES_01'
        },
        {
            id: 'PORTABLEAUTOCLAVES_02',
            name: ' Portable Autoclaves Premium',
            category: ' Portable Autoclaves',
            description: 'Advanced  Portable Autoclaves with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PORTABLEAUTOCLAVES_02'
        },
        {
            id: 'PORTABLEAUTOCLAVES_03',
            name: ' Portable Autoclaves Professional',
            category: ' Portable Autoclaves',
            description: 'Industry-standard  Portable Autoclaves for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PORTABLEAUTOCLAVES_03'
        },
        {
            id: 'PORTABLEAUTOCLAVES_04',
            name: ' Portable Autoclaves Economy',
            category: ' Portable Autoclaves',
            description: 'Cost-effective  Portable Autoclaves solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PORTABLEAUTOCLAVES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Portable Autoclaves</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Portable Autoclaves?</h3>
...
export default PortableAutoclaves;

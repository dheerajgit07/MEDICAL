...
const VerticalAutoclaves = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'VERTICALAUTOCLAVES_01',
            name: ' Vertical Autoclaves Basic',
            category: ' Vertical Autoclaves',
            description: 'High quality and reliable  Vertical Autoclaves designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'VERTICALAUTOCLAVES_01'
        },
        {
            id: 'VERTICALAUTOCLAVES_02',
            name: ' Vertical Autoclaves Premium',
            category: ' Vertical Autoclaves',
            description: 'Advanced  Vertical Autoclaves with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'VERTICALAUTOCLAVES_02'
        },
        {
            id: 'VERTICALAUTOCLAVES_03',
            name: ' Vertical Autoclaves Professional',
            category: ' Vertical Autoclaves',
            description: 'Industry-standard  Vertical Autoclaves for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'VERTICALAUTOCLAVES_03'
        },
        {
            id: 'VERTICALAUTOCLAVES_04',
            name: ' Vertical Autoclaves Economy',
            category: ' Vertical Autoclaves',
            description: 'Cost-effective  Vertical Autoclaves solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'VERTICALAUTOCLAVES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Vertical Autoclaves</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Vertical Autoclaves?</h3>
...
export default VerticalAutoclaves;

...
const HorizontalAutoclaves = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'HORIZONTALAUTOCLAVES_01',
            name: ' Horizontal Autoclaves Basic',
            category: ' Horizontal Autoclaves',
            description: 'High quality and reliable  Horizontal Autoclaves designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'HORIZONTALAUTOCLAVES_01'
        },
        {
            id: 'HORIZONTALAUTOCLAVES_02',
            name: ' Horizontal Autoclaves Premium',
            category: ' Horizontal Autoclaves',
            description: 'Advanced  Horizontal Autoclaves with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HORIZONTALAUTOCLAVES_02'
        },
        {
            id: 'HORIZONTALAUTOCLAVES_03',
            name: ' Horizontal Autoclaves Professional',
            category: ' Horizontal Autoclaves',
            description: 'Industry-standard  Horizontal Autoclaves for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HORIZONTALAUTOCLAVES_03'
        },
        {
            id: 'HORIZONTALAUTOCLAVES_04',
            name: ' Horizontal Autoclaves Economy',
            category: ' Horizontal Autoclaves',
            description: 'Cost-effective  Horizontal Autoclaves solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HORIZONTALAUTOCLAVES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Horizontal Autoclaves</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Horizontal Autoclaves?</h3>
...
export default HorizontalAutoclaves;

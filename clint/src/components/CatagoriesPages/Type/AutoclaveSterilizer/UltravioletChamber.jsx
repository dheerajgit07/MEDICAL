...
const UltravioletChamber = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'ULTRAVIOLETCHAMBER_01',
            name: ' Ultraviolet Chamber Basic',
            category: ' Ultraviolet Chamber',
            description: 'High quality and reliable  Ultraviolet Chamber designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'ULTRAVIOLETCHAMBER_01'
        },
        {
            id: 'ULTRAVIOLETCHAMBER_02',
            name: ' Ultraviolet Chamber Premium',
            category: ' Ultraviolet Chamber',
            description: 'Advanced  Ultraviolet Chamber with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ULTRAVIOLETCHAMBER_02'
        },
        {
            id: 'ULTRAVIOLETCHAMBER_03',
            name: ' Ultraviolet Chamber Professional',
            category: ' Ultraviolet Chamber',
            description: 'Industry-standard  Ultraviolet Chamber for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ULTRAVIOLETCHAMBER_03'
        },
        {
            id: 'ULTRAVIOLETCHAMBER_04',
            name: ' Ultraviolet Chamber Economy',
            category: ' Ultraviolet Chamber',
            description: 'Cost-effective  Ultraviolet Chamber solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ULTRAVIOLETCHAMBER_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Ultraviolet Chamber</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Ultraviolet Chamber?</h3>
...
export default UltravioletChamber;

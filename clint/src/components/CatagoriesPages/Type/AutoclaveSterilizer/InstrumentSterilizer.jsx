...
const InstrumentSterilizer = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'INSTRUMENTSTERILIZER_01',
            name: ' Instrument Sterilizer Basic',
            category: ' Instrument Sterilizer',
            description: 'High quality and reliable  Instrument Sterilizer designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'INSTRUMENTSTERILIZER_01'
        },
        {
            id: 'INSTRUMENTSTERILIZER_02',
            name: ' Instrument Sterilizer Premium',
            category: ' Instrument Sterilizer',
            description: 'Advanced  Instrument Sterilizer with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'INSTRUMENTSTERILIZER_02'
        },
        {
            id: 'INSTRUMENTSTERILIZER_03',
            name: ' Instrument Sterilizer Professional',
            category: ' Instrument Sterilizer',
            description: 'Industry-standard  Instrument Sterilizer for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'INSTRUMENTSTERILIZER_03'
        },
        {
            id: 'INSTRUMENTSTERILIZER_04',
            name: ' Instrument Sterilizer Economy',
            category: ' Instrument Sterilizer',
            description: 'Cost-effective  Instrument Sterilizer solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'INSTRUMENTSTERILIZER_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Instrument Sterilizer</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Instrument Sterilizer?</h3>
...
export default InstrumentSterilizer;

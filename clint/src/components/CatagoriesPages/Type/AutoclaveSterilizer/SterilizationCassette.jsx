...
const SterilizationCassette = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'STERILIZATIONCASSETTE_01',
            name: ' Sterilization Cassette Basic',
            category: ' Sterilization Cassette',
            description: 'High quality and reliable  Sterilization Cassette designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'STERILIZATIONCASSETTE_01'
        },
        {
            id: 'STERILIZATIONCASSETTE_02',
            name: ' Sterilization Cassette Premium',
            category: ' Sterilization Cassette',
            description: 'Advanced  Sterilization Cassette with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'STERILIZATIONCASSETTE_02'
        },
        {
            id: 'STERILIZATIONCASSETTE_03',
            name: ' Sterilization Cassette Professional',
            category: ' Sterilization Cassette',
            description: 'Industry-standard  Sterilization Cassette for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'STERILIZATIONCASSETTE_03'
        },
        {
            id: 'STERILIZATIONCASSETTE_04',
            name: ' Sterilization Cassette Economy',
            category: ' Sterilization Cassette',
            description: 'Cost-effective  Sterilization Cassette solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'STERILIZATIONCASSETTE_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Sterilization Cassette</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Sterilization Cassette?</h3>
...
export default SterilizationCassette;

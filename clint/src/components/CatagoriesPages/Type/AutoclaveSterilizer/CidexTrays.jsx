...
const CidexTrays = () => {
    ...
    const mockProducts = [
        {
            id: 'CIDEXTRAYS_01',
            name: ' Cidex Trays Basic',
            category: ' Cidex Trays',
            description: 'High quality and reliable  Cidex Trays designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'CIDEXTRAYS_02',
            name: ' Cidex Trays Premium',
            category: ' Cidex Trays',
            description: 'Advanced  Cidex Trays with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CIDEXTRAYS_02'
        },
        {
            id: 'CIDEXTRAYS_03',
            name: ' Cidex Trays Professional',
            category: ' Cidex Trays',
            description: 'Industry-standard  Cidex Trays for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CIDEXTRAYS_03'
        },
        {
            id: 'CIDEXTRAYS_04',
            name: ' Cidex Trays Economy',
            category: ' Cidex Trays',
            description: 'Cost-effective  Cidex Trays solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CIDEXTRAYS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Cidex Trays</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Cidex Trays?</h3>

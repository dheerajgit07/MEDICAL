...
const DressingDrums = () => {
    ...
    const mockProducts = [
        {
            id: 'DRESSINGDRUMS_01',
            name: ' Dressing Drums Basic',
            category: ' Dressing Drums',
            description: 'High quality and reliable  Dressing Drums designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'DRESSINGDRUMS_01'
        },
        {
            id: 'DRESSINGDRUMS_02',
            name: ' Dressing Drums Premium',
            category: ' Dressing Drums',
            description: 'Advanced  Dressing Drums with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DRESSINGDRUMS_02'
        },
        {
            id: 'DRESSINGDRUMS_03',
            name: ' Dressing Drums Professional',
            category: ' Dressing Drums',
            description: 'Industry-standard  Dressing Drums for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DRESSINGDRUMS_03'
        },
        {
            id: 'DRESSINGDRUMS_04',
            name: ' Dressing Drums Economy',
            category: ' Dressing Drums',
            description: 'Cost-effective  Dressing Drums solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DRESSINGDRUMS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Dressing Drums</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Dressing Drums?</h3>

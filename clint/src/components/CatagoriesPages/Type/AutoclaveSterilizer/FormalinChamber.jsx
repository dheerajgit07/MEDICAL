...
const FormalinChamber = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'FORMALINCHAMBER_01',
            name: ' Formalin Chamber Basic',
            category: ' Formalin Chamber',
            description: 'High quality and reliable  Formalin Chamber designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'FORMALINCHAMBER_01'
        },
        {
            id: 'FORMALINCHAMBER_02',
            name: ' Formalin Chamber Premium',
            category: ' Formalin Chamber',
            description: 'Advanced  Formalin Chamber with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'FORMALINCHAMBER_02'
        },
        {
            id: 'FORMALINCHAMBER_03',
            name: ' Formalin Chamber Professional',
            category: ' Formalin Chamber',
            description: 'Industry-standard  Formalin Chamber for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'FORMALINCHAMBER_03'
        },
        {
            id: 'FORMALINCHAMBER_04',
            name: ' Formalin Chamber Economy',
            category: ' Formalin Chamber',
            description: 'Cost-effective  Formalin Chamber solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'FORMALINCHAMBER_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Formalin Chamber</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Formalin Chamber?</h3>
...
export default FormalinChamber;

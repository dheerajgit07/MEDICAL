...
const DentalAutoclaves = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'DENTALAUTOCLAVES_01',
            name: ' Dental Autoclaves Basic',
            category: ' Dental Autoclaves',
            description: 'High quality and reliable  Dental Autoclaves designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'DENTALAUTOCLAVES_01'
        },
        {
            id: 'DENTALAUTOCLAVES_02',
            name: ' Dental Autoclaves Premium',
            category: ' Dental Autoclaves',
            description: 'Advanced  Dental Autoclaves with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DENTALAUTOCLAVES_02'
        },
        {
            id: 'DENTALAUTOCLAVES_03',
            name: ' Dental Autoclaves Professional',
            category: ' Dental Autoclaves',
            description: 'Industry-standard  Dental Autoclaves for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DENTALAUTOCLAVES_03'
        },
        {
            id: 'DENTALAUTOCLAVES_04',
            name: ' Dental Autoclaves Economy',
            category: ' Dental Autoclaves',
            description: 'Cost-effective  Dental Autoclaves solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DENTALAUTOCLAVES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Dental Autoclaves</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Dental Autoclaves?</h3>
...
export default DentalAutoclaves;

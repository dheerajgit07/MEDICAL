...
const AutoclaveAccessories = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'AUTOCLAVEACCESSORIES_01',
            name: ' Autoclave Accessories Basic',
            category: ' Autoclave Accessories',
            description: 'High quality and reliable  Autoclave Accessories designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'AUTOCLAVEACCESSORIES_01'
        },
        {
            id: 'AUTOCLAVEACCESSORIES_02',
            name: ' Autoclave Accessories Premium',
            category: ' Autoclave Accessories',
            description: 'Advanced  Autoclave Accessories with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'AUTOCLAVEACCESSORIES_02'
        },
        {
            id: 'AUTOCLAVEACCESSORIES_03',
            name: ' Autoclave Accessories Professional',
            category: ' Autoclave Accessories',
            description: 'Industry-standard  Autoclave Accessories for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'AUTOCLAVEACCESSORIES_03'
        },
        {
            id: 'AUTOCLAVEACCESSORIES_04',
            name: ' Autoclave Accessories Economy',
            category: ' Autoclave Accessories',
            description: 'Cost-effective  Autoclave Accessories solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'AUTOCLAVEACCESSORIES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Autoclave Accessories</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Autoclave Accessories?</h3>
...
export default AutoclaveAccessories;

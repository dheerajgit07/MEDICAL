...
const TattooAutoclaves = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'TATTOOAUTOCLAVES_01',
            name: ' Tattoo Autoclaves Basic',
            category: ' Tattoo Autoclaves',
            description: 'High quality and reliable  Tattoo Autoclaves designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'TATTOOAUTOCLAVES_01'
        },
        {
            id: 'TATTOOAUTOCLAVES_02',
            name: ' Tattoo Autoclaves Premium',
            category: ' Tattoo Autoclaves',
            description: 'Advanced  Tattoo Autoclaves with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'TATTOOAUTOCLAVES_02'
        },
        {
            id: 'TATTOOAUTOCLAVES_03',
            name: ' Tattoo Autoclaves Professional',
            category: ' Tattoo Autoclaves',
            description: 'Industry-standard  Tattoo Autoclaves for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'TATTOOAUTOCLAVES_03'
        },
        {
            id: 'TATTOOAUTOCLAVES_04',
            name: ' Tattoo Autoclaves Economy',
            category: ' Tattoo Autoclaves',
            description: 'Cost-effective  Tattoo Autoclaves solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'TATTOOAUTOCLAVES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Tattoo Autoclaves</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Tattoo Autoclaves?</h3>
...
export default TattooAutoclaves;

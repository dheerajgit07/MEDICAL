...
const SitzBathTub = () => {
    ...
    const mockProducts = [
        {
            id: 'SITZBATHTUB_01',
            name: ' Sitz Bath Tub Basic',
            category: ' Sitz Bath Tub',
            description: 'High quality and reliable  Sitz Bath Tub designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'SITZBATHTUB_02',
            name: ' Sitz Bath Tub Premium',
            category: ' Sitz Bath Tub',
            description: 'Advanced  Sitz Bath Tub with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SITZBATHTUB_02'
        },
        {
            id: 'SITZBATHTUB_03',
            name: ' Sitz Bath Tub Professional',
            category: ' Sitz Bath Tub',
            description: 'Industry-standard  Sitz Bath Tub for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SITZBATHTUB_03'
        },
        {
            id: 'SITZBATHTUB_04',
            name: ' Sitz Bath Tub Economy',
            category: ' Sitz Bath Tub',
            description: 'Cost-effective  Sitz Bath Tub solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SITZBATHTUB_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Sitz Bath Tub</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Sitz Bath Tub?</h3>

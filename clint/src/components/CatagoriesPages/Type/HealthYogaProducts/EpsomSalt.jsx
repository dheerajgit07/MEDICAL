...
const EpsomSalt = () => {
    ...
    const mockProducts = [
        {
            id: 'EPSOMSALT_01',
            name: ' Epsom Salt Basic',
            category: ' Epsom Salt',
            description: 'High quality and reliable  Epsom Salt designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'EPSOMSALT_02',
            name: ' Epsom Salt Premium',
            category: ' Epsom Salt',
            description: 'Advanced  Epsom Salt with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'EPSOMSALT_02'
        },
        {
            id: 'EPSOMSALT_03',
            name: ' Epsom Salt Professional',
            category: ' Epsom Salt',
            description: 'Industry-standard  Epsom Salt for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'EPSOMSALT_03'
        },
        {
            id: 'EPSOMSALT_04',
            name: ' Epsom Salt Economy',
            category: ' Epsom Salt',
            description: 'Cost-effective  Epsom Salt solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'EPSOMSALT_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Epsom Salt</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Epsom Salt?</h3>

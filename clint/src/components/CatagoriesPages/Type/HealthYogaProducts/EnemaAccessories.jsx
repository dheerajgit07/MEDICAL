...
const EnemaAccessories = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'ENEMAACCESSORIES_01',
            name: ' Enema Accessories Basic',
            category: ' Enema Accessories',
            description: 'High quality and reliable  Enema Accessories designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'ENEMAACCESSORIES_01'
        },
        {
            id: 'ENEMAACCESSORIES_02',
            name: ' Enema Accessories Premium',
            category: ' Enema Accessories',
            description: 'Advanced  Enema Accessories with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ENEMAACCESSORIES_02'
        },
        {
            id: 'ENEMAACCESSORIES_03',
            name: ' Enema Accessories Professional',
            category: ' Enema Accessories',
            description: 'Industry-standard  Enema Accessories for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ENEMAACCESSORIES_03'
        },
        {
            id: 'ENEMAACCESSORIES_04',
            name: ' Enema Accessories Economy',
            category: ' Enema Accessories',
            description: 'Cost-effective  Enema Accessories solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ENEMAACCESSORIES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Enema Accessories</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Enema Accessories?</h3>
...
export default EnemaAccessories;

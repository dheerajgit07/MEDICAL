...
const NetiSalt = () => {
    ...
    const mockProducts = [
        {
            id: 'NETISALT_01',
            name: ' Neti Salt Basic',
            category: ' Neti Salt',
            description: 'High quality and reliable  Neti Salt designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'NETISALT_02',
            name: ' Neti Salt Premium',
            category: ' Neti Salt',
            description: 'Advanced  Neti Salt with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'NETISALT_02'
        },
        {
            id: 'NETISALT_03',
            name: ' Neti Salt Professional',
            category: ' Neti Salt',
            description: 'Industry-standard  Neti Salt for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'NETISALT_03'
        },
        {
            id: 'NETISALT_04',
            name: ' Neti Salt Economy',
            category: ' Neti Salt',
            description: 'Cost-effective  Neti Salt solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'NETISALT_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Neti Salt</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Neti Salt?</h3>

...
const NetiPot = () => {
    ...
    const mockProducts = [
        {
            ...
            name: ' Neti Pot Basic',
            category: ' Neti Pot',
            description: 'High quality and reliable  Neti Pot designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'NETIPOT_02',
            name: ' Neti Pot Premium',
            category: ' Neti Pot',
            description: 'Advanced  Neti Pot with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'NETIPOT_02'
        },
        {
            id: 'NETIPOT_03',
            name: ' Neti Pot Professional',
            category: ' Neti Pot',
            description: 'Industry-standard  Neti Pot for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'NETIPOT_03'
        },
        {
            id: 'NETIPOT_04',
            name: ' Neti Pot Economy',
            category: ' Neti Pot',
            description: 'Cost-effective  Neti Pot solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'NETIPOT_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Neti Pot</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Neti Pot?</h3>

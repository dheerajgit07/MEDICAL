...
const EnemaSyringeDoucheBulb = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'ENEMASYRINGEDOUCHEBULB_01',
            name: ' Enema Syringe Douche Bulb Basic',
            category: ' Enema Syringe Douche Bulb',
            description: 'High quality and reliable  Enema Syringe Douche Bulb designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'ENEMASYRINGEDOUCHEBULB_01'
        },
        {
            id: 'ENEMASYRINGEDOUCHEBULB_02',
            name: ' Enema Syringe Douche Bulb Premium',
            category: ' Enema Syringe Douche Bulb',
            description: 'Advanced  Enema Syringe Douche Bulb with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ENEMASYRINGEDOUCHEBULB_02'
        },
        {
            id: 'ENEMASYRINGEDOUCHEBULB_03',
            name: ' Enema Syringe Douche Bulb Professional',
            category: ' Enema Syringe Douche Bulb',
            description: 'Industry-standard  Enema Syringe Douche Bulb for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ENEMASYRINGEDOUCHEBULB_03'
        },
        {
            id: 'ENEMASYRINGEDOUCHEBULB_04',
            name: ' Enema Syringe Douche Bulb Economy',
            category: ' Enema Syringe Douche Bulb',
            description: 'Cost-effective  Enema Syringe Douche Bulb solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ENEMASYRINGEDOUCHEBULB_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Enema Syringe Douche Bulb</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Enema Syringe Douche Bulb?</h3>
...
export default EnemaSyringeDoucheBulb;

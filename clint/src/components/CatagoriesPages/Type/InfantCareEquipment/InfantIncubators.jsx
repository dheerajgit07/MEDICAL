...
const InfantIncubators = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'INFANTINCUBATORS_01',
            name: ' Infant Incubators Basic',
            category: ' Infant Incubators',
            description: 'High quality and reliable  Infant Incubators designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'INFANTINCUBATORS_01'
        },
        {
            id: 'INFANTINCUBATORS_02',
            name: ' Infant Incubators Premium',
            category: ' Infant Incubators',
            description: 'Advanced  Infant Incubators with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'INFANTINCUBATORS_02'
        },
        {
            id: 'INFANTINCUBATORS_03',
            name: ' Infant Incubators Professional',
            category: ' Infant Incubators',
            description: 'Industry-standard  Infant Incubators for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'INFANTINCUBATORS_03'
        },
        {
            id: 'INFANTINCUBATORS_04',
            name: ' Infant Incubators Economy',
            category: ' Infant Incubators',
            description: 'Cost-effective  Infant Incubators solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'INFANTINCUBATORS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Infant Incubators</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Infant Incubators?</h3>
...
export default InfantIncubators;

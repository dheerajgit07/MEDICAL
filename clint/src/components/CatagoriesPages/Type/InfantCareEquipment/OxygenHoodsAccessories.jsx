...
const OxygenHoodsAccessories = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'OXYGENHOODSACCESSORIES_01',
            name: ' Oxygen Hoods Accessories Basic',
            category: ' Oxygen Hoods Accessories',
            description: 'High quality and reliable  Oxygen Hoods Accessories designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'OXYGENHOODSACCESSORIES_01'
        },
        {
            id: 'OXYGENHOODSACCESSORIES_02',
            name: ' Oxygen Hoods Accessories Premium',
            category: ' Oxygen Hoods Accessories',
            description: 'Advanced  Oxygen Hoods Accessories with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OXYGENHOODSACCESSORIES_02'
        },
        {
            id: 'OXYGENHOODSACCESSORIES_03',
            name: ' Oxygen Hoods Accessories Professional',
            category: ' Oxygen Hoods Accessories',
            description: 'Industry-standard  Oxygen Hoods Accessories for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OXYGENHOODSACCESSORIES_03'
        },
        {
            id: 'OXYGENHOODSACCESSORIES_04',
            name: ' Oxygen Hoods Accessories Economy',
            category: ' Oxygen Hoods Accessories',
            description: 'Cost-effective  Oxygen Hoods Accessories solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OXYGENHOODSACCESSORIES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Oxygen Hoods Accessories</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Oxygen Hoods Accessories?</h3>
...
export default OxygenHoodsAccessories;

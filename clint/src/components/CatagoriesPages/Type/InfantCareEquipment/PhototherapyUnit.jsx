...
const PhototherapyUnit = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'PHOTOTHERAPYUNIT_01',
            name: ' Phototherapy Unit Basic',
            category: ' Phototherapy Unit',
            description: 'High quality and reliable  Phototherapy Unit designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PHOTOTHERAPYUNIT_01'
        },
        {
            id: 'PHOTOTHERAPYUNIT_02',
            name: ' Phototherapy Unit Premium',
            category: ' Phototherapy Unit',
            description: 'Advanced  Phototherapy Unit with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PHOTOTHERAPYUNIT_02'
        },
        {
            id: 'PHOTOTHERAPYUNIT_03',
            name: ' Phototherapy Unit Professional',
            category: ' Phototherapy Unit',
            description: 'Industry-standard  Phototherapy Unit for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PHOTOTHERAPYUNIT_03'
        },
        {
            id: 'PHOTOTHERAPYUNIT_04',
            name: ' Phototherapy Unit Economy',
            category: ' Phototherapy Unit',
            description: 'Cost-effective  Phototherapy Unit solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PHOTOTHERAPYUNIT_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Phototherapy Unit</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Phototherapy Unit?</h3>
...
export default PhototherapyUnit;

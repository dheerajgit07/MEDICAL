...
const InfantRadiantWarmer = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'INFANTRADIANTWARMER_01',
            name: ' Infant Radiant Warmer Basic',
            category: ' Infant Radiant Warmer',
            description: 'High quality and reliable  Infant Radiant Warmer designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'INFANTRADIANTWARMER_01'
        },
        {
            id: 'INFANTRADIANTWARMER_02',
            name: ' Infant Radiant Warmer Premium',
            category: ' Infant Radiant Warmer',
            description: 'Advanced  Infant Radiant Warmer with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'INFANTRADIANTWARMER_02'
        },
        {
            id: 'INFANTRADIANTWARMER_03',
            name: ' Infant Radiant Warmer Professional',
            category: ' Infant Radiant Warmer',
            description: 'Industry-standard  Infant Radiant Warmer for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'INFANTRADIANTWARMER_03'
        },
        {
            id: 'INFANTRADIANTWARMER_04',
            name: ' Infant Radiant Warmer Economy',
            category: ' Infant Radiant Warmer',
            description: 'Cost-effective  Infant Radiant Warmer solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'INFANTRADIANTWARMER_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Infant Radiant Warmer</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Infant Radiant Warmer?</h3>
...
export default InfantRadiantWarmer;

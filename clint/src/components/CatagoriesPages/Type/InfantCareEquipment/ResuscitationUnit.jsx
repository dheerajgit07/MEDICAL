...
const ResuscitationUnit = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'RESUSCITATIONUNIT_01',
            name: ' Resuscitation Unit Basic',
            category: ' Resuscitation Unit',
            description: 'High quality and reliable  Resuscitation Unit designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'RESUSCITATIONUNIT_01'
        },
        {
            id: 'RESUSCITATIONUNIT_02',
            name: ' Resuscitation Unit Premium',
            category: ' Resuscitation Unit',
            description: 'Advanced  Resuscitation Unit with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'RESUSCITATIONUNIT_02'
        },
        {
            id: 'RESUSCITATIONUNIT_03',
            name: ' Resuscitation Unit Professional',
            category: ' Resuscitation Unit',
            description: 'Industry-standard  Resuscitation Unit for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'RESUSCITATIONUNIT_03'
        },
        {
            id: 'RESUSCITATIONUNIT_04',
            name: ' Resuscitation Unit Economy',
            category: ' Resuscitation Unit',
            description: 'Cost-effective  Resuscitation Unit solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'RESUSCITATIONUNIT_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Resuscitation Unit</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Resuscitation Unit?</h3>
...
export default ResuscitationUnit;

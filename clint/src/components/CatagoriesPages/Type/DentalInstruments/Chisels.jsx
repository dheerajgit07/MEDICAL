...
const Chisels = () => {
    ...
    const mockProducts = [
        {
            ...
            name: ' Chisels Basic',
            category: ' Chisels',
            description: 'High quality and reliable  Chisels designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'CHISELS_02',
            name: ' Chisels Premium',
            category: ' Chisels',
            description: 'Advanced  Chisels with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CHISELS_02'
        },
        {
            id: 'CHISELS_03',
            name: ' Chisels Professional',
            category: ' Chisels',
            description: 'Industry-standard  Chisels for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CHISELS_03'
        },
        {
            id: 'CHISELS_04',
            name: ' Chisels Economy',
            category: ' Chisels',
            description: 'Cost-effective  Chisels solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CHISELS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Chisels</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Chisels?</h3>

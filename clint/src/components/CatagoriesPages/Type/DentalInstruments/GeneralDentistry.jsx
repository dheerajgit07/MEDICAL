...
const GeneralDentistry = () => {
    ...
    const mockProducts = [
        {
            id: 'GENERALDENTISTRY_01',
            name: ' General Dentistry Basic',
            category: ' General Dentistry',
            description: 'High quality and reliable  General Dentistry designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'GENERALDENTISTRY_01'
        },
        {
            id: 'GENERALDENTISTRY_02',
            name: ' General Dentistry Premium',
            category: ' General Dentistry',
            description: 'Advanced  General Dentistry with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GENERALDENTISTRY_02'
        },
        {
            id: 'GENERALDENTISTRY_03',
            name: ' General Dentistry Professional',
            category: ' General Dentistry',
            description: 'Industry-standard  General Dentistry for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GENERALDENTISTRY_03'
        },
        {
            id: 'GENERALDENTISTRY_04',
            name: ' General Dentistry Economy',
            category: ' General Dentistry',
            description: 'Cost-effective  General Dentistry solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GENERALDENTISTRY_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> General Dentistry</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  General Dentistry?</h3>

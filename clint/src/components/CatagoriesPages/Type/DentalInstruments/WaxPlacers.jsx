...
const WaxPlacers = () => {
    ...
    const mockProducts = [
        {
            id: 'WAXPLACERS_01',
            name: ' Wax Placers Basic',
            category: ' Wax Placers',
            description: 'High quality and reliable  Wax Placers designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'WAXPLACERS_02',
            name: ' Wax Placers Premium',
            category: ' Wax Placers',
            description: 'Advanced  Wax Placers with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WAXPLACERS_02'
        },
        {
            id: 'WAXPLACERS_03',
            name: ' Wax Placers Professional',
            category: ' Wax Placers',
            description: 'Industry-standard  Wax Placers for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WAXPLACERS_03'
        },
        {
            id: 'WAXPLACERS_04',
            name: ' Wax Placers Economy',
            category: ' Wax Placers',
            description: 'Cost-effective  Wax Placers solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WAXPLACERS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Wax Placers</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Wax Placers?</h3>

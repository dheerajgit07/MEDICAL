...
const Elevators = () => {
    ...
    const mockProducts = [
        {
            id: 'ELEVATORS_01',
            name: ' Elevators Basic',
            category: ' Elevators',
            description: 'High quality and reliable  Elevators designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'ELEVATORS_02',
            name: ' Elevators Premium',
            category: ' Elevators',
            description: 'Advanced  Elevators with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ELEVATORS_02'
        },
        {
            id: 'ELEVATORS_03',
            name: ' Elevators Professional',
            category: ' Elevators',
            description: 'Industry-standard  Elevators for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ELEVATORS_03'
        },
        {
            id: 'ELEVATORS_04',
            name: ' Elevators Economy',
            category: ' Elevators',
            description: 'Cost-effective  Elevators solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ELEVATORS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Elevators</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Elevators?</h3>

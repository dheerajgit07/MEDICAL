...
const OrthodonticsInstruments = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'ORTHODONTICSINSTRUMENTS_01',
            name: ' Orthodontics Instruments Basic',
            category: ' Orthodontics Instruments',
            description: 'High quality and reliable  Orthodontics Instruments designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'ORTHODONTICSINSTRUMENTS_01'
        },
        {
            id: 'ORTHODONTICSINSTRUMENTS_02',
            name: ' Orthodontics Instruments Premium',
            category: ' Orthodontics Instruments',
            description: 'Advanced  Orthodontics Instruments with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ORTHODONTICSINSTRUMENTS_02'
        },
        {
            id: 'ORTHODONTICSINSTRUMENTS_03',
            name: ' Orthodontics Instruments Professional',
            category: ' Orthodontics Instruments',
            description: 'Industry-standard  Orthodontics Instruments for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ORTHODONTICSINSTRUMENTS_03'
        },
        {
            id: 'ORTHODONTICSINSTRUMENTS_04',
            name: ' Orthodontics Instruments Economy',
            category: ' Orthodontics Instruments',
            description: 'Cost-effective  Orthodontics Instruments solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ORTHODONTICSINSTRUMENTS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Orthodontics Instruments</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Orthodontics Instruments?</h3>
...
export default OrthodonticsInstruments;

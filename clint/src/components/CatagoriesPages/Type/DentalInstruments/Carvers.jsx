...
const Carvers = () => {
    ...
    const mockProducts = [
        {
            ...
            name: ' Carvers Basic',
            category: ' Carvers',
            description: 'High quality and reliable  Carvers designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'CARVERS_02',
            name: ' Carvers Premium',
            category: ' Carvers',
            description: 'Advanced  Carvers with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CARVERS_02'
        },
        {
            id: 'CARVERS_03',
            name: ' Carvers Professional',
            category: ' Carvers',
            description: 'Industry-standard  Carvers for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CARVERS_03'
        },
        {
            id: 'CARVERS_04',
            name: ' Carvers Economy',
            category: ' Carvers',
            description: 'Cost-effective  Carvers solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CARVERS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Carvers</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Carvers?</h3>

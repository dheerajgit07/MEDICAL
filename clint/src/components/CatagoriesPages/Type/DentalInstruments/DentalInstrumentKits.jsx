...
const DentalInstrumentKits = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'DENTALINSTRUMENTKITS_01',
            name: ' Dental Instrument Kits Basic',
            category: ' Dental Instrument Kits',
            description: 'High quality and reliable  Dental Instrument Kits designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'DENTALINSTRUMENTKITS_01'
        },
        {
            id: 'DENTALINSTRUMENTKITS_02',
            name: ' Dental Instrument Kits Premium',
            category: ' Dental Instrument Kits',
            description: 'Advanced  Dental Instrument Kits with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DENTALINSTRUMENTKITS_02'
        },
        {
            id: 'DENTALINSTRUMENTKITS_03',
            name: ' Dental Instrument Kits Professional',
            category: ' Dental Instrument Kits',
            description: 'Industry-standard  Dental Instrument Kits for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DENTALINSTRUMENTKITS_03'
        },
        {
            id: 'DENTALINSTRUMENTKITS_04',
            name: ' Dental Instrument Kits Economy',
            category: ' Dental Instrument Kits',
            description: 'Cost-effective  Dental Instrument Kits solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DENTALINSTRUMENTKITS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Dental Instrument Kits</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Dental Instrument Kits?</h3>
...
export default DentalInstrumentKits;

...
const Curettes = () => {
    ...
    const mockProducts = [
        {
            ...
            name: ' Curettes Basic',
            category: ' Curettes',
            description: 'High quality and reliable  Curettes designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'CURETTES_02',
            name: ' Curettes Premium',
            category: ' Curettes',
            description: 'Advanced  Curettes with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CURETTES_02'
        },
        {
            id: 'CURETTES_03',
            name: ' Curettes Professional',
            category: ' Curettes',
            description: 'Industry-standard  Curettes for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CURETTES_03'
        },
        {
            id: 'CURETTES_04',
            name: ' Curettes Economy',
            category: ' Curettes',
            description: 'Cost-effective  Curettes solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CURETTES_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Curettes</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Curettes?</h3>

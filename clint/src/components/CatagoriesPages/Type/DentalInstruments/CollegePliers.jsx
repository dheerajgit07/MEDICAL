...
const CollegePliers = () => {
    ...
    const mockProducts = [
        {
            id: 'COLLEGEPLIERS_01',
            name: ' College Pliers Basic',
            category: ' College Pliers',
            description: 'High quality and reliable  College Pliers designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'COLLEGEPLIERS_01'
        },
        {
            id: 'COLLEGEPLIERS_02',
            name: ' College Pliers Premium',
            category: ' College Pliers',
            description: 'Advanced  College Pliers with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'COLLEGEPLIERS_02'
        },
        {
            id: 'COLLEGEPLIERS_03',
            name: ' College Pliers Professional',
            category: ' College Pliers',
            description: 'Industry-standard  College Pliers for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'COLLEGEPLIERS_03'
        },
        {
            id: 'COLLEGEPLIERS_04',
            name: ' College Pliers Economy',
            category: ' College Pliers',
            description: 'Cost-effective  College Pliers solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'COLLEGEPLIERS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> College Pliers</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  College Pliers?</h3>

...
const Syringes = () => {
    ...
    const mockProducts = [
        {
            ...
            name: ' Syringes Basic',
            category: ' Syringes',
            description: 'High quality and reliable  Syringes designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'SYRINGES_02',
            name: ' Syringes Premium',
            category: ' Syringes',
            description: 'Advanced  Syringes with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SYRINGES_02'
        },
        {
            id: 'SYRINGES_03',
            name: ' Syringes Professional',
            category: ' Syringes',
            description: 'Industry-standard  Syringes for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SYRINGES_03'
        },
        {
            id: 'SYRINGES_04',
            name: ' Syringes Economy',
            category: ' Syringes',
            description: 'Cost-effective  Syringes solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SYRINGES_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Syringes</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Syringes?</h3>

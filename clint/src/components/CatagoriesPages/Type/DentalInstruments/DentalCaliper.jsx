...
const DentalCaliper = () => {
    ...
    const mockProducts = [
        {
            id: 'DENTALCALIPER_01',
            name: ' Dental Caliper Basic',
            category: ' Dental Caliper',
            description: 'High quality and reliable  Dental Caliper designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'DENTALCALIPER_01'
        },
        {
            id: 'DENTALCALIPER_02',
            name: ' Dental Caliper Premium',
            category: ' Dental Caliper',
            description: 'Advanced  Dental Caliper with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DENTALCALIPER_02'
        },
        {
            id: 'DENTALCALIPER_03',
            name: ' Dental Caliper Professional',
            category: ' Dental Caliper',
            description: 'Industry-standard  Dental Caliper for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DENTALCALIPER_03'
        },
        {
            id: 'DENTALCALIPER_04',
            name: ' Dental Caliper Economy',
            category: ' Dental Caliper',
            description: 'Cost-effective  Dental Caliper solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DENTALCALIPER_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Dental Caliper</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Dental Caliper?</h3>

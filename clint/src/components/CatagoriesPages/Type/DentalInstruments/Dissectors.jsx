...
const Dissectors = () => {
    ...
    const mockProducts = [
        {
            id: 'DISSECTORS_01',
            name: ' Dissectors Basic',
            category: ' Dissectors',
            description: 'High quality and reliable  Dissectors designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'DISSECTORS_02',
            name: ' Dissectors Premium',
            category: ' Dissectors',
            description: 'Advanced  Dissectors with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DISSECTORS_02'
        },
        {
            id: 'DISSECTORS_03',
            name: ' Dissectors Professional',
            category: ' Dissectors',
            description: 'Industry-standard  Dissectors for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DISSECTORS_03'
        },
        {
            id: 'DISSECTORS_04',
            name: ' Dissectors Economy',
            category: ' Dissectors',
            description: 'Cost-effective  Dissectors solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DISSECTORS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Dissectors</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Dissectors?</h3>

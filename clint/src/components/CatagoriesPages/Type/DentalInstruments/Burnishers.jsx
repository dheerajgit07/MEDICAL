...
const Burnishers = () => {
    ...
    const mockProducts = [
        {
            id: 'BURNISHERS_01',
            name: ' Burnishers Basic',
            category: ' Burnishers',
            description: 'High quality and reliable  Burnishers designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'BURNISHERS_02',
            name: ' Burnishers Premium',
            category: ' Burnishers',
            description: 'Advanced  Burnishers with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BURNISHERS_02'
        },
        {
            id: 'BURNISHERS_03',
            name: ' Burnishers Professional',
            category: ' Burnishers',
            description: 'Industry-standard  Burnishers for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BURNISHERS_03'
        },
        {
            id: 'BURNISHERS_04',
            name: ' Burnishers Economy',
            category: ' Burnishers',
            description: 'Cost-effective  Burnishers solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BURNISHERS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Burnishers</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Burnishers?</h3>

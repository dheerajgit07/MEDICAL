...
const CordPackers = () => {
    ...
    const mockProducts = [
        {
            id: 'CORDPACKERS_01',
            name: ' Cord Packers Basic',
            category: ' Cord Packers',
            description: 'High quality and reliable  Cord Packers designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'CORDPACKERS_02',
            name: ' Cord Packers Premium',
            category: ' Cord Packers',
            description: 'Advanced  Cord Packers with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CORDPACKERS_02'
        },
        {
            id: 'CORDPACKERS_03',
            name: ' Cord Packers Professional',
            category: ' Cord Packers',
            description: 'Industry-standard  Cord Packers for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CORDPACKERS_03'
        },
        {
            id: 'CORDPACKERS_04',
            name: ' Cord Packers Economy',
            category: ' Cord Packers',
            description: 'Cost-effective  Cord Packers solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CORDPACKERS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Cord Packers</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Cord Packers?</h3>

...
const DentalExtractionForceps = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'DENTALEXTRACTIONFORCEPS_01',
            name: ' Dental Extraction Forceps Basic',
            category: ' Dental Extraction Forceps',
            description: 'High quality and reliable  Dental Extraction Forceps designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'DENTALEXTRACTIONFORCEPS_01'
        },
        {
            id: 'DENTALEXTRACTIONFORCEPS_02',
            name: ' Dental Extraction Forceps Premium',
            category: ' Dental Extraction Forceps',
            description: 'Advanced  Dental Extraction Forceps with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DENTALEXTRACTIONFORCEPS_02'
        },
        {
            id: 'DENTALEXTRACTIONFORCEPS_03',
            name: ' Dental Extraction Forceps Professional',
            category: ' Dental Extraction Forceps',
            description: 'Industry-standard  Dental Extraction Forceps for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DENTALEXTRACTIONFORCEPS_03'
        },
        {
            id: 'DENTALEXTRACTIONFORCEPS_04',
            name: ' Dental Extraction Forceps Economy',
            category: ' Dental Extraction Forceps',
            description: 'Cost-effective  Dental Extraction Forceps solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DENTALEXTRACTIONFORCEPS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Dental Extraction Forceps</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Dental Extraction Forceps?</h3>
...
export default DentalExtractionForceps;

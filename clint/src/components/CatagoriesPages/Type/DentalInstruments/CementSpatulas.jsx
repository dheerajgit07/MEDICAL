...
const CementSpatulas = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'CEMENTSPATULAS_01',
            name: ' Cement Spatulas Basic',
            category: ' Cement Spatulas',
            description: 'High quality and reliable  Cement Spatulas designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'CEMENTSPATULAS_01'
        },
        {
            id: 'CEMENTSPATULAS_02',
            name: ' Cement Spatulas Premium',
            category: ' Cement Spatulas',
            description: 'Advanced  Cement Spatulas with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CEMENTSPATULAS_02'
        },
        {
            id: 'CEMENTSPATULAS_03',
            name: ' Cement Spatulas Professional',
            category: ' Cement Spatulas',
            description: 'Industry-standard  Cement Spatulas for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CEMENTSPATULAS_03'
        },
        {
            id: 'CEMENTSPATULAS_04',
            name: ' Cement Spatulas Economy',
            category: ' Cement Spatulas',
            description: 'Cost-effective  Cement Spatulas solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CEMENTSPATULAS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Cement Spatulas</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Cement Spatulas?</h3>

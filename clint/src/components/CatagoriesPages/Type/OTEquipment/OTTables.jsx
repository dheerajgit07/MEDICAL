...
const OTTables = () => {
    ...
    const mockProducts = [
        {
            id: 'OTTABLES_01',
            name: ' O T Tables Basic',
            category: ' O T Tables',
            description: 'High quality and reliable  O T Tables designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'OTTABLES_02',
            name: ' O T Tables Premium',
            category: ' O T Tables',
            description: 'Advanced  O T Tables with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OTTABLES_02'
        },
        {
            id: 'OTTABLES_03',
            name: ' O T Tables Professional',
            category: ' O T Tables',
            description: 'Industry-standard  O T Tables for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OTTABLES_03'
        },
        {
            id: 'OTTABLES_04',
            name: ' O T Tables Economy',
            category: ' O T Tables',
            description: 'Cost-effective  O T Tables solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OTTABLES_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> O T Tables</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  O T Tables?</h3>

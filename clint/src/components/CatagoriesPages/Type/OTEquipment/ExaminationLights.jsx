...
const ExaminationLights = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'EXAMINATIONLIGHTS_01',
            name: ' Examination Lights Basic',
            category: ' Examination Lights',
            description: 'High quality and reliable  Examination Lights designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'EXAMINATIONLIGHTS_01'
        },
        {
            id: 'EXAMINATIONLIGHTS_02',
            name: ' Examination Lights Premium',
            category: ' Examination Lights',
            description: 'Advanced  Examination Lights with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'EXAMINATIONLIGHTS_02'
        },
        {
            id: 'EXAMINATIONLIGHTS_03',
            name: ' Examination Lights Professional',
            category: ' Examination Lights',
            description: 'Industry-standard  Examination Lights for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'EXAMINATIONLIGHTS_03'
        },
        {
            id: 'EXAMINATIONLIGHTS_04',
            name: ' Examination Lights Economy',
            category: ' Examination Lights',
            description: 'Cost-effective  Examination Lights solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'EXAMINATIONLIGHTS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Examination Lights</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Examination Lights?</h3>
...
export default ExaminationLights;

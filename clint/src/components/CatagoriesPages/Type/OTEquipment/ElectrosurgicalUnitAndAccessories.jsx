...
const ElectrosurgicalUnitAndAccessories = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'ELECTROSURGICALUNITANDACCESSORIES_01',
            name: ' Electrosurgical Unit And Accessories Basic',
            category: ' Electrosurgical Unit And Accessories',
            description: 'High quality and reliable  Electrosurgical Unit And Accessories designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'ELECTROSURGICALUNITANDACCESSORIES_01'
        },
        {
            id: 'ELECTROSURGICALUNITANDACCESSORIES_02',
            name: ' Electrosurgical Unit And Accessories Premium',
            category: ' Electrosurgical Unit And Accessories',
            description: 'Advanced  Electrosurgical Unit And Accessories with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ELECTROSURGICALUNITANDACCESSORIES_02'
        },
        {
            id: 'ELECTROSURGICALUNITANDACCESSORIES_03',
            name: ' Electrosurgical Unit And Accessories Professional',
            category: ' Electrosurgical Unit And Accessories',
            description: 'Industry-standard  Electrosurgical Unit And Accessories for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ELECTROSURGICALUNITANDACCESSORIES_03'
        },
        {
            id: 'ELECTROSURGICALUNITANDACCESSORIES_04',
            name: ' Electrosurgical Unit And Accessories Economy',
            category: ' Electrosurgical Unit And Accessories',
            description: 'Cost-effective  Electrosurgical Unit And Accessories solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ELECTROSURGICALUNITANDACCESSORIES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Electrosurgical Unit And Accessories</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Electrosurgical Unit And Accessories?</h3>
...
export default ElectrosurgicalUnitAndAccessories;

...
const OTLights = () => {
    ...
    const mockProducts = [
        {
            id: 'OTLIGHTS_01',
            name: ' O T Lights Basic',
            category: ' O T Lights',
            description: 'High quality and reliable  O T Lights designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'OTLIGHTS_02',
            name: ' O T Lights Premium',
            category: ' O T Lights',
            description: 'Advanced  O T Lights with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OTLIGHTS_02'
        },
        {
            id: 'OTLIGHTS_03',
            name: ' O T Lights Professional',
            category: ' O T Lights',
            description: 'Industry-standard  O T Lights for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OTLIGHTS_03'
        },
        {
            id: 'OTLIGHTS_04',
            name: ' O T Lights Economy',
            category: ' O T Lights',
            description: 'Cost-effective  O T Lights solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OTLIGHTS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> O T Lights</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  O T Lights?</h3>

...
const DehydratedCultureMedia = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'DEHYDRATEDCULTUREMEDIA_01',
            name: ' Dehydrated Culture Media Basic',
            category: ' Dehydrated Culture Media',
            description: 'High quality and reliable  Dehydrated Culture Media designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'DEHYDRATEDCULTUREMEDIA_01'
        },
        {
            id: 'DEHYDRATEDCULTUREMEDIA_02',
            name: ' Dehydrated Culture Media Premium',
            category: ' Dehydrated Culture Media',
            description: 'Advanced  Dehydrated Culture Media with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DEHYDRATEDCULTUREMEDIA_02'
        },
        {
            id: 'DEHYDRATEDCULTUREMEDIA_03',
            name: ' Dehydrated Culture Media Professional',
            category: ' Dehydrated Culture Media',
            description: 'Industry-standard  Dehydrated Culture Media for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DEHYDRATEDCULTUREMEDIA_03'
        },
        {
            id: 'DEHYDRATEDCULTUREMEDIA_04',
            name: ' Dehydrated Culture Media Economy',
            category: ' Dehydrated Culture Media',
            description: 'Cost-effective  Dehydrated Culture Media solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DEHYDRATEDCULTUREMEDIA_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Dehydrated Culture Media</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Dehydrated Culture Media?</h3>
...
export default DehydratedCultureMedia;

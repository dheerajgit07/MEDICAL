...
const VaginalSpeculum = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'VAGINALSPECULUM_01',
            name: ' Vaginal Speculum Basic',
            category: ' Vaginal Speculum',
            description: 'High quality and reliable  Vaginal Speculum designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'VAGINALSPECULUM_01'
        },
        {
            id: 'VAGINALSPECULUM_02',
            name: ' Vaginal Speculum Premium',
            category: ' Vaginal Speculum',
            description: 'Advanced  Vaginal Speculum with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'VAGINALSPECULUM_02'
        },
        {
            id: 'VAGINALSPECULUM_03',
            name: ' Vaginal Speculum Professional',
            category: ' Vaginal Speculum',
            description: 'Industry-standard  Vaginal Speculum for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'VAGINALSPECULUM_03'
        },
        {
            id: 'VAGINALSPECULUM_04',
            name: ' Vaginal Speculum Economy',
            category: ' Vaginal Speculum',
            description: 'Cost-effective  Vaginal Speculum solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'VAGINALSPECULUM_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Vaginal Speculum</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Vaginal Speculum?</h3>
...
export default VaginalSpeculum;

...
const VacuumExtractorSetsManual = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'VACUUMEXTRACTORSETSMANUAL_01',
            name: ' Vacuum Extractor Sets Manual Basic',
            category: ' Vacuum Extractor Sets Manual',
            description: 'High quality and reliable  Vacuum Extractor Sets Manual designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'VACUUMEXTRACTORSETSMANUAL_01'
        },
        {
            id: 'VACUUMEXTRACTORSETSMANUAL_02',
            name: ' Vacuum Extractor Sets Manual Premium',
            category: ' Vacuum Extractor Sets Manual',
            description: 'Advanced  Vacuum Extractor Sets Manual with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'VACUUMEXTRACTORSETSMANUAL_02'
        },
        {
            id: 'VACUUMEXTRACTORSETSMANUAL_03',
            name: ' Vacuum Extractor Sets Manual Professional',
            category: ' Vacuum Extractor Sets Manual',
            description: 'Industry-standard  Vacuum Extractor Sets Manual for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'VACUUMEXTRACTORSETSMANUAL_03'
        },
        {
            id: 'VACUUMEXTRACTORSETSMANUAL_04',
            name: ' Vacuum Extractor Sets Manual Economy',
            category: ' Vacuum Extractor Sets Manual',
            description: 'Cost-effective  Vacuum Extractor Sets Manual solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'VACUUMEXTRACTORSETSMANUAL_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Vacuum Extractor Sets Manual</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Vacuum Extractor Sets Manual?</h3>
...
export default VacuumExtractorSetsManual;

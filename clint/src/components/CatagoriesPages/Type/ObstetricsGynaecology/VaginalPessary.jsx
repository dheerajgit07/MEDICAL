...
const VaginalPessary = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'VAGINALPESSARY_01',
            name: ' Vaginal Pessary Basic',
            category: ' Vaginal Pessary',
            description: 'High quality and reliable  Vaginal Pessary designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'VAGINALPESSARY_01'
        },
        {
            id: 'VAGINALPESSARY_02',
            name: ' Vaginal Pessary Premium',
            category: ' Vaginal Pessary',
            description: 'Advanced  Vaginal Pessary with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'VAGINALPESSARY_02'
        },
        {
            id: 'VAGINALPESSARY_03',
            name: ' Vaginal Pessary Professional',
            category: ' Vaginal Pessary',
            description: 'Industry-standard  Vaginal Pessary for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'VAGINALPESSARY_03'
        },
        {
            id: 'VAGINALPESSARY_04',
            name: ' Vaginal Pessary Economy',
            category: ' Vaginal Pessary',
            description: 'Cost-effective  Vaginal Pessary solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'VAGINALPESSARY_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Vaginal Pessary</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Vaginal Pessary?</h3>

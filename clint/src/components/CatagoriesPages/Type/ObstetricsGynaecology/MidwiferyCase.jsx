...
const MidwiferyCase = () => {
    ...
    const mockProducts = [
        {
            id: 'MIDWIFERYCASE_01',
            name: ' Midwifery Case Basic',
            category: ' Midwifery Case',
            description: 'High quality and reliable  Midwifery Case designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'MIDWIFERYCASE_01'
        },
        {
            id: 'MIDWIFERYCASE_02',
            name: ' Midwifery Case Premium',
            category: ' Midwifery Case',
            description: 'Advanced  Midwifery Case with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MIDWIFERYCASE_02'
        },
        {
            id: 'MIDWIFERYCASE_03',
            name: ' Midwifery Case Professional',
            category: ' Midwifery Case',
            description: 'Industry-standard  Midwifery Case for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MIDWIFERYCASE_03'
        },
        {
            id: 'MIDWIFERYCASE_04',
            name: ' Midwifery Case Economy',
            category: ' Midwifery Case',
            description: 'Cost-effective  Midwifery Case solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MIDWIFERYCASE_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Midwifery Case</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Midwifery Case?</h3>

...
const ElectricVacuumExtractorSet = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'ELECTRICVACUUMEXTRACTORSET_01',
            name: ' Electric Vacuum Extractor Set Basic',
            category: ' Electric Vacuum Extractor Set',
            description: 'High quality and reliable  Electric Vacuum Extractor Set designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'ELECTRICVACUUMEXTRACTORSET_01'
        },
        {
            id: 'ELECTRICVACUUMEXTRACTORSET_02',
            name: ' Electric Vacuum Extractor Set Premium',
            category: ' Electric Vacuum Extractor Set',
            description: 'Advanced  Electric Vacuum Extractor Set with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ELECTRICVACUUMEXTRACTORSET_02'
        },
        {
            id: 'ELECTRICVACUUMEXTRACTORSET_03',
            name: ' Electric Vacuum Extractor Set Professional',
            category: ' Electric Vacuum Extractor Set',
            description: 'Industry-standard  Electric Vacuum Extractor Set for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ELECTRICVACUUMEXTRACTORSET_03'
        },
        {
            id: 'ELECTRICVACUUMEXTRACTORSET_04',
            name: ' Electric Vacuum Extractor Set Economy',
            category: ' Electric Vacuum Extractor Set',
            description: 'Cost-effective  Electric Vacuum Extractor Set solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ELECTRICVACUUMEXTRACTORSET_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Electric Vacuum Extractor Set</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Electric Vacuum Extractor Set?</h3>
...
export default ElectricVacuumExtractorSet;

...
const LatexGynecologicalGloves = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'LATEXGYNECOLOGICALGLOVES_01',
            name: ' Latex Gynecological Gloves Basic',
            category: ' Latex Gynecological Gloves',
            description: 'High quality and reliable  Latex Gynecological Gloves designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'LATEXGYNECOLOGICALGLOVES_01'
        },
        {
            id: 'LATEXGYNECOLOGICALGLOVES_02',
            name: ' Latex Gynecological Gloves Premium',
            category: ' Latex Gynecological Gloves',
            description: 'Advanced  Latex Gynecological Gloves with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LATEXGYNECOLOGICALGLOVES_02'
        },
        {
            id: 'LATEXGYNECOLOGICALGLOVES_03',
            name: ' Latex Gynecological Gloves Professional',
            category: ' Latex Gynecological Gloves',
            description: 'Industry-standard  Latex Gynecological Gloves for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LATEXGYNECOLOGICALGLOVES_03'
        },
        {
            id: 'LATEXGYNECOLOGICALGLOVES_04',
            name: ' Latex Gynecological Gloves Economy',
            category: ' Latex Gynecological Gloves',
            description: 'Cost-effective  Latex Gynecological Gloves solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LATEXGYNECOLOGICALGLOVES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Latex Gynecological Gloves</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Latex Gynecological Gloves?</h3>
...
export default LatexGynecologicalGloves;

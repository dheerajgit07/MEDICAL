...
const BreastPumps = () => {
    ...
    const mockProducts = [
        {
            id: 'BREASTPUMPS_01',
            name: ' Breast Pumps Basic',
            category: ' Breast Pumps',
            description: 'High quality and reliable  Breast Pumps designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'BREASTPUMPS_02',
            name: ' Breast Pumps Premium',
            category: ' Breast Pumps',
            description: 'Advanced  Breast Pumps with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BREASTPUMPS_02'
        },
        {
            id: 'BREASTPUMPS_03',
            name: ' Breast Pumps Professional',
            category: ' Breast Pumps',
            description: 'Industry-standard  Breast Pumps for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BREASTPUMPS_03'
        },
        {
            id: 'BREASTPUMPS_04',
            name: ' Breast Pumps Economy',
            category: ' Breast Pumps',
            description: 'Cost-effective  Breast Pumps solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BREASTPUMPS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Breast Pumps</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Breast Pumps?</h3>

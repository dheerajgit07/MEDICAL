...
const GynecologicalAspirationKitMVAKit = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'GYNECOLOGICALASPIRATIONKITMVAKIT_01',
            name: ' Gynecological Aspiration Kit M V A Kit Basic',
            category: ' Gynecological Aspiration Kit M V A Kit',
            description: 'High quality and reliable  Gynecological Aspiration Kit M V A Kit designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'GYNECOLOGICALASPIRATIONKITMVAKIT_01'
        },
        {
            id: 'GYNECOLOGICALASPIRATIONKITMVAKIT_02',
            name: ' Gynecological Aspiration Kit M V A Kit Premium',
            category: ' Gynecological Aspiration Kit M V A Kit',
            description: 'Advanced  Gynecological Aspiration Kit M V A Kit with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GYNECOLOGICALASPIRATIONKITMVAKIT_02'
        },
        {
            id: 'GYNECOLOGICALASPIRATIONKITMVAKIT_03',
            name: ' Gynecological Aspiration Kit M V A Kit Professional',
            category: ' Gynecological Aspiration Kit M V A Kit',
            description: 'Industry-standard  Gynecological Aspiration Kit M V A Kit for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GYNECOLOGICALASPIRATIONKITMVAKIT_03'
        },
        {
            id: 'GYNECOLOGICALASPIRATIONKITMVAKIT_04',
            name: ' Gynecological Aspiration Kit M V A Kit Economy',
            category: ' Gynecological Aspiration Kit M V A Kit',
            description: 'Cost-effective  Gynecological Aspiration Kit M V A Kit solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GYNECOLOGICALASPIRATIONKITMVAKIT_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Gynecological Aspiration Kit M V A Kit</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Gynecological Aspiration Kit M V A Kit?</h3>
...
export default GynecologicalAspirationKitMVAKit;

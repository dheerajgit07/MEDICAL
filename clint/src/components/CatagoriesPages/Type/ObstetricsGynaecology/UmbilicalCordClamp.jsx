...
const UmbilicalCordClamp = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'UMBILICALCORDCLAMP_01',
            name: ' Umbilical Cord Clamp Basic',
            category: ' Umbilical Cord Clamp',
            description: 'High quality and reliable  Umbilical Cord Clamp designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'UMBILICALCORDCLAMP_01'
        },
        {
            id: 'UMBILICALCORDCLAMP_02',
            name: ' Umbilical Cord Clamp Premium',
            category: ' Umbilical Cord Clamp',
            description: 'Advanced  Umbilical Cord Clamp with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'UMBILICALCORDCLAMP_02'
        },
        {
            id: 'UMBILICALCORDCLAMP_03',
            name: ' Umbilical Cord Clamp Professional',
            category: ' Umbilical Cord Clamp',
            description: 'Industry-standard  Umbilical Cord Clamp for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'UMBILICALCORDCLAMP_03'
        },
        {
            id: 'UMBILICALCORDCLAMP_04',
            name: ' Umbilical Cord Clamp Economy',
            category: ' Umbilical Cord Clamp',
            description: 'Cost-effective  Umbilical Cord Clamp solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'UMBILICALCORDCLAMP_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Umbilical Cord Clamp</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Umbilical Cord Clamp?</h3>
...
export default UmbilicalCordClamp;

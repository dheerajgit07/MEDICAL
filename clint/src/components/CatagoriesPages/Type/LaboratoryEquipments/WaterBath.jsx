...
const WaterBath = () => {
    ...
    const mockProducts = [
        {
            id: 'WATERBATH_01',
            name: ' Water Bath Basic',
            category: ' Water Bath',
            description: 'High quality and reliable  Water Bath designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'WATERBATH_02',
            name: ' Water Bath Premium',
            category: ' Water Bath',
            description: 'Advanced  Water Bath with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WATERBATH_02'
        },
        {
            id: 'WATERBATH_03',
            name: ' Water Bath Professional',
            category: ' Water Bath',
            description: 'Industry-standard  Water Bath for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WATERBATH_03'
        },
        {
            id: 'WATERBATH_04',
            name: ' Water Bath Economy',
            category: ' Water Bath',
            description: 'Cost-effective  Water Bath solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WATERBATH_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Water Bath</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Water Bath?</h3>

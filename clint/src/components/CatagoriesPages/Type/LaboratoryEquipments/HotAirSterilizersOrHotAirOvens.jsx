...
const HotAirSterilizersOrHotAirOvens = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'HOTAIRSTERILIZERSORHOTAIROVENS_01',
            name: ' Hot Air Sterilizers Or Hot Air Ovens Basic',
            category: ' Hot Air Sterilizers Or Hot Air Ovens',
            description: 'High quality and reliable  Hot Air Sterilizers Or Hot Air Ovens designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'HOTAIRSTERILIZERSORHOTAIROVENS_01'
        },
        {
            id: 'HOTAIRSTERILIZERSORHOTAIROVENS_02',
            name: ' Hot Air Sterilizers Or Hot Air Ovens Premium',
            category: ' Hot Air Sterilizers Or Hot Air Ovens',
            description: 'Advanced  Hot Air Sterilizers Or Hot Air Ovens with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOTAIRSTERILIZERSORHOTAIROVENS_02'
        },
        {
            id: 'HOTAIRSTERILIZERSORHOTAIROVENS_03',
            name: ' Hot Air Sterilizers Or Hot Air Ovens Professional',
            category: ' Hot Air Sterilizers Or Hot Air Ovens',
            description: 'Industry-standard  Hot Air Sterilizers Or Hot Air Ovens for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOTAIRSTERILIZERSORHOTAIROVENS_03'
        },
        {
            id: 'HOTAIRSTERILIZERSORHOTAIROVENS_04',
            name: ' Hot Air Sterilizers Or Hot Air Ovens Economy',
            category: ' Hot Air Sterilizers Or Hot Air Ovens',
            description: 'Cost-effective  Hot Air Sterilizers Or Hot Air Ovens solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOTAIRSTERILIZERSORHOTAIROVENS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Hot Air Sterilizers Or Hot Air Ovens</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Hot Air Sterilizers Or Hot Air Ovens?</h3>
...
export default HotAirSterilizersOrHotAirOvens;

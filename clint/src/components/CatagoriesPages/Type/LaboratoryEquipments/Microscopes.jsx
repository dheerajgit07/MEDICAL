...
const Microscopes = () => {
    ...
    const mockProducts = [
        {
            id: 'MICROSCOPES_01',
            name: ' Microscopes Basic',
            category: ' Microscopes',
            description: 'High quality and reliable  Microscopes designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'MICROSCOPES_02',
            name: ' Microscopes Premium',
            category: ' Microscopes',
            description: 'Advanced  Microscopes with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MICROSCOPES_02'
        },
        {
            id: 'MICROSCOPES_03',
            name: ' Microscopes Professional',
            category: ' Microscopes',
            description: 'Industry-standard  Microscopes for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MICROSCOPES_03'
        },
        {
            id: 'MICROSCOPES_04',
            name: ' Microscopes Economy',
            category: ' Microscopes',
            description: 'Cost-effective  Microscopes solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MICROSCOPES_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Microscopes</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Microscopes?</h3>

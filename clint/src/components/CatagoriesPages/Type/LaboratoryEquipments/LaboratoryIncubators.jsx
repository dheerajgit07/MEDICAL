...
const LaboratoryIncubators = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'LABORATORYINCUBATORS_01',
            name: ' Laboratory Incubators Basic',
            category: ' Laboratory Incubators',
            description: 'High quality and reliable  Laboratory Incubators designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'LABORATORYINCUBATORS_01'
        },
        {
            id: 'LABORATORYINCUBATORS_02',
            name: ' Laboratory Incubators Premium',
            category: ' Laboratory Incubators',
            description: 'Advanced  Laboratory Incubators with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LABORATORYINCUBATORS_02'
        },
        {
            id: 'LABORATORYINCUBATORS_03',
            name: ' Laboratory Incubators Professional',
            category: ' Laboratory Incubators',
            description: 'Industry-standard  Laboratory Incubators for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LABORATORYINCUBATORS_03'
        },
        {
            id: 'LABORATORYINCUBATORS_04',
            name: ' Laboratory Incubators Economy',
            category: ' Laboratory Incubators',
            description: 'Cost-effective  Laboratory Incubators solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LABORATORYINCUBATORS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Laboratory Incubators</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Laboratory Incubators?</h3>
...
export default LaboratoryIncubators;

...
const Centrifuge = () => {
    ...
    const mockProducts = [
        {
            ...
            category: ' Centrifuge',
            description: 'High quality and reliable  Centrifuge designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'CENTRIFUGE_02',
            name: ' Centrifuge Premium',
            category: ' Centrifuge',
            description: 'Advanced  Centrifuge with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CENTRIFUGE_02'
        },
        {
            id: 'CENTRIFUGE_03',
            name: ' Centrifuge Professional',
            category: ' Centrifuge',
            description: 'Industry-standard  Centrifuge for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CENTRIFUGE_03'
        },
        {
            id: 'CENTRIFUGE_04',
            name: ' Centrifuge Economy',
            category: ' Centrifuge',
            description: 'Cost-effective  Centrifuge solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CENTRIFUGE_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Centrifuge</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Centrifuge?</h3>

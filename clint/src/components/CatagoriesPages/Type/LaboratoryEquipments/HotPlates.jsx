...
const HotPlates = () => {
    ...
    const mockProducts = [
        {
            id: 'HOTPLATES_01',
            name: ' Hot Plates Basic',
            category: ' Hot Plates',
            description: 'High quality and reliable  Hot Plates designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'HOTPLATES_02',
            name: ' Hot Plates Premium',
            category: ' Hot Plates',
            description: 'Advanced  Hot Plates with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOTPLATES_02'
        },
        {
            id: 'HOTPLATES_03',
            name: ' Hot Plates Professional',
            category: ' Hot Plates',
            description: 'Industry-standard  Hot Plates for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOTPLATES_03'
        },
        {
            id: 'HOTPLATES_04',
            name: ' Hot Plates Economy',
            category: ' Hot Plates',
            description: 'Cost-effective  Hot Plates solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOTPLATES_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Hot Plates</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Hot Plates?</h3>

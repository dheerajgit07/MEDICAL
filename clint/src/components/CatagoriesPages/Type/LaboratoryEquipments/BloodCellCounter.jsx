...
const BloodCellCounter = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'BLOODCELLCOUNTER_01',
            name: ' Blood Cell Counter Basic',
            category: ' Blood Cell Counter',
            description: 'High quality and reliable  Blood Cell Counter designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'BLOODCELLCOUNTER_01'
        },
        {
            id: 'BLOODCELLCOUNTER_02',
            name: ' Blood Cell Counter Premium',
            category: ' Blood Cell Counter',
            description: 'Advanced  Blood Cell Counter with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BLOODCELLCOUNTER_02'
        },
        {
            id: 'BLOODCELLCOUNTER_03',
            name: ' Blood Cell Counter Professional',
            category: ' Blood Cell Counter',
            description: 'Industry-standard  Blood Cell Counter for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BLOODCELLCOUNTER_03'
        },
        {
            id: 'BLOODCELLCOUNTER_04',
            name: ' Blood Cell Counter Economy',
            category: ' Blood Cell Counter',
            description: 'Cost-effective  Blood Cell Counter solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BLOODCELLCOUNTER_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Blood Cell Counter</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Blood Cell Counter?</h3>
...
export default BloodCellCounter;

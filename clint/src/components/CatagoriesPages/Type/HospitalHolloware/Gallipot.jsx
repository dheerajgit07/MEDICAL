...
const Gallipot = () => {
    ...
    const mockProducts = [
        {
            ...
            name: ' Gallipot Basic',
            category: ' Gallipot',
            description: 'High quality and reliable  Gallipot designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'GALLIPOT_02',
            name: ' Gallipot Premium',
            category: ' Gallipot',
            description: 'Advanced  Gallipot with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GALLIPOT_02'
        },
        {
            id: 'GALLIPOT_03',
            name: ' Gallipot Professional',
            category: ' Gallipot',
            description: 'Industry-standard  Gallipot for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GALLIPOT_03'
        },
        {
            id: 'GALLIPOT_04',
            name: ' Gallipot Economy',
            category: ' Gallipot',
            description: 'Cost-effective  Gallipot solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GALLIPOT_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Gallipot</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Gallipot?</h3>

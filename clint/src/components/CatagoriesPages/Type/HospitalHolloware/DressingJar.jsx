...
const DressingJar = () => {
    ...
    const mockProducts = [
        {
            id: 'DRESSINGJAR_01',
            name: ' Dressing Jar Basic',
            category: ' Dressing Jar',
            description: 'High quality and reliable  Dressing Jar designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'DRESSINGJAR_02',
            name: ' Dressing Jar Premium',
            category: ' Dressing Jar',
            description: 'Advanced  Dressing Jar with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DRESSINGJAR_02'
        },
        {
            id: 'DRESSINGJAR_03',
            name: ' Dressing Jar Professional',
            category: ' Dressing Jar',
            description: 'Industry-standard  Dressing Jar for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DRESSINGJAR_03'
        },
        {
            id: 'DRESSINGJAR_04',
            name: ' Dressing Jar Economy',
            category: ' Dressing Jar',
            description: 'Cost-effective  Dressing Jar solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DRESSINGJAR_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Dressing Jar</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Dressing Jar?</h3>

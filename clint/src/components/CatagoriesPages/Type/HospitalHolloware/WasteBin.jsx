...
const WasteBin = () => {
    ...
    const mockProducts = [
        {
            id: 'WASTEBIN_01',
            name: ' Waste Bin Basic',
            category: ' Waste Bin',
            description: 'High quality and reliable  Waste Bin designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'WASTEBIN_02',
            name: ' Waste Bin Premium',
            category: ' Waste Bin',
            description: 'Advanced  Waste Bin with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WASTEBIN_02'
        },
        {
            id: 'WASTEBIN_03',
            name: ' Waste Bin Professional',
            category: ' Waste Bin',
            description: 'Industry-standard  Waste Bin for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WASTEBIN_03'
        },
        {
            id: 'WASTEBIN_04',
            name: ' Waste Bin Economy',
            category: ' Waste Bin',
            description: 'Cost-effective  Waste Bin solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WASTEBIN_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Waste Bin</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Waste Bin?</h3>

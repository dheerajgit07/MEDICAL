...
const CatheterInstrumentTray = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'CATHETERINSTRUMENTTRAY_01',
            name: ' Catheter Instrument Tray Basic',
            category: ' Catheter Instrument Tray',
            description: 'High quality and reliable  Catheter Instrument Tray designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'CATHETERINSTRUMENTTRAY_01'
        },
        {
            id: 'CATHETERINSTRUMENTTRAY_02',
            name: ' Catheter Instrument Tray Premium',
            category: ' Catheter Instrument Tray',
            description: 'Advanced  Catheter Instrument Tray with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CATHETERINSTRUMENTTRAY_02'
        },
        {
            id: 'CATHETERINSTRUMENTTRAY_03',
            name: ' Catheter Instrument Tray Professional',
            category: ' Catheter Instrument Tray',
            description: 'Industry-standard  Catheter Instrument Tray for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CATHETERINSTRUMENTTRAY_03'
        },
        {
            id: 'CATHETERINSTRUMENTTRAY_04',
            name: ' Catheter Instrument Tray Economy',
            category: ' Catheter Instrument Tray',
            description: 'Cost-effective  Catheter Instrument Tray solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CATHETERINSTRUMENTTRAY_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Catheter Instrument Tray</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Catheter Instrument Tray?</h3>
...
export default CatheterInstrumentTray;

...
const BedPanAndUrinal = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'BEDPANANDURINAL_01',
            name: ' Bed Pan And Urinal Basic',
            category: ' Bed Pan And Urinal',
            description: 'High quality and reliable  Bed Pan And Urinal designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'BEDPANANDURINAL_01'
        },
        {
            id: 'BEDPANANDURINAL_02',
            name: ' Bed Pan And Urinal Premium',
            category: ' Bed Pan And Urinal',
            description: 'Advanced  Bed Pan And Urinal with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BEDPANANDURINAL_02'
        },
        {
            id: 'BEDPANANDURINAL_03',
            name: ' Bed Pan And Urinal Professional',
            category: ' Bed Pan And Urinal',
            description: 'Industry-standard  Bed Pan And Urinal for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BEDPANANDURINAL_03'
        },
        {
            id: 'BEDPANANDURINAL_04',
            name: ' Bed Pan And Urinal Economy',
            category: ' Bed Pan And Urinal',
            description: 'Cost-effective  Bed Pan And Urinal solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BEDPANANDURINAL_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Bed Pan And Urinal</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Bed Pan And Urinal?</h3>
...
export default BedPanAndUrinal;

...
const BowlBasin = () => {
    ...
    const mockProducts = [
        {
            id: 'BOWLBASIN_01',
            name: ' Bowl Basin Basic',
            category: ' Bowl Basin',
            description: 'High quality and reliable  Bowl Basin designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'BOWLBASIN_02',
            name: ' Bowl Basin Premium',
            category: ' Bowl Basin',
            description: 'Advanced  Bowl Basin with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BOWLBASIN_02'
        },
        {
            id: 'BOWLBASIN_03',
            name: ' Bowl Basin Professional',
            category: ' Bowl Basin',
            description: 'Industry-standard  Bowl Basin for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BOWLBASIN_03'
        },
        {
            id: 'BOWLBASIN_04',
            name: ' Bowl Basin Economy',
            category: ' Bowl Basin',
            description: 'Cost-effective  Bowl Basin solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BOWLBASIN_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Bowl Basin</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Bowl Basin?</h3>

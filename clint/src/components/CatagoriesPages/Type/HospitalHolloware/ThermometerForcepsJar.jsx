...
const ThermometerForcepsJar = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'THERMOMETERFORCEPSJAR_01',
            name: ' Thermometer Forceps Jar Basic',
            category: ' Thermometer Forceps Jar',
            description: 'High quality and reliable  Thermometer Forceps Jar designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'THERMOMETERFORCEPSJAR_01'
        },
        {
            id: 'THERMOMETERFORCEPSJAR_02',
            name: ' Thermometer Forceps Jar Premium',
            category: ' Thermometer Forceps Jar',
            description: 'Advanced  Thermometer Forceps Jar with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'THERMOMETERFORCEPSJAR_02'
        },
        {
            id: 'THERMOMETERFORCEPSJAR_03',
            name: ' Thermometer Forceps Jar Professional',
            category: ' Thermometer Forceps Jar',
            description: 'Industry-standard  Thermometer Forceps Jar for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'THERMOMETERFORCEPSJAR_03'
        },
        {
            id: 'THERMOMETERFORCEPSJAR_04',
            name: ' Thermometer Forceps Jar Economy',
            category: ' Thermometer Forceps Jar',
            description: 'Cost-effective  Thermometer Forceps Jar solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'THERMOMETERFORCEPSJAR_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Thermometer Forceps Jar</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Thermometer Forceps Jar?</h3>
...
export default ThermometerForcepsJar;

...
const KidneyTray = () => {
    ...
    const mockProducts = [
        {
            id: 'KIDNEYTRAY_01',
            name: ' Kidney Tray Basic',
            category: ' Kidney Tray',
            description: 'High quality and reliable  Kidney Tray designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'KIDNEYTRAY_02',
            name: ' Kidney Tray Premium',
            category: ' Kidney Tray',
            description: 'Advanced  Kidney Tray with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'KIDNEYTRAY_02'
        },
        {
            id: 'KIDNEYTRAY_03',
            name: ' Kidney Tray Professional',
            category: ' Kidney Tray',
            description: 'Industry-standard  Kidney Tray for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'KIDNEYTRAY_03'
        },
        {
            id: 'KIDNEYTRAY_04',
            name: ' Kidney Tray Economy',
            category: ' Kidney Tray',
            description: 'Cost-effective  Kidney Tray solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'KIDNEYTRAY_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Kidney Tray</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Kidney Tray?</h3>

...
const CidexTray = () => {
    ...
    const mockProducts = [
        {
            id: 'CIDEXTRAY_01',
            name: ' Cidex Tray Basic',
            category: ' Cidex Tray',
            description: 'High quality and reliable  Cidex Tray designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'CIDEXTRAY_02',
            name: ' Cidex Tray Premium',
            category: ' Cidex Tray',
            description: 'Advanced  Cidex Tray with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CIDEXTRAY_02'
        },
        {
            id: 'CIDEXTRAY_03',
            name: ' Cidex Tray Professional',
            category: ' Cidex Tray',
            description: 'Industry-standard  Cidex Tray for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CIDEXTRAY_03'
        },
        {
            id: 'CIDEXTRAY_04',
            name: ' Cidex Tray Economy',
            category: ' Cidex Tray',
            description: 'Cost-effective  Cidex Tray solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CIDEXTRAY_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Cidex Tray</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Cidex Tray?</h3>

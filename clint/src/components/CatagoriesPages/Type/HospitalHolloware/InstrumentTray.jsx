...
const InstrumentTray = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'INSTRUMENTTRAY_01',
            name: ' Instrument Tray Basic',
            category: ' Instrument Tray',
            description: 'High quality and reliable  Instrument Tray designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'INSTRUMENTTRAY_01'
        },
        {
            id: 'INSTRUMENTTRAY_02',
            name: ' Instrument Tray Premium',
            category: ' Instrument Tray',
            description: 'Advanced  Instrument Tray with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'INSTRUMENTTRAY_02'
        },
        {
            id: 'INSTRUMENTTRAY_03',
            name: ' Instrument Tray Professional',
            category: ' Instrument Tray',
            description: 'Industry-standard  Instrument Tray for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'INSTRUMENTTRAY_03'
        },
        {
            id: 'INSTRUMENTTRAY_04',
            name: ' Instrument Tray Economy',
            category: ' Instrument Tray',
            description: 'Cost-effective  Instrument Tray solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'INSTRUMENTTRAY_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Instrument Tray</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Instrument Tray?</h3>

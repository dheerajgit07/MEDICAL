...
const Bucket = () => {
    ...
    const mockProducts = [
        {
            ...
            name: ' Bucket Basic',
            category: ' Bucket',
            description: 'High quality and reliable  Bucket designed for medical professionals.',
            price: 50.00,
        ...
        },
        {
            ...
            name: ' Bucket Premium',
            category: ' Bucket',
            description: 'Advanced  Bucket with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BUCKET_02'
        },
        {
            id: 'BUCKET_03',
            name: ' Bucket Professional',
            category: ' Bucket',
            description: 'Industry-standard  Bucket for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BUCKET_03'
        },
        {
            ...
            name: ' Bucket Economy',
            category: ' Bucket',
            description: 'Cost-effective  Bucket solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BUCKET_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Bucket</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Bucket?</h3>

...
const DressingDrum = () => {
    ...
    const mockProducts = [
        {
            id: 'DRESSINGDRUM_01',
            name: ' Dressing Drum Basic',
            category: ' Dressing Drum',
            description: 'High quality and reliable  Dressing Drum designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'DRESSINGDRUM_02',
            name: ' Dressing Drum Premium',
            category: ' Dressing Drum',
            description: 'Advanced  Dressing Drum with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DRESSINGDRUM_02'
        },
        {
            id: 'DRESSINGDRUM_03',
            name: ' Dressing Drum Professional',
            category: ' Dressing Drum',
            description: 'Industry-standard  Dressing Drum for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DRESSINGDRUM_03'
        },
        {
            id: 'DRESSINGDRUM_04',
            name: ' Dressing Drum Economy',
            category: ' Dressing Drum',
            description: 'Cost-effective  Dressing Drum solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DRESSINGDRUM_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Dressing Drum</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Dressing Drum?</h3>

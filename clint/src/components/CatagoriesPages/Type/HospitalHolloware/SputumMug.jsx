...
const SputumMug = () => {
    ...
    const mockProducts = [
        {
            id: 'SPUTUMMUG_01',
            name: ' Sputum Mug Basic',
            category: ' Sputum Mug',
            description: 'High quality and reliable  Sputum Mug designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'SPUTUMMUG_02',
            name: ' Sputum Mug Premium',
            category: ' Sputum Mug',
            description: 'Advanced  Sputum Mug with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SPUTUMMUG_02'
        },
        {
            id: 'SPUTUMMUG_03',
            name: ' Sputum Mug Professional',
            category: ' Sputum Mug',
            description: 'Industry-standard  Sputum Mug for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SPUTUMMUG_03'
        },
        {
            id: 'SPUTUMMUG_04',
            name: ' Sputum Mug Economy',
            category: ' Sputum Mug',
            description: 'Cost-effective  Sputum Mug solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SPUTUMMUG_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Sputum Mug</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Sputum Mug?</h3>

...
const WireMeshSurgicalInstrumentTray = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'WIREMESHSURGICALINSTRUMENTTRAY_01',
            name: ' Wire Mesh Surgical Instrument Tray Basic',
            category: ' Wire Mesh Surgical Instrument Tray',
            description: 'High quality and reliable  Wire Mesh Surgical Instrument Tray designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'WIREMESHSURGICALINSTRUMENTTRAY_01'
        },
        {
            id: 'WIREMESHSURGICALINSTRUMENTTRAY_02',
            name: ' Wire Mesh Surgical Instrument Tray Premium',
            category: ' Wire Mesh Surgical Instrument Tray',
            description: 'Advanced  Wire Mesh Surgical Instrument Tray with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WIREMESHSURGICALINSTRUMENTTRAY_02'
        },
        {
            id: 'WIREMESHSURGICALINSTRUMENTTRAY_03',
            name: ' Wire Mesh Surgical Instrument Tray Professional',
            category: ' Wire Mesh Surgical Instrument Tray',
            description: 'Industry-standard  Wire Mesh Surgical Instrument Tray for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WIREMESHSURGICALINSTRUMENTTRAY_03'
        },
        {
            id: 'WIREMESHSURGICALINSTRUMENTTRAY_04',
            name: ' Wire Mesh Surgical Instrument Tray Economy',
            category: ' Wire Mesh Surgical Instrument Tray',
            description: 'Cost-effective  Wire Mesh Surgical Instrument Tray solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WIREMESHSURGICALINSTRUMENTTRAY_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Wire Mesh Surgical Instrument Tray</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Wire Mesh Surgical Instrument Tray?</h3>
...
export default WireMeshSurgicalInstrumentTray;

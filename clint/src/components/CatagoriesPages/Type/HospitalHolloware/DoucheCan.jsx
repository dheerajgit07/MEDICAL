...
const DoucheCan = () => {
    ...
    const mockProducts = [
        {
            id: 'DOUCHECAN_01',
            name: ' Douche Can Basic',
            category: ' Douche Can',
            description: 'High quality and reliable  Douche Can designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'DOUCHECAN_02',
            name: ' Douche Can Premium',
            category: ' Douche Can',
            description: 'Advanced  Douche Can with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DOUCHECAN_02'
        },
        {
            id: 'DOUCHECAN_03',
            name: ' Douche Can Professional',
            category: ' Douche Can',
            description: 'Industry-standard  Douche Can for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DOUCHECAN_03'
        },
        {
            id: 'DOUCHECAN_04',
            name: ' Douche Can Economy',
            category: ' Douche Can',
            description: 'Cost-effective  Douche Can solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DOUCHECAN_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Douche Can</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Douche Can?</h3>

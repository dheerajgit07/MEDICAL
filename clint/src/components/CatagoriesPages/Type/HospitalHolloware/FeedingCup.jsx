...
const FeedingCup = () => {
    ...
    const mockProducts = [
        {
            id: 'FEEDINGCUP_01',
            name: ' Feeding Cup Basic',
            category: ' Feeding Cup',
            description: 'High quality and reliable  Feeding Cup designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'FEEDINGCUP_02',
            name: ' Feeding Cup Premium',
            category: ' Feeding Cup',
            description: 'Advanced  Feeding Cup with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'FEEDINGCUP_02'
        },
        {
            id: 'FEEDINGCUP_03',
            name: ' Feeding Cup Professional',
            category: ' Feeding Cup',
            description: 'Industry-standard  Feeding Cup for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'FEEDINGCUP_03'
        },
        {
            id: 'FEEDINGCUP_04',
            name: ' Feeding Cup Economy',
            category: ' Feeding Cup',
            description: 'Cost-effective  Feeding Cup solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'FEEDINGCUP_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Feeding Cup</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Feeding Cup?</h3>

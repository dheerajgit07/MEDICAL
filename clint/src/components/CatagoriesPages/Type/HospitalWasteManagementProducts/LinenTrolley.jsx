...
const LinenTrolley = () => {
    ...
    const mockProducts = [
        {
            id: 'LINENTROLLEY_01',
            name: ' Linen Trolley Basic',
            category: ' Linen Trolley',
            description: 'High quality and reliable  Linen Trolley designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'LINENTROLLEY_02',
            name: ' Linen Trolley Premium',
            category: ' Linen Trolley',
            description: 'Advanced  Linen Trolley with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LINENTROLLEY_02'
        },
        {
            id: 'LINENTROLLEY_03',
            name: ' Linen Trolley Professional',
            category: ' Linen Trolley',
            description: 'Industry-standard  Linen Trolley for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LINENTROLLEY_03'
        },
        {
            id: 'LINENTROLLEY_04',
            name: ' Linen Trolley Economy',
            category: ' Linen Trolley',
            description: 'Cost-effective  Linen Trolley solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LINENTROLLEY_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Linen Trolley</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Linen Trolley?</h3>

...
const LiquidWasteTreatmentSystem = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'LIQUIDWASTETREATMENTSYSTEM_01',
            name: ' Liquid Waste Treatment System Basic',
            category: ' Liquid Waste Treatment System',
            description: 'High quality and reliable  Liquid Waste Treatment System designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'LIQUIDWASTETREATMENTSYSTEM_01'
        },
        {
            id: 'LIQUIDWASTETREATMENTSYSTEM_02',
            name: ' Liquid Waste Treatment System Premium',
            category: ' Liquid Waste Treatment System',
            description: 'Advanced  Liquid Waste Treatment System with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LIQUIDWASTETREATMENTSYSTEM_02'
        },
        {
            id: 'LIQUIDWASTETREATMENTSYSTEM_03',
            name: ' Liquid Waste Treatment System Professional',
            category: ' Liquid Waste Treatment System',
            description: 'Industry-standard  Liquid Waste Treatment System for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LIQUIDWASTETREATMENTSYSTEM_03'
        },
        {
            id: 'LIQUIDWASTETREATMENTSYSTEM_04',
            name: ' Liquid Waste Treatment System Economy',
            category: ' Liquid Waste Treatment System',
            description: 'Cost-effective  Liquid Waste Treatment System solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LIQUIDWASTETREATMENTSYSTEM_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Liquid Waste Treatment System</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Liquid Waste Treatment System?</h3>
...
export default LiquidWasteTreatmentSystem;

...
const WasteSegregationTrolleysMS = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'WASTESEGREGATIONTROLLEYSMS_01',
            name: ' Waste Segregation Trolleys M S Basic',
            category: ' Waste Segregation Trolleys M S',
            description: 'High quality and reliable  Waste Segregation Trolleys M S designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'WASTESEGREGATIONTROLLEYSMS_01'
        },
        {
            id: 'WASTESEGREGATIONTROLLEYSMS_02',
            name: ' Waste Segregation Trolleys M S Premium',
            category: ' Waste Segregation Trolleys M S',
            description: 'Advanced  Waste Segregation Trolleys M S with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WASTESEGREGATIONTROLLEYSMS_02'
        },
        {
            id: 'WASTESEGREGATIONTROLLEYSMS_03',
            name: ' Waste Segregation Trolleys M S Professional',
            category: ' Waste Segregation Trolleys M S',
            description: 'Industry-standard  Waste Segregation Trolleys M S for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WASTESEGREGATIONTROLLEYSMS_03'
        },
        {
            id: 'WASTESEGREGATIONTROLLEYSMS_04',
            name: ' Waste Segregation Trolleys M S Economy',
            category: ' Waste Segregation Trolleys M S',
            description: 'Cost-effective  Waste Segregation Trolleys M S solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WASTESEGREGATIONTROLLEYSMS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Waste Segregation Trolleys M S</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Waste Segregation Trolleys M S?</h3>
...
export default WasteSegregationTrolleysMS;

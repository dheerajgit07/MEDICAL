...
const WasteBins = () => {
    ...
    const mockProducts = [
        {
            id: 'WASTEBINS_01',
            name: ' Waste Bins Basic',
            category: ' Waste Bins',
            description: 'High quality and reliable  Waste Bins designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'WASTEBINS_02',
            name: ' Waste Bins Premium',
            category: ' Waste Bins',
            description: 'Advanced  Waste Bins with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WASTEBINS_02'
        },
        {
            id: 'WASTEBINS_03',
            name: ' Waste Bins Professional',
            category: ' Waste Bins',
            description: 'Industry-standard  Waste Bins for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WASTEBINS_03'
        },
        {
            id: 'WASTEBINS_04',
            name: ' Waste Bins Economy',
            category: ' Waste Bins',
            description: 'Cost-effective  Waste Bins solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WASTEBINS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Waste Bins</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Waste Bins?</h3>

...
const WringerMoppingTrolleys = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'WRINGERMOPPINGTROLLEYS_01',
            name: ' Wringer Mopping Trolleys Basic',
            category: ' Wringer Mopping Trolleys',
            description: 'High quality and reliable  Wringer Mopping Trolleys designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'WRINGERMOPPINGTROLLEYS_01'
        },
        {
            id: 'WRINGERMOPPINGTROLLEYS_02',
            name: ' Wringer Mopping Trolleys Premium',
            category: ' Wringer Mopping Trolleys',
            description: 'Advanced  Wringer Mopping Trolleys with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WRINGERMOPPINGTROLLEYS_02'
        },
        {
            id: 'WRINGERMOPPINGTROLLEYS_03',
            name: ' Wringer Mopping Trolleys Professional',
            category: ' Wringer Mopping Trolleys',
            description: 'Industry-standard  Wringer Mopping Trolleys for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WRINGERMOPPINGTROLLEYS_03'
        },
        {
            id: 'WRINGERMOPPINGTROLLEYS_04',
            name: ' Wringer Mopping Trolleys Economy',
            category: ' Wringer Mopping Trolleys',
            description: 'Cost-effective  Wringer Mopping Trolleys solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WRINGERMOPPINGTROLLEYS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Wringer Mopping Trolleys</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Wringer Mopping Trolleys?</h3>
...
export default WringerMoppingTrolleys;

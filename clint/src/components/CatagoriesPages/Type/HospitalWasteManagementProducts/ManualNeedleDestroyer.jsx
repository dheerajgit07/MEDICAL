...
const ManualNeedleDestroyer = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'MANUALNEEDLEDESTROYER_01',
            name: ' Manual Needle Destroyer Basic',
            category: ' Manual Needle Destroyer',
            description: 'High quality and reliable  Manual Needle Destroyer designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'MANUALNEEDLEDESTROYER_01'
        },
        {
            id: 'MANUALNEEDLEDESTROYER_02',
            name: ' Manual Needle Destroyer Premium',
            category: ' Manual Needle Destroyer',
            description: 'Advanced  Manual Needle Destroyer with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MANUALNEEDLEDESTROYER_02'
        },
        {
            id: 'MANUALNEEDLEDESTROYER_03',
            name: ' Manual Needle Destroyer Professional',
            category: ' Manual Needle Destroyer',
            description: 'Industry-standard  Manual Needle Destroyer for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MANUALNEEDLEDESTROYER_03'
        },
        {
            id: 'MANUALNEEDLEDESTROYER_04',
            name: ' Manual Needle Destroyer Economy',
            category: ' Manual Needle Destroyer',
            description: 'Cost-effective  Manual Needle Destroyer solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MANUALNEEDLEDESTROYER_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Manual Needle Destroyer</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Manual Needle Destroyer?</h3>
...
export default ManualNeedleDestroyer;

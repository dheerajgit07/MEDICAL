...
const UtilityTrolley = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'UTILITYTROLLEY_01',
            name: ' Utility Trolley Basic',
            category: ' Utility Trolley',
            description: 'High quality and reliable  Utility Trolley designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'UTILITYTROLLEY_01'
        },
        {
            id: 'UTILITYTROLLEY_02',
            name: ' Utility Trolley Premium',
            category: ' Utility Trolley',
            description: 'Advanced  Utility Trolley with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'UTILITYTROLLEY_02'
        },
        {
            id: 'UTILITYTROLLEY_03',
            name: ' Utility Trolley Professional',
            category: ' Utility Trolley',
            description: 'Industry-standard  Utility Trolley for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'UTILITYTROLLEY_03'
        },
        {
            id: 'UTILITYTROLLEY_04',
            name: ' Utility Trolley Economy',
            category: ' Utility Trolley',
            description: 'Cost-effective  Utility Trolley solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'UTILITYTROLLEY_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Utility Trolley</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Utility Trolley?</h3>

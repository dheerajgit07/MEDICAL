...
const CardboardSafetyBoxes = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'CARDBOARDSAFETYBOXES_01',
            name: ' Cardboard Safety Boxes Basic',
            category: ' Cardboard Safety Boxes',
            description: 'High quality and reliable  Cardboard Safety Boxes designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'CARDBOARDSAFETYBOXES_01'
        },
        {
            id: 'CARDBOARDSAFETYBOXES_02',
            name: ' Cardboard Safety Boxes Premium',
            category: ' Cardboard Safety Boxes',
            description: 'Advanced  Cardboard Safety Boxes with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CARDBOARDSAFETYBOXES_02'
        },
        {
            id: 'CARDBOARDSAFETYBOXES_03',
            name: ' Cardboard Safety Boxes Professional',
            category: ' Cardboard Safety Boxes',
            description: 'Industry-standard  Cardboard Safety Boxes for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CARDBOARDSAFETYBOXES_03'
        },
        {
            id: 'CARDBOARDSAFETYBOXES_04',
            name: ' Cardboard Safety Boxes Economy',
            category: ' Cardboard Safety Boxes',
            description: 'Cost-effective  Cardboard Safety Boxes solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CARDBOARDSAFETYBOXES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Cardboard Safety Boxes</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Cardboard Safety Boxes?</h3>
...
export default CardboardSafetyBoxes;

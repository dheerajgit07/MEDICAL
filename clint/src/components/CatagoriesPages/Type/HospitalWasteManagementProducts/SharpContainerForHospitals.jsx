...
const SharpContainerForHospitals = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'SHARPCONTAINERFORHOSPITALS_01',
            name: ' Sharp Container For Hospitals Basic',
            category: ' Sharp Container For Hospitals',
            description: 'High quality and reliable  Sharp Container For Hospitals designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'SHARPCONTAINERFORHOSPITALS_01'
        },
        {
            id: 'SHARPCONTAINERFORHOSPITALS_02',
            name: ' Sharp Container For Hospitals Premium',
            category: ' Sharp Container For Hospitals',
            description: 'Advanced  Sharp Container For Hospitals with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SHARPCONTAINERFORHOSPITALS_02'
        },
        {
            id: 'SHARPCONTAINERFORHOSPITALS_03',
            name: ' Sharp Container For Hospitals Professional',
            category: ' Sharp Container For Hospitals',
            description: 'Industry-standard  Sharp Container For Hospitals for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SHARPCONTAINERFORHOSPITALS_03'
        },
        {
            id: 'SHARPCONTAINERFORHOSPITALS_04',
            name: ' Sharp Container For Hospitals Economy',
            category: ' Sharp Container For Hospitals',
            description: 'Cost-effective  Sharp Container For Hospitals solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SHARPCONTAINERFORHOSPITALS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Sharp Container For Hospitals</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Sharp Container For Hospitals?</h3>
...
export default SharpContainerForHospitals;

...
const HospitalUniformsDresses = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'HOSPITALUNIFORMSDRESSES_01',
            name: ' Hospital Uniforms Dresses Basic',
            category: ' Hospital Uniforms Dresses',
            description: 'High quality and reliable  Hospital Uniforms Dresses designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'HOSPITALUNIFORMSDRESSES_01'
        },
        {
            id: 'HOSPITALUNIFORMSDRESSES_02',
            name: ' Hospital Uniforms Dresses Premium',
            category: ' Hospital Uniforms Dresses',
            description: 'Advanced  Hospital Uniforms Dresses with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOSPITALUNIFORMSDRESSES_02'
        },
        {
            id: 'HOSPITALUNIFORMSDRESSES_03',
            name: ' Hospital Uniforms Dresses Professional',
            category: ' Hospital Uniforms Dresses',
            description: 'Industry-standard  Hospital Uniforms Dresses for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOSPITALUNIFORMSDRESSES_03'
        },
        {
            id: 'HOSPITALUNIFORMSDRESSES_04',
            name: ' Hospital Uniforms Dresses Economy',
            category: ' Hospital Uniforms Dresses',
            description: 'Cost-effective  Hospital Uniforms Dresses solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOSPITALUNIFORMSDRESSES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Hospital Uniforms Dresses</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Hospital Uniforms Dresses?</h3>
...
export default HospitalUniformsDresses;

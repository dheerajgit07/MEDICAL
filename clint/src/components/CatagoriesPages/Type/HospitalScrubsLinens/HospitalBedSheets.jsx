...
const HospitalBedSheets = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'HOSPITALBEDSHEETS_01',
            name: ' Hospital Bed Sheets Basic',
            category: ' Hospital Bed Sheets',
            description: 'High quality and reliable  Hospital Bed Sheets designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'HOSPITALBEDSHEETS_01'
        },
        {
            id: 'HOSPITALBEDSHEETS_02',
            name: ' Hospital Bed Sheets Premium',
            category: ' Hospital Bed Sheets',
            description: 'Advanced  Hospital Bed Sheets with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOSPITALBEDSHEETS_02'
        },
        {
            id: 'HOSPITALBEDSHEETS_03',
            name: ' Hospital Bed Sheets Professional',
            category: ' Hospital Bed Sheets',
            description: 'Industry-standard  Hospital Bed Sheets for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOSPITALBEDSHEETS_03'
        },
        {
            id: 'HOSPITALBEDSHEETS_04',
            name: ' Hospital Bed Sheets Economy',
            category: ' Hospital Bed Sheets',
            description: 'Cost-effective  Hospital Bed Sheets solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOSPITALBEDSHEETS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Hospital Bed Sheets</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Hospital Bed Sheets?</h3>
...
export default HospitalBedSheets;

...
const MedicalDrapeSheets = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'MEDICALDRAPESHEETS_01',
            name: ' Medical Drape Sheets Basic',
            category: ' Medical Drape Sheets',
            description: 'High quality and reliable  Medical Drape Sheets designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'MEDICALDRAPESHEETS_01'
        },
        {
            id: 'MEDICALDRAPESHEETS_02',
            name: ' Medical Drape Sheets Premium',
            category: ' Medical Drape Sheets',
            description: 'Advanced  Medical Drape Sheets with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MEDICALDRAPESHEETS_02'
        },
        {
            id: 'MEDICALDRAPESHEETS_03',
            name: ' Medical Drape Sheets Professional',
            category: ' Medical Drape Sheets',
            description: 'Industry-standard  Medical Drape Sheets for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MEDICALDRAPESHEETS_03'
        },
        {
            id: 'MEDICALDRAPESHEETS_04',
            name: ' Medical Drape Sheets Economy',
            category: ' Medical Drape Sheets',
            description: 'Cost-effective  Medical Drape Sheets solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MEDICALDRAPESHEETS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Medical Drape Sheets</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Medical Drape Sheets?</h3>
...
export default MedicalDrapeSheets;

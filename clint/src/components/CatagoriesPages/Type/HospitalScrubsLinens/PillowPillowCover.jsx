...
const PillowPillowCover = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'PILLOWPILLOWCOVER_01',
            name: ' Pillow Pillow Cover Basic',
            category: ' Pillow Pillow Cover',
            description: 'High quality and reliable  Pillow Pillow Cover designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PILLOWPILLOWCOVER_01'
        },
        {
            id: 'PILLOWPILLOWCOVER_02',
            name: ' Pillow Pillow Cover Premium',
            category: ' Pillow Pillow Cover',
            description: 'Advanced  Pillow Pillow Cover with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PILLOWPILLOWCOVER_02'
        },
        {
            id: 'PILLOWPILLOWCOVER_03',
            name: ' Pillow Pillow Cover Professional',
            category: ' Pillow Pillow Cover',
            description: 'Industry-standard  Pillow Pillow Cover for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PILLOWPILLOWCOVER_03'
        },
        {
            id: 'PILLOWPILLOWCOVER_04',
            name: ' Pillow Pillow Cover Economy',
            category: ' Pillow Pillow Cover',
            description: 'Cost-effective  Pillow Pillow Cover solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PILLOWPILLOWCOVER_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Pillow Pillow Cover</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Pillow Pillow Cover?</h3>
...
export default PillowPillowCover;

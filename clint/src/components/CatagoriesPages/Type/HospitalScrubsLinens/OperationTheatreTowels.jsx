...
const OperationTheatreTowels = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'OPERATIONTHEATRETOWELS_01',
            name: ' Operation Theatre Towels Basic',
            category: ' Operation Theatre Towels',
            description: 'High quality and reliable  Operation Theatre Towels designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'OPERATIONTHEATRETOWELS_01'
        },
        {
            id: 'OPERATIONTHEATRETOWELS_02',
            name: ' Operation Theatre Towels Premium',
            category: ' Operation Theatre Towels',
            description: 'Advanced  Operation Theatre Towels with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OPERATIONTHEATRETOWELS_02'
        },
        {
            id: 'OPERATIONTHEATRETOWELS_03',
            name: ' Operation Theatre Towels Professional',
            category: ' Operation Theatre Towels',
            description: 'Industry-standard  Operation Theatre Towels for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OPERATIONTHEATRETOWELS_03'
        },
        {
            id: 'OPERATIONTHEATRETOWELS_04',
            name: ' Operation Theatre Towels Economy',
            category: ' Operation Theatre Towels',
            description: 'Cost-effective  Operation Theatre Towels solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OPERATIONTHEATRETOWELS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Operation Theatre Towels</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Operation Theatre Towels?</h3>
...
export default OperationTheatreTowels;

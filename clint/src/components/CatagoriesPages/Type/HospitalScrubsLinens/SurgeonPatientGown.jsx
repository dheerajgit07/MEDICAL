...
const SurgeonPatientGown = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'SURGEONPATIENTGOWN_01',
            name: ' Surgeon Patient Gown Basic',
            category: ' Surgeon Patient Gown',
            description: 'High quality and reliable  Surgeon Patient Gown designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'SURGEONPATIENTGOWN_01'
        },
        {
            id: 'SURGEONPATIENTGOWN_02',
            name: ' Surgeon Patient Gown Premium',
            category: ' Surgeon Patient Gown',
            description: 'Advanced  Surgeon Patient Gown with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SURGEONPATIENTGOWN_02'
        },
        {
            id: 'SURGEONPATIENTGOWN_03',
            name: ' Surgeon Patient Gown Professional',
            category: ' Surgeon Patient Gown',
            description: 'Industry-standard  Surgeon Patient Gown for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SURGEONPATIENTGOWN_03'
        },
        {
            id: 'SURGEONPATIENTGOWN_04',
            name: ' Surgeon Patient Gown Economy',
            category: ' Surgeon Patient Gown',
            description: 'Cost-effective  Surgeon Patient Gown solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SURGEONPATIENTGOWN_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Surgeon Patient Gown</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Surgeon Patient Gown?</h3>
...
export default SurgeonPatientGown;

...
const PatientIdentificationWristbands = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'PATIENTIDENTIFICATIONWRISTBANDS_01',
            name: ' Patient Identification Wristbands Basic',
            category: ' Patient Identification Wristbands',
            description: 'High quality and reliable  Patient Identification Wristbands designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PATIENTIDENTIFICATIONWRISTBANDS_01'
        },
        {
            id: 'PATIENTIDENTIFICATIONWRISTBANDS_02',
            name: ' Patient Identification Wristbands Premium',
            category: ' Patient Identification Wristbands',
            description: 'Advanced  Patient Identification Wristbands with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PATIENTIDENTIFICATIONWRISTBANDS_02'
        },
        {
            id: 'PATIENTIDENTIFICATIONWRISTBANDS_03',
            name: ' Patient Identification Wristbands Professional',
            category: ' Patient Identification Wristbands',
            description: 'Industry-standard  Patient Identification Wristbands for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PATIENTIDENTIFICATIONWRISTBANDS_03'
        },
        {
            id: 'PATIENTIDENTIFICATIONWRISTBANDS_04',
            name: ' Patient Identification Wristbands Economy',
            category: ' Patient Identification Wristbands',
            description: 'Cost-effective  Patient Identification Wristbands solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PATIENTIDENTIFICATIONWRISTBANDS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Patient Identification Wristbands</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Patient Identification Wristbands?</h3>
...
export default PatientIdentificationWristbands;

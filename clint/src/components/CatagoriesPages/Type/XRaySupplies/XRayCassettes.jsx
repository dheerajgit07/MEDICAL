...
const XRayCassettes = () => {
    ...
    const mockProducts = [
        {
            id: 'XRAYCASSETTES_01',
            name: ' X Ray Cassettes Basic',
            category: ' X Ray Cassettes',
            description: 'High quality and reliable  X Ray Cassettes designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'XRAYCASSETTES_01'
        },
        {
            id: 'XRAYCASSETTES_02',
            name: ' X Ray Cassettes Premium',
            category: ' X Ray Cassettes',
            description: 'Advanced  X Ray Cassettes with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'XRAYCASSETTES_02'
        },
        {
            id: 'XRAYCASSETTES_03',
            name: ' X Ray Cassettes Professional',
            category: ' X Ray Cassettes',
            description: 'Industry-standard  X Ray Cassettes for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'XRAYCASSETTES_03'
        },
        {
            id: 'XRAYCASSETTES_04',
            name: ' X Ray Cassettes Economy',
            category: ' X Ray Cassettes',
            description: 'Cost-effective  X Ray Cassettes solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'XRAYCASSETTES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> X Ray Cassettes</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  X Ray Cassettes?</h3>

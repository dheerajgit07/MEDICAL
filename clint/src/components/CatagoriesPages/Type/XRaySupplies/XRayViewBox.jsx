...
const XRayViewBox = () => {
    ...
    const mockProducts = [
        {
            id: 'XRAYVIEWBOX_01',
            name: ' X Ray View Box Basic',
            category: ' X Ray View Box',
            description: 'High quality and reliable  X Ray View Box designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'XRAYVIEWBOX_02',
            name: ' X Ray View Box Premium',
            category: ' X Ray View Box',
            description: 'Advanced  X Ray View Box with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'XRAYVIEWBOX_02'
        },
        {
            id: 'XRAYVIEWBOX_03',
            name: ' X Ray View Box Professional',
            category: ' X Ray View Box',
            description: 'Industry-standard  X Ray View Box for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'XRAYVIEWBOX_03'
        },
        {
            id: 'XRAYVIEWBOX_04',
            name: ' X Ray View Box Economy',
            category: ' X Ray View Box',
            description: 'Cost-effective  X Ray View Box solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'XRAYVIEWBOX_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> X Ray View Box</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  X Ray View Box?</h3>

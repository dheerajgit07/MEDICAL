...
const MobileLeadBarrier = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'MOBILELEADBARRIER_01',
            name: ' Mobile Lead Barrier Basic',
            category: ' Mobile Lead Barrier',
            description: 'High quality and reliable  Mobile Lead Barrier designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'MOBILELEADBARRIER_01'
        },
        {
            id: 'MOBILELEADBARRIER_02',
            name: ' Mobile Lead Barrier Premium',
            category: ' Mobile Lead Barrier',
            description: 'Advanced  Mobile Lead Barrier with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MOBILELEADBARRIER_02'
        },
        {
            id: 'MOBILELEADBARRIER_03',
            name: ' Mobile Lead Barrier Professional',
            category: ' Mobile Lead Barrier',
            description: 'Industry-standard  Mobile Lead Barrier for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MOBILELEADBARRIER_03'
        },
        {
            id: 'MOBILELEADBARRIER_04',
            name: ' Mobile Lead Barrier Economy',
            category: ' Mobile Lead Barrier',
            description: 'Cost-effective  Mobile Lead Barrier solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MOBILELEADBARRIER_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Mobile Lead Barrier</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Mobile Lead Barrier?</h3>
...
export default MobileLeadBarrier;

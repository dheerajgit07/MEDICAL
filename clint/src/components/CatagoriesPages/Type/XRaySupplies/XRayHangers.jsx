...
const XRayHangers = () => {
    ...
    const mockProducts = [
        {
            id: 'XRAYHANGERS_01',
            name: ' X Ray Hangers Basic',
            category: ' X Ray Hangers',
            description: 'High quality and reliable  X Ray Hangers designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'XRAYHANGERS_02',
            name: ' X Ray Hangers Premium',
            category: ' X Ray Hangers',
            description: 'Advanced  X Ray Hangers with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'XRAYHANGERS_02'
        },
        {
            id: 'XRAYHANGERS_03',
            name: ' X Ray Hangers Professional',
            category: ' X Ray Hangers',
            description: 'Industry-standard  X Ray Hangers for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'XRAYHANGERS_03'
        },
        {
            id: 'XRAYHANGERS_04',
            name: ' X Ray Hangers Economy',
            category: ' X Ray Hangers',
            description: 'Cost-effective  X Ray Hangers solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'XRAYHANGERS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> X Ray Hangers</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  X Ray Hangers?</h3>

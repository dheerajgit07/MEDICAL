...
const ThyroidCollarShield = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'THYROIDCOLLARSHIELD_01',
            name: ' Thyroid Collar Shield Basic',
            category: ' Thyroid Collar Shield',
            description: 'High quality and reliable  Thyroid Collar Shield designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'THYROIDCOLLARSHIELD_01'
        },
        {
            id: 'THYROIDCOLLARSHIELD_02',
            name: ' Thyroid Collar Shield Premium',
            category: ' Thyroid Collar Shield',
            description: 'Advanced  Thyroid Collar Shield with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'THYROIDCOLLARSHIELD_02'
        },
        {
            id: 'THYROIDCOLLARSHIELD_03',
            name: ' Thyroid Collar Shield Professional',
            category: ' Thyroid Collar Shield',
            description: 'Industry-standard  Thyroid Collar Shield for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'THYROIDCOLLARSHIELD_03'
        },
        {
            id: 'THYROIDCOLLARSHIELD_04',
            name: ' Thyroid Collar Shield Economy',
            category: ' Thyroid Collar Shield',
            description: 'Cost-effective  Thyroid Collar Shield solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'THYROIDCOLLARSHIELD_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Thyroid Collar Shield</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Thyroid Collar Shield?</h3>
...
export default ThyroidCollarShield;

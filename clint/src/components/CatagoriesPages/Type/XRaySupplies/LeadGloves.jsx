...
const LeadGloves = () => {
    ...
    const mockProducts = [
        {
            id: 'LEADGLOVES_01',
            name: ' Lead Gloves Basic',
            category: ' Lead Gloves',
            description: 'High quality and reliable  Lead Gloves designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'LEADGLOVES_02',
            name: ' Lead Gloves Premium',
            category: ' Lead Gloves',
            description: 'Advanced  Lead Gloves with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LEADGLOVES_02'
        },
        {
            id: 'LEADGLOVES_03',
            name: ' Lead Gloves Professional',
            category: ' Lead Gloves',
            description: 'Industry-standard  Lead Gloves for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LEADGLOVES_03'
        },
        {
            id: 'LEADGLOVES_04',
            name: ' Lead Gloves Economy',
            category: ' Lead Gloves',
            description: 'Cost-effective  Lead Gloves solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LEADGLOVES_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Lead Gloves</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Lead Gloves?</h3>

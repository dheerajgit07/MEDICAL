...
const GonadOvarianShields = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'GONADOVARIANSHIELDS_01',
            name: ' Gonad Ovarian Shields Basic',
            category: ' Gonad Ovarian Shields',
            description: 'High quality and reliable  Gonad Ovarian Shields designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'GONADOVARIANSHIELDS_01'
        },
        {
            id: 'GONADOVARIANSHIELDS_02',
            name: ' Gonad Ovarian Shields Premium',
            category: ' Gonad Ovarian Shields',
            description: 'Advanced  Gonad Ovarian Shields with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GONADOVARIANSHIELDS_02'
        },
        {
            id: 'GONADOVARIANSHIELDS_03',
            name: ' Gonad Ovarian Shields Professional',
            category: ' Gonad Ovarian Shields',
            description: 'Industry-standard  Gonad Ovarian Shields for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GONADOVARIANSHIELDS_03'
        },
        {
            id: 'GONADOVARIANSHIELDS_04',
            name: ' Gonad Ovarian Shields Economy',
            category: ' Gonad Ovarian Shields',
            description: 'Cost-effective  Gonad Ovarian Shields solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GONADOVARIANSHIELDS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Gonad Ovarian Shields</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Gonad Ovarian Shields?</h3>
...
export default GonadOvarianShields;

...
const BreastProtector = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'BREASTPROTECTOR_01',
            name: ' Breast Protector Basic',
            category: ' Breast Protector',
            description: 'High quality and reliable  Breast Protector designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'BREASTPROTECTOR_01'
        },
        {
            id: 'BREASTPROTECTOR_02',
            name: ' Breast Protector Premium',
            category: ' Breast Protector',
            description: 'Advanced  Breast Protector with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BREASTPROTECTOR_02'
        },
        {
            id: 'BREASTPROTECTOR_03',
            name: ' Breast Protector Professional',
            category: ' Breast Protector',
            description: 'Industry-standard  Breast Protector for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BREASTPROTECTOR_03'
        },
        {
            id: 'BREASTPROTECTOR_04',
            name: ' Breast Protector Economy',
            category: ' Breast Protector',
            description: 'Cost-effective  Breast Protector solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BREASTPROTECTOR_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Breast Protector</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Breast Protector?</h3>
...
export default BreastProtector;

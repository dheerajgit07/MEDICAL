...
const RadiationProtectionHeadShield = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'RADIATIONPROTECTIONHEADSHIELD_01',
            name: ' Radiation Protection Head Shield Basic',
            category: ' Radiation Protection Head Shield',
            description: 'High quality and reliable  Radiation Protection Head Shield designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'RADIATIONPROTECTIONHEADSHIELD_01'
        },
        {
            id: 'RADIATIONPROTECTIONHEADSHIELD_02',
            name: ' Radiation Protection Head Shield Premium',
            category: ' Radiation Protection Head Shield',
            description: 'Advanced  Radiation Protection Head Shield with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'RADIATIONPROTECTIONHEADSHIELD_02'
        },
        {
            id: 'RADIATIONPROTECTIONHEADSHIELD_03',
            name: ' Radiation Protection Head Shield Professional',
            category: ' Radiation Protection Head Shield',
            description: 'Industry-standard  Radiation Protection Head Shield for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'RADIATIONPROTECTIONHEADSHIELD_03'
        },
        {
            id: 'RADIATIONPROTECTIONHEADSHIELD_04',
            name: ' Radiation Protection Head Shield Economy',
            category: ' Radiation Protection Head Shield',
            description: 'Cost-effective  Radiation Protection Head Shield solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'RADIATIONPROTECTIONHEADSHIELD_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Radiation Protection Head Shield</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Radiation Protection Head Shield?</h3>
...
export default RadiationProtectionHeadShield;

...
const LeadAprons = () => {
    ...
    const mockProducts = [
        {
            id: 'LEADAPRONS_01',
            name: ' Lead Aprons Basic',
            category: ' Lead Aprons',
            description: 'High quality and reliable  Lead Aprons designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'LEADAPRONS_02',
            name: ' Lead Aprons Premium',
            category: ' Lead Aprons',
            description: 'Advanced  Lead Aprons with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LEADAPRONS_02'
        },
        {
            id: 'LEADAPRONS_03',
            name: ' Lead Aprons Professional',
            category: ' Lead Aprons',
            description: 'Industry-standard  Lead Aprons for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LEADAPRONS_03'
        },
        {
            id: 'LEADAPRONS_04',
            name: ' Lead Aprons Economy',
            category: ' Lead Aprons',
            description: 'Cost-effective  Lead Aprons solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LEADAPRONS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Lead Aprons</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Lead Aprons?</h3>

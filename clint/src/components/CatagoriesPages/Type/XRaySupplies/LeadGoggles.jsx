...
const LeadGoggles = () => {
    ...
    const mockProducts = [
        {
            id: 'LEADGOGGLES_01',
            name: ' Lead Goggles Basic',
            category: ' Lead Goggles',
            description: 'High quality and reliable  Lead Goggles designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'LEADGOGGLES_02',
            name: ' Lead Goggles Premium',
            category: ' Lead Goggles',
            description: 'Advanced  Lead Goggles with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LEADGOGGLES_02'
        },
        {
            id: 'LEADGOGGLES_03',
            name: ' Lead Goggles Professional',
            category: ' Lead Goggles',
            description: 'Industry-standard  Lead Goggles for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LEADGOGGLES_03'
        },
        {
            id: 'LEADGOGGLES_04',
            name: ' Lead Goggles Economy',
            category: ' Lead Goggles',
            description: 'Cost-effective  Lead Goggles solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LEADGOGGLES_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Lead Goggles</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Lead Goggles?</h3>

...
const PHTestStrips = () => {
    ...
    const mockProducts = [
        {
            id: 'PHTESTSTRIPS_01',
            name: ' P H Test Strips Basic',
            category: ' P H Test Strips',
            description: 'High quality and reliable  P H Test Strips designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'PHTESTSTRIPS_02',
            name: ' P H Test Strips Premium',
            category: ' P H Test Strips',
            description: 'Advanced  P H Test Strips with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PHTESTSTRIPS_02'
        },
        {
            id: 'PHTESTSTRIPS_03',
            name: ' P H Test Strips Professional',
            category: ' P H Test Strips',
            description: 'Industry-standard  P H Test Strips for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PHTESTSTRIPS_03'
        },
        {
            id: 'PHTESTSTRIPS_04',
            name: ' P H Test Strips Economy',
            category: ' P H Test Strips',
            description: 'Cost-effective  P H Test Strips solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PHTESTSTRIPS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> P H Test Strips</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  P H Test Strips?</h3>

...
const PneumaticTourniquet = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'PNEUMATICTOURNIQUET_01',
            name: ' Pneumatic Tourniquet Basic',
            category: ' Pneumatic Tourniquet',
            description: 'High quality and reliable  Pneumatic Tourniquet designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PNEUMATICTOURNIQUET_01'
        },
        {
            id: 'PNEUMATICTOURNIQUET_02',
            name: ' Pneumatic Tourniquet Premium',
            category: ' Pneumatic Tourniquet',
            description: 'Advanced  Pneumatic Tourniquet with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PNEUMATICTOURNIQUET_02'
        },
        {
            id: 'PNEUMATICTOURNIQUET_03',
            name: ' Pneumatic Tourniquet Professional',
            category: ' Pneumatic Tourniquet',
            description: 'Industry-standard  Pneumatic Tourniquet for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PNEUMATICTOURNIQUET_03'
        },
        {
            id: 'PNEUMATICTOURNIQUET_04',
            name: ' Pneumatic Tourniquet Economy',
            category: ' Pneumatic Tourniquet',
            description: 'Cost-effective  Pneumatic Tourniquet solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PNEUMATICTOURNIQUET_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Pneumatic Tourniquet</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Pneumatic Tourniquet?</h3>
...
export default PneumaticTourniquet;

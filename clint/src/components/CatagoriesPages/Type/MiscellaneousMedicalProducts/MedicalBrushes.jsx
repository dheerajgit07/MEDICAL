...
const MedicalBrushes = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'MEDICALBRUSHES_01',
            name: ' Medical Brushes Basic',
            category: ' Medical Brushes',
            description: 'High quality and reliable  Medical Brushes designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'MEDICALBRUSHES_01'
        },
        {
            id: 'MEDICALBRUSHES_02',
            name: ' Medical Brushes Premium',
            category: ' Medical Brushes',
            description: 'Advanced  Medical Brushes with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MEDICALBRUSHES_02'
        },
        {
            id: 'MEDICALBRUSHES_03',
            name: ' Medical Brushes Professional',
            category: ' Medical Brushes',
            description: 'Industry-standard  Medical Brushes for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MEDICALBRUSHES_03'
        },
        {
            id: 'MEDICALBRUSHES_04',
            name: ' Medical Brushes Economy',
            category: ' Medical Brushes',
            description: 'Cost-effective  Medical Brushes solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MEDICALBRUSHES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Medical Brushes</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Medical Brushes?</h3>

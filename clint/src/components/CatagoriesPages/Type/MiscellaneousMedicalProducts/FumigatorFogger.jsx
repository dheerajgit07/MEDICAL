...
const FumigatorFogger = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'FUMIGATORFOGGER_01',
            name: ' Fumigator Fogger Basic',
            category: ' Fumigator Fogger',
            description: 'High quality and reliable  Fumigator Fogger designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'FUMIGATORFOGGER_01'
        },
        {
            id: 'FUMIGATORFOGGER_02',
            name: ' Fumigator Fogger Premium',
            category: ' Fumigator Fogger',
            description: 'Advanced  Fumigator Fogger with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'FUMIGATORFOGGER_02'
        },
        {
            id: 'FUMIGATORFOGGER_03',
            name: ' Fumigator Fogger Professional',
            category: ' Fumigator Fogger',
            description: 'Industry-standard  Fumigator Fogger for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'FUMIGATORFOGGER_03'
        },
        {
            id: 'FUMIGATORFOGGER_04',
            name: ' Fumigator Fogger Economy',
            category: ' Fumigator Fogger',
            description: 'Cost-effective  Fumigator Fogger solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'FUMIGATORFOGGER_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Fumigator Fogger</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Fumigator Fogger?</h3>
...
export default FumigatorFogger;

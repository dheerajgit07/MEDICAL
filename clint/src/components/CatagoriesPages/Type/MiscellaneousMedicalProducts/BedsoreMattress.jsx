...
const BedsoreMattress = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'BEDSOREMATTRESS_01',
            name: ' Bedsore Mattress Basic',
            category: ' Bedsore Mattress',
            description: 'High quality and reliable  Bedsore Mattress designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'BEDSOREMATTRESS_01'
        },
        {
            id: 'BEDSOREMATTRESS_02',
            name: ' Bedsore Mattress Premium',
            category: ' Bedsore Mattress',
            description: 'Advanced  Bedsore Mattress with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BEDSOREMATTRESS_02'
        },
        {
            id: 'BEDSOREMATTRESS_03',
            name: ' Bedsore Mattress Professional',
            category: ' Bedsore Mattress',
            description: 'Industry-standard  Bedsore Mattress for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BEDSOREMATTRESS_03'
        },
        {
            id: 'BEDSOREMATTRESS_04',
            name: ' Bedsore Mattress Economy',
            category: ' Bedsore Mattress',
            description: 'Cost-effective  Bedsore Mattress solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BEDSOREMATTRESS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Bedsore Mattress</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Bedsore Mattress?</h3>
...
export default BedsoreMattress;

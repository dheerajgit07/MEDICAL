...
const TimerAndStopWatch = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'TIMERANDSTOPWATCH_01',
            name: ' Timer And Stop Watch Basic',
            category: ' Timer And Stop Watch',
            description: 'High quality and reliable  Timer And Stop Watch designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'TIMERANDSTOPWATCH_01'
        },
        {
            id: 'TIMERANDSTOPWATCH_02',
            name: ' Timer And Stop Watch Premium',
            category: ' Timer And Stop Watch',
            description: 'Advanced  Timer And Stop Watch with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'TIMERANDSTOPWATCH_02'
        },
        {
            id: 'TIMERANDSTOPWATCH_03',
            name: ' Timer And Stop Watch Professional',
            category: ' Timer And Stop Watch',
            description: 'Industry-standard  Timer And Stop Watch for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'TIMERANDSTOPWATCH_03'
        },
        {
            id: 'TIMERANDSTOPWATCH_04',
            name: ' Timer And Stop Watch Economy',
            category: ' Timer And Stop Watch',
            description: 'Cost-effective  Timer And Stop Watch solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'TIMERANDSTOPWATCH_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Timer And Stop Watch</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Timer And Stop Watch?</h3>
...
export default TimerAndStopWatch;

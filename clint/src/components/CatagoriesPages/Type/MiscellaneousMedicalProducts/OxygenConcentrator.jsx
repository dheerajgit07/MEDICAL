...
const OxygenConcentrator = () => {
    ...
    const mockProducts = [
        {
            id: 'OXYGENCONCENTRATOR_01',
            name: ' Oxygen Concentrator Basic',
            category: ' Oxygen Concentrator',
            description: 'High quality and reliable  Oxygen Concentrator designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'OXYGENCONCENTRATOR_01'
        },
        {
            id: 'OXYGENCONCENTRATOR_02',
            name: ' Oxygen Concentrator Premium',
            category: ' Oxygen Concentrator',
            description: 'Advanced  Oxygen Concentrator with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OXYGENCONCENTRATOR_02'
        },
        {
            id: 'OXYGENCONCENTRATOR_03',
            name: ' Oxygen Concentrator Professional',
            category: ' Oxygen Concentrator',
            description: 'Industry-standard  Oxygen Concentrator for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OXYGENCONCENTRATOR_03'
        },
        {
            id: 'OXYGENCONCENTRATOR_04',
            name: ' Oxygen Concentrator Economy',
            category: ' Oxygen Concentrator',
            description: 'Cost-effective  Oxygen Concentrator solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OXYGENCONCENTRATOR_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Oxygen Concentrator</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Oxygen Concentrator?</h3>

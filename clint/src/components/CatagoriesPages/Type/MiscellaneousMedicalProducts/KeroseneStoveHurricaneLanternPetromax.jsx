...
const KeroseneStoveHurricaneLanternPetromax = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'KEROSENESTOVEHURRICANELANTERNPETROMAX_01',
            name: ' Kerosene Stove Hurricane Lantern Petromax Basic',
            category: ' Kerosene Stove Hurricane Lantern Petromax',
            description: 'High quality and reliable  Kerosene Stove Hurricane Lantern Petromax designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'KEROSENESTOVEHURRICANELANTERNPETROMAX_01'
        },
        {
            id: 'KEROSENESTOVEHURRICANELANTERNPETROMAX_02',
            name: ' Kerosene Stove Hurricane Lantern Petromax Premium',
            category: ' Kerosene Stove Hurricane Lantern Petromax',
            description: 'Advanced  Kerosene Stove Hurricane Lantern Petromax with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'KEROSENESTOVEHURRICANELANTERNPETROMAX_02'
        },
        {
            id: 'KEROSENESTOVEHURRICANELANTERNPETROMAX_03',
            name: ' Kerosene Stove Hurricane Lantern Petromax Professional',
            category: ' Kerosene Stove Hurricane Lantern Petromax',
            description: 'Industry-standard  Kerosene Stove Hurricane Lantern Petromax for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'KEROSENESTOVEHURRICANELANTERNPETROMAX_03'
        },
        {
            id: 'KEROSENESTOVEHURRICANELANTERNPETROMAX_04',
            name: ' Kerosene Stove Hurricane Lantern Petromax Economy',
            category: ' Kerosene Stove Hurricane Lantern Petromax',
            description: 'Cost-effective  Kerosene Stove Hurricane Lantern Petromax solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'KEROSENESTOVEHURRICANELANTERNPETROMAX_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Kerosene Stove Hurricane Lantern Petromax</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Kerosene Stove Hurricane Lantern Petromax?</h3>
...
export default KeroseneStoveHurricaneLanternPetromax;

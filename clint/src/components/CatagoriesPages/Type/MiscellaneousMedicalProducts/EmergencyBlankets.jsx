...
const EmergencyBlankets = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'EMERGENCYBLANKETS_01',
            name: ' Emergency Blankets Basic',
            category: ' Emergency Blankets',
            description: 'High quality and reliable  Emergency Blankets designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'EMERGENCYBLANKETS_01'
        },
        {
            id: 'EMERGENCYBLANKETS_02',
            name: ' Emergency Blankets Premium',
            category: ' Emergency Blankets',
            description: 'Advanced  Emergency Blankets with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'EMERGENCYBLANKETS_02'
        },
        {
            id: 'EMERGENCYBLANKETS_03',
            name: ' Emergency Blankets Professional',
            category: ' Emergency Blankets',
            description: 'Industry-standard  Emergency Blankets for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'EMERGENCYBLANKETS_03'
        },
        {
            id: 'EMERGENCYBLANKETS_04',
            name: ' Emergency Blankets Economy',
            category: ' Emergency Blankets',
            description: 'Cost-effective  Emergency Blankets solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'EMERGENCYBLANKETS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Emergency Blankets</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Emergency Blankets?</h3>
...
export default EmergencyBlankets;

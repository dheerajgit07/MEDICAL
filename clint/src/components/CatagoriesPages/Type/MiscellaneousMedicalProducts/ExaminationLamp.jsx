...
const ExaminationLamp = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'EXAMINATIONLAMP_01',
            name: ' Examination Lamp Basic',
            category: ' Examination Lamp',
            description: 'High quality and reliable  Examination Lamp designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'EXAMINATIONLAMP_01'
        },
        {
            id: 'EXAMINATIONLAMP_02',
            name: ' Examination Lamp Premium',
            category: ' Examination Lamp',
            description: 'Advanced  Examination Lamp with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'EXAMINATIONLAMP_02'
        },
        {
            id: 'EXAMINATIONLAMP_03',
            name: ' Examination Lamp Professional',
            category: ' Examination Lamp',
            description: 'Industry-standard  Examination Lamp for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'EXAMINATIONLAMP_03'
        },
        {
            id: 'EXAMINATIONLAMP_04',
            name: ' Examination Lamp Economy',
            category: ' Examination Lamp',
            description: 'Cost-effective  Examination Lamp solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'EXAMINATIONLAMP_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Examination Lamp</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Examination Lamp?</h3>
...
export default ExaminationLamp;

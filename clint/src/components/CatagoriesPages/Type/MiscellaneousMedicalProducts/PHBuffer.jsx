...
const PHBuffer = () => {
    ...
    const mockProducts = [
        {
            id: 'PHBUFFER_01',
            name: ' P H Buffer Basic',
            category: ' P H Buffer',
            description: 'High quality and reliable  P H Buffer designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'PHBUFFER_02',
            name: ' P H Buffer Premium',
            category: ' P H Buffer',
            description: 'Advanced  P H Buffer with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PHBUFFER_02'
        },
        {
            id: 'PHBUFFER_03',
            name: ' P H Buffer Professional',
            category: ' P H Buffer',
            description: 'Industry-standard  P H Buffer for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PHBUFFER_03'
        },
        {
            id: 'PHBUFFER_04',
            name: ' P H Buffer Economy',
            category: ' P H Buffer',
            description: 'Cost-effective  P H Buffer solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PHBUFFER_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> P H Buffer</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  P H Buffer?</h3>

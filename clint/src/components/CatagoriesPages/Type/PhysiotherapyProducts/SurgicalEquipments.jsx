...
const SurgicalEquipments = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'SURGICALEQUIPMENTS_01',
            name: ' Surgical Equipments Basic',
            category: ' Surgical Equipments',
            description: 'High quality and reliable  Surgical Equipments designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'SURGICALEQUIPMENTS_01'
        },
        {
            id: 'SURGICALEQUIPMENTS_02',
            name: ' Surgical Equipments Premium',
            category: ' Surgical Equipments',
            description: 'Advanced  Surgical Equipments with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SURGICALEQUIPMENTS_02'
        },
        {
            id: 'SURGICALEQUIPMENTS_03',
            name: ' Surgical Equipments Professional',
            category: ' Surgical Equipments',
            description: 'Industry-standard  Surgical Equipments for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SURGICALEQUIPMENTS_03'
        },
        {
            id: 'SURGICALEQUIPMENTS_04',
            name: ' Surgical Equipments Economy',
            category: ' Surgical Equipments',
            description: 'Cost-effective  Surgical Equipments solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SURGICALEQUIPMENTS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Surgical Equipments</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Surgical Equipments?</h3>
...
export default SurgicalEquipments;

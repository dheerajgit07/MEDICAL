...
const SlimmingEquipments = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'SLIMMINGEQUIPMENTS_01',
            name: ' Slimming Equipments Basic',
            category: ' Slimming Equipments',
            description: 'High quality and reliable  Slimming Equipments designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'SLIMMINGEQUIPMENTS_01'
        },
        {
            id: 'SLIMMINGEQUIPMENTS_02',
            name: ' Slimming Equipments Premium',
            category: ' Slimming Equipments',
            description: 'Advanced  Slimming Equipments with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SLIMMINGEQUIPMENTS_02'
        },
        {
            id: 'SLIMMINGEQUIPMENTS_03',
            name: ' Slimming Equipments Professional',
            category: ' Slimming Equipments',
            description: 'Industry-standard  Slimming Equipments for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SLIMMINGEQUIPMENTS_03'
        },
        {
            id: 'SLIMMINGEQUIPMENTS_04',
            name: ' Slimming Equipments Economy',
            category: ' Slimming Equipments',
            description: 'Cost-effective  Slimming Equipments solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SLIMMINGEQUIPMENTS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Slimming Equipments</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Slimming Equipments?</h3>
...
export default SlimmingEquipments;

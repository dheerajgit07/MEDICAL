...
const PediatricHospitalBed = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'PEDIATRICHOSPITALBED_01',
            name: ' Pediatric Hospital Bed Basic',
            category: ' Pediatric Hospital Bed',
            description: 'High quality and reliable  Pediatric Hospital Bed designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PEDIATRICHOSPITALBED_01'
        },
        {
            id: 'PEDIATRICHOSPITALBED_02',
            name: ' Pediatric Hospital Bed Premium',
            category: ' Pediatric Hospital Bed',
            description: 'Advanced  Pediatric Hospital Bed with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PEDIATRICHOSPITALBED_02'
        },
        {
            id: 'PEDIATRICHOSPITALBED_03',
            name: ' Pediatric Hospital Bed Professional',
            category: ' Pediatric Hospital Bed',
            description: 'Industry-standard  Pediatric Hospital Bed for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PEDIATRICHOSPITALBED_03'
        },
        {
            id: 'PEDIATRICHOSPITALBED_04',
            name: ' Pediatric Hospital Bed Economy',
            category: ' Pediatric Hospital Bed',
            description: 'Cost-effective  Pediatric Hospital Bed solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PEDIATRICHOSPITALBED_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Pediatric Hospital Bed</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Pediatric Hospital Bed?</h3>
...
export default PediatricHospitalBed;

...
const OrthopedicTractionBed = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'ORTHOPEDICTRACTIONBED_01',
            name: ' Orthopedic Traction Bed Basic',
            category: ' Orthopedic Traction Bed',
            description: 'High quality and reliable  Orthopedic Traction Bed designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'ORTHOPEDICTRACTIONBED_01'
        },
        {
            id: 'ORTHOPEDICTRACTIONBED_02',
            name: ' Orthopedic Traction Bed Premium',
            category: ' Orthopedic Traction Bed',
            description: 'Advanced  Orthopedic Traction Bed with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ORTHOPEDICTRACTIONBED_02'
        },
        {
            id: 'ORTHOPEDICTRACTIONBED_03',
            name: ' Orthopedic Traction Bed Professional',
            category: ' Orthopedic Traction Bed',
            description: 'Industry-standard  Orthopedic Traction Bed for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ORTHOPEDICTRACTIONBED_03'
        },
        {
            id: 'ORTHOPEDICTRACTIONBED_04',
            name: ' Orthopedic Traction Bed Economy',
            category: ' Orthopedic Traction Bed',
            description: 'Cost-effective  Orthopedic Traction Bed solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ORTHOPEDICTRACTIONBED_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Orthopedic Traction Bed</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Orthopedic Traction Bed?</h3>
...
export default OrthopedicTractionBed;

...
const Stretchers = () => {
    ...
    const mockProducts = [
        {
            id: 'STRETCHERS_01',
            name: ' Stretchers Basic',
            category: ' Stretchers',
            description: 'High quality and reliable  Stretchers designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'STRETCHERS_02',
            name: ' Stretchers Premium',
            category: ' Stretchers',
            description: 'Advanced  Stretchers with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'STRETCHERS_02'
        },
        {
            id: 'STRETCHERS_03',
            name: ' Stretchers Professional',
            category: ' Stretchers',
            description: 'Industry-standard  Stretchers for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'STRETCHERS_03'
        },
        {
            id: 'STRETCHERS_04',
            name: ' Stretchers Economy',
            category: ' Stretchers',
            description: 'Cost-effective  Stretchers solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'STRETCHERS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Stretchers</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Stretchers?</h3>

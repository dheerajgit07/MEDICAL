...
const ExaminationDeliveryTables = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'EXAMINATIONDELIVERYTABLES_01',
            name: ' Examination Delivery Tables Basic',
            category: ' Examination Delivery Tables',
            description: 'High quality and reliable  Examination Delivery Tables designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'EXAMINATIONDELIVERYTABLES_01'
        },
        {
            id: 'EXAMINATIONDELIVERYTABLES_02',
            name: ' Examination Delivery Tables Premium',
            category: ' Examination Delivery Tables',
            description: 'Advanced  Examination Delivery Tables with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'EXAMINATIONDELIVERYTABLES_02'
        },
        {
            id: 'EXAMINATIONDELIVERYTABLES_03',
            name: ' Examination Delivery Tables Professional',
            category: ' Examination Delivery Tables',
            description: 'Industry-standard  Examination Delivery Tables for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'EXAMINATIONDELIVERYTABLES_03'
        },
        {
            id: 'EXAMINATIONDELIVERYTABLES_04',
            name: ' Examination Delivery Tables Economy',
            category: ' Examination Delivery Tables',
            description: 'Cost-effective  Examination Delivery Tables solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'EXAMINATIONDELIVERYTABLES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Examination Delivery Tables</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Examination Delivery Tables?</h3>
...
export default ExaminationDeliveryTables;

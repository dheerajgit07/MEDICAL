...
const BloodDonorCouchChairs = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'BLOODDONORCOUCHCHAIRS_01',
            name: ' Blood Donor Couch Chairs Basic',
            category: ' Blood Donor Couch Chairs',
            description: 'High quality and reliable  Blood Donor Couch Chairs designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'BLOODDONORCOUCHCHAIRS_01'
        },
        {
            id: 'BLOODDONORCOUCHCHAIRS_02',
            name: ' Blood Donor Couch Chairs Premium',
            category: ' Blood Donor Couch Chairs',
            description: 'Advanced  Blood Donor Couch Chairs with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BLOODDONORCOUCHCHAIRS_02'
        },
        {
            id: 'BLOODDONORCOUCHCHAIRS_03',
            name: ' Blood Donor Couch Chairs Professional',
            category: ' Blood Donor Couch Chairs',
            description: 'Industry-standard  Blood Donor Couch Chairs for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BLOODDONORCOUCHCHAIRS_03'
        },
        {
            id: 'BLOODDONORCOUCHCHAIRS_04',
            name: ' Blood Donor Couch Chairs Economy',
            category: ' Blood Donor Couch Chairs',
            description: 'Cost-effective  Blood Donor Couch Chairs solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BLOODDONORCOUCHCHAIRS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Blood Donor Couch Chairs</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Blood Donor Couch Chairs?</h3>
...
export default BloodDonorCouchChairs;

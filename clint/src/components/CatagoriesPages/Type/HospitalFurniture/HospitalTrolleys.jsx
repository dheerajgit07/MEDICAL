...
const HospitalTrolleys = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'HOSPITALTROLLEYS_01',
            name: ' Hospital Trolleys Basic',
            category: ' Hospital Trolleys',
            description: 'High quality and reliable  Hospital Trolleys designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'HOSPITALTROLLEYS_01'
        },
        {
            id: 'HOSPITALTROLLEYS_02',
            name: ' Hospital Trolleys Premium',
            category: ' Hospital Trolleys',
            description: 'Advanced  Hospital Trolleys with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOSPITALTROLLEYS_02'
        },
        {
            id: 'HOSPITALTROLLEYS_03',
            name: ' Hospital Trolleys Professional',
            category: ' Hospital Trolleys',
            description: 'Industry-standard  Hospital Trolleys for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOSPITALTROLLEYS_03'
        },
        {
            id: 'HOSPITALTROLLEYS_04',
            name: ' Hospital Trolleys Economy',
            category: ' Hospital Trolleys',
            description: 'Cost-effective  Hospital Trolleys solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOSPITALTROLLEYS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Hospital Trolleys</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Hospital Trolleys?</h3>
...
export default HospitalTrolleys;

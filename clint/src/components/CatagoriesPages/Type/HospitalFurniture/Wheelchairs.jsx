...
const Wheelchairs = () => {
    ...
    const mockProducts = [
        {
            id: 'WHEELCHAIRS_01',
            name: ' Wheelchairs Basic',
            category: ' Wheelchairs',
            description: 'High quality and reliable  Wheelchairs designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'WHEELCHAIRS_02',
            name: ' Wheelchairs Premium',
            category: ' Wheelchairs',
            description: 'Advanced  Wheelchairs with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WHEELCHAIRS_02'
        },
        {
            id: 'WHEELCHAIRS_03',
            name: ' Wheelchairs Professional',
            category: ' Wheelchairs',
            description: 'Industry-standard  Wheelchairs for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WHEELCHAIRS_03'
        },
        {
            id: 'WHEELCHAIRS_04',
            name: ' Wheelchairs Economy',
            category: ' Wheelchairs',
            description: 'Cost-effective  Wheelchairs solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WHEELCHAIRS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Wheelchairs</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Wheelchairs?</h3>

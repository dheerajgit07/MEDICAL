...
const AttendantBed = () => {
    ...
    const mockProducts = [
        {
            id: 'ATTENDANTBED_01',
            name: ' Attendant Bed Basic',
            category: ' Attendant Bed',
            description: 'High quality and reliable  Attendant Bed designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'ATTENDANTBED_02',
            name: ' Attendant Bed Premium',
            category: ' Attendant Bed',
            description: 'Advanced  Attendant Bed with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ATTENDANTBED_02'
        },
        {
            id: 'ATTENDANTBED_03',
            name: ' Attendant Bed Professional',
            category: ' Attendant Bed',
            description: 'Industry-standard  Attendant Bed for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ATTENDANTBED_03'
        },
        {
            id: 'ATTENDANTBED_04',
            name: ' Attendant Bed Economy',
            category: ' Attendant Bed',
            description: 'Cost-effective  Attendant Bed solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ATTENDANTBED_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Attendant Bed</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Attendant Bed?</h3>

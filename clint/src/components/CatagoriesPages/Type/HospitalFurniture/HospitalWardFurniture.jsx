...
const HospitalWardFurniture = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'HOSPITALWARDFURNITURE_01',
            name: ' Hospital Ward Furniture Basic',
            category: ' Hospital Ward Furniture',
            description: 'High quality and reliable  Hospital Ward Furniture designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'HOSPITALWARDFURNITURE_01'
        },
        {
            id: 'HOSPITALWARDFURNITURE_02',
            name: ' Hospital Ward Furniture Premium',
            category: ' Hospital Ward Furniture',
            description: 'Advanced  Hospital Ward Furniture with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOSPITALWARDFURNITURE_02'
        },
        {
            id: 'HOSPITALWARDFURNITURE_03',
            name: ' Hospital Ward Furniture Professional',
            category: ' Hospital Ward Furniture',
            description: 'Industry-standard  Hospital Ward Furniture for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOSPITALWARDFURNITURE_03'
        },
        {
            id: 'HOSPITALWARDFURNITURE_04',
            name: ' Hospital Ward Furniture Economy',
            category: ' Hospital Ward Furniture',
            description: 'Cost-effective  Hospital Ward Furniture solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOSPITALWARDFURNITURE_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Hospital Ward Furniture</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Hospital Ward Furniture?</h3>
...
export default HospitalWardFurniture;

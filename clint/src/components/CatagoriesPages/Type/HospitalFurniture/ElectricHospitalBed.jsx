...
const ElectricHospitalBed = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'ELECTRICHOSPITALBED_01',
            name: ' Electric Hospital Bed Basic',
            category: ' Electric Hospital Bed',
            description: 'High quality and reliable  Electric Hospital Bed designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'ELECTRICHOSPITALBED_01'
        },
        {
            id: 'ELECTRICHOSPITALBED_02',
            name: ' Electric Hospital Bed Premium',
            category: ' Electric Hospital Bed',
            description: 'Advanced  Electric Hospital Bed with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ELECTRICHOSPITALBED_02'
        },
        {
            id: 'ELECTRICHOSPITALBED_03',
            name: ' Electric Hospital Bed Professional',
            category: ' Electric Hospital Bed',
            description: 'Industry-standard  Electric Hospital Bed for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ELECTRICHOSPITALBED_03'
        },
        {
            id: 'ELECTRICHOSPITALBED_04',
            name: ' Electric Hospital Bed Economy',
            category: ' Electric Hospital Bed',
            description: 'Cost-effective  Electric Hospital Bed solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ELECTRICHOSPITALBED_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Electric Hospital Bed</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Electric Hospital Bed?</h3>
...
export default ElectricHospitalBed;

...
const ManualHospitalBed = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'MANUALHOSPITALBED_01',
            name: ' Manual Hospital Bed Basic',
            category: ' Manual Hospital Bed',
            description: 'High quality and reliable  Manual Hospital Bed designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'MANUALHOSPITALBED_01'
        },
        {
            id: 'MANUALHOSPITALBED_02',
            name: ' Manual Hospital Bed Premium',
            category: ' Manual Hospital Bed',
            description: 'Advanced  Manual Hospital Bed with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MANUALHOSPITALBED_02'
        },
        {
            id: 'MANUALHOSPITALBED_03',
            name: ' Manual Hospital Bed Professional',
            category: ' Manual Hospital Bed',
            description: 'Industry-standard  Manual Hospital Bed for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MANUALHOSPITALBED_03'
        },
        {
            id: 'MANUALHOSPITALBED_04',
            name: ' Manual Hospital Bed Economy',
            category: ' Manual Hospital Bed',
            description: 'Cost-effective  Manual Hospital Bed solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MANUALHOSPITALBED_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Manual Hospital Bed</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Manual Hospital Bed?</h3>
...
export default ManualHospitalBed;

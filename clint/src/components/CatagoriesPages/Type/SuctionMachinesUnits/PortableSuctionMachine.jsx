...
const PortableSuctionMachine = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'PORTABLESUCTIONMACHINE_01',
            name: ' Portable Suction Machine Basic',
            category: ' Portable Suction Machine',
            description: 'High quality and reliable  Portable Suction Machine designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PORTABLESUCTIONMACHINE_01'
        },
        {
            id: 'PORTABLESUCTIONMACHINE_02',
            name: ' Portable Suction Machine Premium',
            category: ' Portable Suction Machine',
            description: 'Advanced  Portable Suction Machine with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PORTABLESUCTIONMACHINE_02'
        },
        {
            id: 'PORTABLESUCTIONMACHINE_03',
            name: ' Portable Suction Machine Professional',
            category: ' Portable Suction Machine',
            description: 'Industry-standard  Portable Suction Machine for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PORTABLESUCTIONMACHINE_03'
        },
        {
            id: 'PORTABLESUCTIONMACHINE_04',
            name: ' Portable Suction Machine Economy',
            category: ' Portable Suction Machine',
            description: 'Cost-effective  Portable Suction Machine solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PORTABLESUCTIONMACHINE_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Portable Suction Machine</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Portable Suction Machine?</h3>
...
export default PortableSuctionMachine;

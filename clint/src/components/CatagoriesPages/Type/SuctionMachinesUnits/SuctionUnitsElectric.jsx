...
const SuctionUnitsElectric = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'SUCTIONUNITSELECTRIC_01',
            name: ' Suction Units Electric Basic',
            category: ' Suction Units Electric',
            description: 'High quality and reliable  Suction Units Electric designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'SUCTIONUNITSELECTRIC_01'
        },
        {
            id: 'SUCTIONUNITSELECTRIC_02',
            name: ' Suction Units Electric Premium',
            category: ' Suction Units Electric',
            description: 'Advanced  Suction Units Electric with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SUCTIONUNITSELECTRIC_02'
        },
        {
            id: 'SUCTIONUNITSELECTRIC_03',
            name: ' Suction Units Electric Professional',
            category: ' Suction Units Electric',
            description: 'Industry-standard  Suction Units Electric for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SUCTIONUNITSELECTRIC_03'
        },
        {
            id: 'SUCTIONUNITSELECTRIC_04',
            name: ' Suction Units Electric Economy',
            category: ' Suction Units Electric',
            description: 'Cost-effective  Suction Units Electric solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SUCTIONUNITSELECTRIC_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Suction Units Electric</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Suction Units Electric?</h3>
...
export default SuctionUnitsElectric;

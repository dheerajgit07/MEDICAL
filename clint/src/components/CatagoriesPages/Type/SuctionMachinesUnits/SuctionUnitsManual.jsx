...
const SuctionUnitsManual = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'SUCTIONUNITSMANUAL_01',
            name: ' Suction Units Manual Basic',
            category: ' Suction Units Manual',
            description: 'High quality and reliable  Suction Units Manual designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'SUCTIONUNITSMANUAL_01'
        },
        {
            id: 'SUCTIONUNITSMANUAL_02',
            name: ' Suction Units Manual Premium',
            category: ' Suction Units Manual',
            description: 'Advanced  Suction Units Manual with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SUCTIONUNITSMANUAL_02'
        },
        {
            id: 'SUCTIONUNITSMANUAL_03',
            name: ' Suction Units Manual Professional',
            category: ' Suction Units Manual',
            description: 'Industry-standard  Suction Units Manual for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SUCTIONUNITSMANUAL_03'
        },
        {
            id: 'SUCTIONUNITSMANUAL_04',
            name: ' Suction Units Manual Economy',
            category: ' Suction Units Manual',
            description: 'Cost-effective  Suction Units Manual solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SUCTIONUNITSMANUAL_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Suction Units Manual</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Suction Units Manual?</h3>
...
export default SuctionUnitsManual;

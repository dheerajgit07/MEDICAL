...
const ElectricCumManualSuctionUnits = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'ELECTRICCUMMANUALSUCTIONUNITS_01',
            name: ' Electric Cum Manual Suction Units Basic',
            category: ' Electric Cum Manual Suction Units',
            description: 'High quality and reliable  Electric Cum Manual Suction Units designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'ELECTRICCUMMANUALSUCTIONUNITS_01'
        },
        {
            id: 'ELECTRICCUMMANUALSUCTIONUNITS_02',
            name: ' Electric Cum Manual Suction Units Premium',
            category: ' Electric Cum Manual Suction Units',
            description: 'Advanced  Electric Cum Manual Suction Units with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ELECTRICCUMMANUALSUCTIONUNITS_02'
        },
        {
            id: 'ELECTRICCUMMANUALSUCTIONUNITS_03',
            name: ' Electric Cum Manual Suction Units Professional',
            category: ' Electric Cum Manual Suction Units',
            description: 'Industry-standard  Electric Cum Manual Suction Units for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ELECTRICCUMMANUALSUCTIONUNITS_03'
        },
        {
            id: 'ELECTRICCUMMANUALSUCTIONUNITS_04',
            name: ' Electric Cum Manual Suction Units Economy',
            category: ' Electric Cum Manual Suction Units',
            description: 'Cost-effective  Electric Cum Manual Suction Units solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ELECTRICCUMMANUALSUCTIONUNITS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Electric Cum Manual Suction Units</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Electric Cum Manual Suction Units?</h3>
...
export default ElectricCumManualSuctionUnits;

...
const PipetteBulb = () => {
    ...
    const mockProducts = [
        {
            id: 'PIPETTEBULB_01',
            name: ' Pipette Bulb Basic',
            category: ' Pipette Bulb',
            description: 'High quality and reliable  Pipette Bulb designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'PIPETTEBULB_02',
            name: ' Pipette Bulb Premium',
            category: ' Pipette Bulb',
            description: 'Advanced  Pipette Bulb with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PIPETTEBULB_02'
        },
        {
            id: 'PIPETTEBULB_03',
            name: ' Pipette Bulb Professional',
            category: ' Pipette Bulb',
            description: 'Industry-standard  Pipette Bulb for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PIPETTEBULB_03'
        },
        {
            id: 'PIPETTEBULB_04',
            name: ' Pipette Bulb Economy',
            category: ' Pipette Bulb',
            description: 'Cost-effective  Pipette Bulb solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PIPETTEBULB_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Pipette Bulb</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Pipette Bulb?</h3>

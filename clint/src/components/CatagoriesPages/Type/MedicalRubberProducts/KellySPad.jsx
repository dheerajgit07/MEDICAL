...
const KellySPad = () => {
    ...
    const mockProducts = [
        {
            id: 'KELLYSPAD_01',
            name: ' Kelly S Pad Basic',
            category: ' Kelly S Pad',
            description: 'High quality and reliable  Kelly S Pad designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'KELLYSPAD_02',
            name: ' Kelly S Pad Premium',
            category: ' Kelly S Pad',
            description: 'Advanced  Kelly S Pad with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'KELLYSPAD_02'
        },
        {
            id: 'KELLYSPAD_03',
            name: ' Kelly S Pad Professional',
            category: ' Kelly S Pad',
            description: 'Industry-standard  Kelly S Pad for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'KELLYSPAD_03'
        },
        {
            id: 'KELLYSPAD_04',
            name: ' Kelly S Pad Economy',
            category: ' Kelly S Pad',
            description: 'Cost-effective  Kelly S Pad solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'KELLYSPAD_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Kelly S Pad</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Kelly S Pad?</h3>

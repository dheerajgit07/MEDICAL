...
const RubberDrainageSheet = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'RUBBERDRAINAGESHEET_01',
            name: ' Rubber Drainage Sheet Basic',
            category: ' Rubber Drainage Sheet',
            description: 'High quality and reliable  Rubber Drainage Sheet designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'RUBBERDRAINAGESHEET_01'
        },
        {
            id: 'RUBBERDRAINAGESHEET_02',
            name: ' Rubber Drainage Sheet Premium',
            category: ' Rubber Drainage Sheet',
            description: 'Advanced  Rubber Drainage Sheet with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'RUBBERDRAINAGESHEET_02'
        },
        {
            id: 'RUBBERDRAINAGESHEET_03',
            name: ' Rubber Drainage Sheet Professional',
            category: ' Rubber Drainage Sheet',
            description: 'Industry-standard  Rubber Drainage Sheet for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'RUBBERDRAINAGESHEET_03'
        },
        {
            id: 'RUBBERDRAINAGESHEET_04',
            name: ' Rubber Drainage Sheet Economy',
            category: ' Rubber Drainage Sheet',
            description: 'Cost-effective  Rubber Drainage Sheet solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'RUBBERDRAINAGESHEET_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Rubber Drainage Sheet</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Rubber Drainage Sheet?</h3>
...
export default RubberDrainageSheet;

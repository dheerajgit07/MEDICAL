...
const InfantRectalSyringe = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'INFANTRECTALSYRINGE_01',
            name: ' Infant Rectal Syringe Basic',
            category: ' Infant Rectal Syringe',
            description: 'High quality and reliable  Infant Rectal Syringe designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'INFANTRECTALSYRINGE_01'
        },
        {
            id: 'INFANTRECTALSYRINGE_02',
            name: ' Infant Rectal Syringe Premium',
            category: ' Infant Rectal Syringe',
            description: 'Advanced  Infant Rectal Syringe with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'INFANTRECTALSYRINGE_02'
        },
        {
            id: 'INFANTRECTALSYRINGE_03',
            name: ' Infant Rectal Syringe Professional',
            category: ' Infant Rectal Syringe',
            description: 'Industry-standard  Infant Rectal Syringe for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'INFANTRECTALSYRINGE_03'
        },
        {
            id: 'INFANTRECTALSYRINGE_04',
            name: ' Infant Rectal Syringe Economy',
            category: ' Infant Rectal Syringe',
            description: 'Cost-effective  Infant Rectal Syringe solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'INFANTRECTALSYRINGE_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Infant Rectal Syringe</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Infant Rectal Syringe?</h3>
...
export default InfantRectalSyringe;

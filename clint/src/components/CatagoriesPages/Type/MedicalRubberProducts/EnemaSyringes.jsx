...
const EnemaSyringes = () => {
    ...
    const mockProducts = [
        {
            id: 'ENEMASYRINGES_01',
            name: ' Enema Syringes Basic',
            category: ' Enema Syringes',
            description: 'High quality and reliable  Enema Syringes designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'ENEMASYRINGES_01'
        },
        {
            id: 'ENEMASYRINGES_02',
            name: ' Enema Syringes Premium',
            category: ' Enema Syringes',
            description: 'Advanced  Enema Syringes with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ENEMASYRINGES_02'
        },
        {
            id: 'ENEMASYRINGES_03',
            name: ' Enema Syringes Professional',
            category: ' Enema Syringes',
            description: 'Industry-standard  Enema Syringes for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ENEMASYRINGES_03'
        },
        {
            id: 'ENEMASYRINGES_04',
            name: ' Enema Syringes Economy',
            category: ' Enema Syringes',
            description: 'Cost-effective  Enema Syringes solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ENEMASYRINGES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Enema Syringes</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Enema Syringes?</h3>

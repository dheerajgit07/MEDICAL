...
const HotWaterBottles = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'HOTWATERBOTTLES_01',
            name: ' Hot Water Bottles Basic',
            category: ' Hot Water Bottles',
            description: 'High quality and reliable  Hot Water Bottles designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'HOTWATERBOTTLES_01'
        },
        {
            id: 'HOTWATERBOTTLES_02',
            name: ' Hot Water Bottles Premium',
            category: ' Hot Water Bottles',
            description: 'Advanced  Hot Water Bottles with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOTWATERBOTTLES_02'
        },
        {
            id: 'HOTWATERBOTTLES_03',
            name: ' Hot Water Bottles Professional',
            category: ' Hot Water Bottles',
            description: 'Industry-standard  Hot Water Bottles for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOTWATERBOTTLES_03'
        },
        {
            id: 'HOTWATERBOTTLES_04',
            name: ' Hot Water Bottles Economy',
            category: ' Hot Water Bottles',
            description: 'Cost-effective  Hot Water Bottles solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOTWATERBOTTLES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Hot Water Bottles</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Hot Water Bottles?</h3>
...
export default HotWaterBottles;

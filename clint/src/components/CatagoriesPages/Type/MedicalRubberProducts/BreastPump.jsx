...
const BreastPump = () => {
    ...
    const mockProducts = [
        {
            id: 'BREASTPUMP_01',
            name: ' Breast Pump Basic',
            category: ' Breast Pump',
            description: 'High quality and reliable  Breast Pump designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'BREASTPUMP_02',
            name: ' Breast Pump Premium',
            category: ' Breast Pump',
            description: 'Advanced  Breast Pump with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BREASTPUMP_02'
        },
        {
            id: 'BREASTPUMP_03',
            name: ' Breast Pump Professional',
            category: ' Breast Pump',
            description: 'Industry-standard  Breast Pump for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BREASTPUMP_03'
        },
        {
            id: 'BREASTPUMP_04',
            name: ' Breast Pump Economy',
            category: ' Breast Pump',
            description: 'Cost-effective  Breast Pump solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BREASTPUMP_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Breast Pump</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Breast Pump?</h3>

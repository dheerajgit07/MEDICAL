...
const AirCushionInvalidAirRings = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'AIRCUSHIONINVALIDAIRRINGS_01',
            name: ' Air Cushion Invalid Air Rings Basic',
            category: ' Air Cushion Invalid Air Rings',
            description: 'High quality and reliable  Air Cushion Invalid Air Rings designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'AIRCUSHIONINVALIDAIRRINGS_01'
        },
        {
            id: 'AIRCUSHIONINVALIDAIRRINGS_02',
            name: ' Air Cushion Invalid Air Rings Premium',
            category: ' Air Cushion Invalid Air Rings',
            description: 'Advanced  Air Cushion Invalid Air Rings with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'AIRCUSHIONINVALIDAIRRINGS_02'
        },
        {
            id: 'AIRCUSHIONINVALIDAIRRINGS_03',
            name: ' Air Cushion Invalid Air Rings Professional',
            category: ' Air Cushion Invalid Air Rings',
            description: 'Industry-standard  Air Cushion Invalid Air Rings for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'AIRCUSHIONINVALIDAIRRINGS_03'
        },
        {
            id: 'AIRCUSHIONINVALIDAIRRINGS_04',
            name: ' Air Cushion Invalid Air Rings Economy',
            category: ' Air Cushion Invalid Air Rings',
            description: 'Cost-effective  Air Cushion Invalid Air Rings solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'AIRCUSHIONINVALIDAIRRINGS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Air Cushion Invalid Air Rings</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Air Cushion Invalid Air Rings?</h3>
...
export default AirCushionInvalidAirRings;

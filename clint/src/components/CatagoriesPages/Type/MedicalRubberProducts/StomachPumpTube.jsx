...
const StomachPumpTube = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'STOMACHPUMPTUBE_01',
            name: ' Stomach Pump Tube Basic',
            category: ' Stomach Pump Tube',
            description: 'High quality and reliable  Stomach Pump Tube designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'STOMACHPUMPTUBE_01'
        },
        {
            id: 'STOMACHPUMPTUBE_02',
            name: ' Stomach Pump Tube Premium',
            category: ' Stomach Pump Tube',
            description: 'Advanced  Stomach Pump Tube with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'STOMACHPUMPTUBE_02'
        },
        {
            id: 'STOMACHPUMPTUBE_03',
            name: ' Stomach Pump Tube Professional',
            category: ' Stomach Pump Tube',
            description: 'Industry-standard  Stomach Pump Tube for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'STOMACHPUMPTUBE_03'
        },
        {
            id: 'STOMACHPUMPTUBE_04',
            name: ' Stomach Pump Tube Economy',
            category: ' Stomach Pump Tube',
            description: 'Cost-effective  Stomach Pump Tube solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'STOMACHPUMPTUBE_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Stomach Pump Tube</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Stomach Pump Tube?</h3>
...
export default StomachPumpTube;

...
const DoucheBag = () => {
    ...
    const mockProducts = [
        {
            id: 'DOUCHEBAG_01',
            name: ' Douche Bag Basic',
            category: ' Douche Bag',
            description: 'High quality and reliable  Douche Bag designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'DOUCHEBAG_02',
            name: ' Douche Bag Premium',
            category: ' Douche Bag',
            description: 'Advanced  Douche Bag with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DOUCHEBAG_02'
        },
        {
            id: 'DOUCHEBAG_03',
            name: ' Douche Bag Professional',
            category: ' Douche Bag',
            description: 'Industry-standard  Douche Bag for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DOUCHEBAG_03'
        },
        {
            id: 'DOUCHEBAG_04',
            name: ' Douche Bag Economy',
            category: ' Douche Bag',
            description: 'Cost-effective  Douche Bag solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DOUCHEBAG_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Douche Bag</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Douche Bag?</h3>

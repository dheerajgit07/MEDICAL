...
const Tourniquet = () => {
    ...
    const mockProducts = [
        {
            id: 'TOURNIQUET_01',
            name: ' Tourniquet Basic',
            category: ' Tourniquet',
            description: 'High quality and reliable  Tourniquet designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'TOURNIQUET_02',
            name: ' Tourniquet Premium',
            category: ' Tourniquet',
            description: 'Advanced  Tourniquet with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'TOURNIQUET_02'
        },
        {
            id: 'TOURNIQUET_03',
            name: ' Tourniquet Professional',
            category: ' Tourniquet',
            description: 'Industry-standard  Tourniquet for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'TOURNIQUET_03'
        },
        {
            id: 'TOURNIQUET_04',
            name: ' Tourniquet Economy',
            category: ' Tourniquet',
            description: 'Cost-effective  Tourniquet solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'TOURNIQUET_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Tourniquet</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Tourniquet?</h3>

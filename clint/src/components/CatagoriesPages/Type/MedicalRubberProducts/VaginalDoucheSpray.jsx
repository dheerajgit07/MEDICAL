...
const VaginalDoucheSpray = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'VAGINALDOUCHESPRAY_01',
            name: ' Vaginal Douche Spray Basic',
            category: ' Vaginal Douche Spray',
            description: 'High quality and reliable  Vaginal Douche Spray designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'VAGINALDOUCHESPRAY_01'
        },
        {
            id: 'VAGINALDOUCHESPRAY_02',
            name: ' Vaginal Douche Spray Premium',
            category: ' Vaginal Douche Spray',
            description: 'Advanced  Vaginal Douche Spray with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'VAGINALDOUCHESPRAY_02'
        },
        {
            id: 'VAGINALDOUCHESPRAY_03',
            name: ' Vaginal Douche Spray Professional',
            category: ' Vaginal Douche Spray',
            description: 'Industry-standard  Vaginal Douche Spray for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'VAGINALDOUCHESPRAY_03'
        },
        {
            id: 'VAGINALDOUCHESPRAY_04',
            name: ' Vaginal Douche Spray Economy',
            category: ' Vaginal Douche Spray',
            description: 'Cost-effective  Vaginal Douche Spray solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'VAGINALDOUCHESPRAY_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Vaginal Douche Spray</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Vaginal Douche Spray?</h3>
...
export default VaginalDoucheSpray;

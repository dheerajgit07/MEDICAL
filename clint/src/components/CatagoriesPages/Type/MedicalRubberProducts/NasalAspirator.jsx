...
const NasalAspirator = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'NASALASPIRATOR_01',
            name: ' Nasal Aspirator Basic',
            category: ' Nasal Aspirator',
            description: 'High quality and reliable  Nasal Aspirator designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'NASALASPIRATOR_01'
        },
        {
            id: 'NASALASPIRATOR_02',
            name: ' Nasal Aspirator Premium',
            category: ' Nasal Aspirator',
            description: 'Advanced  Nasal Aspirator with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'NASALASPIRATOR_02'
        },
        {
            id: 'NASALASPIRATOR_03',
            name: ' Nasal Aspirator Professional',
            category: ' Nasal Aspirator',
            description: 'Industry-standard  Nasal Aspirator for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'NASALASPIRATOR_03'
        },
        {
            id: 'NASALASPIRATOR_04',
            name: ' Nasal Aspirator Economy',
            category: ' Nasal Aspirator',
            description: 'Cost-effective  Nasal Aspirator solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'NASALASPIRATOR_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Nasal Aspirator</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Nasal Aspirator?</h3>

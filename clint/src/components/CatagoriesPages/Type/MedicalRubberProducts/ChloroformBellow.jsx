...
const ChloroformBellow = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'CHLOROFORMBELLOW_01',
            name: ' Chloroform Bellow Basic',
            category: ' Chloroform Bellow',
            description: 'High quality and reliable  Chloroform Bellow designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'CHLOROFORMBELLOW_01'
        },
        {
            id: 'CHLOROFORMBELLOW_02',
            name: ' Chloroform Bellow Premium',
            category: ' Chloroform Bellow',
            description: 'Advanced  Chloroform Bellow with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CHLOROFORMBELLOW_02'
        },
        {
            id: 'CHLOROFORMBELLOW_03',
            name: ' Chloroform Bellow Professional',
            category: ' Chloroform Bellow',
            description: 'Industry-standard  Chloroform Bellow for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CHLOROFORMBELLOW_03'
        },
        {
            id: 'CHLOROFORMBELLOW_04',
            name: ' Chloroform Bellow Economy',
            category: ' Chloroform Bellow',
            description: 'Cost-effective  Chloroform Bellow solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CHLOROFORMBELLOW_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Chloroform Bellow</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Chloroform Bellow?</h3>
...
export default ChloroformBellow;

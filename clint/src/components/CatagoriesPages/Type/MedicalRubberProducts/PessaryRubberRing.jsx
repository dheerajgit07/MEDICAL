...
const PessaryRubberRing = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'PESSARYRUBBERRING_01',
            name: ' Pessary Rubber Ring Basic',
            category: ' Pessary Rubber Ring',
            description: 'High quality and reliable  Pessary Rubber Ring designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PESSARYRUBBERRING_01'
        },
        {
            id: 'PESSARYRUBBERRING_02',
            name: ' Pessary Rubber Ring Premium',
            category: ' Pessary Rubber Ring',
            description: 'Advanced  Pessary Rubber Ring with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PESSARYRUBBERRING_02'
        },
        {
            id: 'PESSARYRUBBERRING_03',
            name: ' Pessary Rubber Ring Professional',
            category: ' Pessary Rubber Ring',
            description: 'Industry-standard  Pessary Rubber Ring for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PESSARYRUBBERRING_03'
        },
        {
            id: 'PESSARYRUBBERRING_04',
            name: ' Pessary Rubber Ring Economy',
            category: ' Pessary Rubber Ring',
            description: 'Cost-effective  Pessary Rubber Ring solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PESSARYRUBBERRING_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Pessary Rubber Ring</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Pessary Rubber Ring?</h3>
...
export default PessaryRubberRing;

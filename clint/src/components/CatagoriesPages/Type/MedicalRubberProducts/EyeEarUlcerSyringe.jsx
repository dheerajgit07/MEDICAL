...
const EyeEarUlcerSyringe = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'EYEEARULCERSYRINGE_01',
            name: ' Eye Ear Ulcer Syringe Basic',
            category: ' Eye Ear Ulcer Syringe',
            description: 'High quality and reliable  Eye Ear Ulcer Syringe designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'EYEEARULCERSYRINGE_01'
        },
        {
            id: 'EYEEARULCERSYRINGE_02',
            name: ' Eye Ear Ulcer Syringe Premium',
            category: ' Eye Ear Ulcer Syringe',
            description: 'Advanced  Eye Ear Ulcer Syringe with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'EYEEARULCERSYRINGE_02'
        },
        {
            id: 'EYEEARULCERSYRINGE_03',
            name: ' Eye Ear Ulcer Syringe Professional',
            category: ' Eye Ear Ulcer Syringe',
            description: 'Industry-standard  Eye Ear Ulcer Syringe for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'EYEEARULCERSYRINGE_03'
        },
        {
            id: 'EYEEARULCERSYRINGE_04',
            name: ' Eye Ear Ulcer Syringe Economy',
            category: ' Eye Ear Ulcer Syringe',
            description: 'Cost-effective  Eye Ear Ulcer Syringe solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'EYEEARULCERSYRINGE_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Eye Ear Ulcer Syringe</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Eye Ear Ulcer Syringe?</h3>
...
export default EyeEarUlcerSyringe;

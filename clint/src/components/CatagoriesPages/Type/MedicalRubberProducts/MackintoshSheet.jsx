...
const MackintoshSheet = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'MACKINTOSHSHEET_01',
            name: ' Mackintosh Sheet Basic',
            category: ' Mackintosh Sheet',
            description: 'High quality and reliable  Mackintosh Sheet designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'MACKINTOSHSHEET_01'
        },
        {
            id: 'MACKINTOSHSHEET_02',
            name: ' Mackintosh Sheet Premium',
            category: ' Mackintosh Sheet',
            description: 'Advanced  Mackintosh Sheet with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MACKINTOSHSHEET_02'
        },
        {
            id: 'MACKINTOSHSHEET_03',
            name: ' Mackintosh Sheet Professional',
            category: ' Mackintosh Sheet',
            description: 'Industry-standard  Mackintosh Sheet for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MACKINTOSHSHEET_03'
        },
        {
            id: 'MACKINTOSHSHEET_04',
            name: ' Mackintosh Sheet Economy',
            category: ' Mackintosh Sheet',
            description: 'Cost-effective  Mackintosh Sheet solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MACKINTOSHSHEET_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Mackintosh Sheet</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Mackintosh Sheet?</h3>
...
export default MackintoshSheet;

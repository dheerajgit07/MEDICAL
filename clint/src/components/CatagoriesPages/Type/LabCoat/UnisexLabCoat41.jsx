...
const UnisexLabCoat41 = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'UNISEXLABCOAT41_01',
            name: ' Unisex Lab Coat41 Basic',
            category: ' Unisex Lab Coat41',
            description: 'High quality and reliable  Unisex Lab Coat41 designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'UNISEXLABCOAT41_01'
        },
        {
            id: 'UNISEXLABCOAT41_02',
            name: ' Unisex Lab Coat41 Premium',
            category: ' Unisex Lab Coat41',
            description: 'Advanced  Unisex Lab Coat41 with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'UNISEXLABCOAT41_02'
        },
        {
            id: 'UNISEXLABCOAT41_03',
            name: ' Unisex Lab Coat41 Professional',
            category: ' Unisex Lab Coat41',
            description: 'Industry-standard  Unisex Lab Coat41 for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'UNISEXLABCOAT41_03'
        },
        {
            id: 'UNISEXLABCOAT41_04',
            name: ' Unisex Lab Coat41 Economy',
            category: ' Unisex Lab Coat41',
            description: 'Cost-effective  Unisex Lab Coat41 solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'UNISEXLABCOAT41_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Unisex Lab Coat41</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Unisex Lab Coat41?</h3>
...
export default UnisexLabCoat41;

...
const UnisexLabCoat37 = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'UNISEXLABCOAT37_01',
            name: ' Unisex Lab Coat37 Basic',
            category: ' Unisex Lab Coat37',
            description: 'High quality and reliable  Unisex Lab Coat37 designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'UNISEXLABCOAT37_01'
        },
        {
            id: 'UNISEXLABCOAT37_02',
            name: ' Unisex Lab Coat37 Premium',
            category: ' Unisex Lab Coat37',
            description: 'Advanced  Unisex Lab Coat37 with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'UNISEXLABCOAT37_02'
        },
        {
            id: 'UNISEXLABCOAT37_03',
            name: ' Unisex Lab Coat37 Professional',
            category: ' Unisex Lab Coat37',
            description: 'Industry-standard  Unisex Lab Coat37 for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'UNISEXLABCOAT37_03'
        },
        {
            id: 'UNISEXLABCOAT37_04',
            name: ' Unisex Lab Coat37 Economy',
            category: ' Unisex Lab Coat37',
            description: 'Cost-effective  Unisex Lab Coat37 solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'UNISEXLABCOAT37_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Unisex Lab Coat37</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Unisex Lab Coat37?</h3>
...
export default UnisexLabCoat37;

...
const UnisexLabCoat30 = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'UNISEXLABCOAT30_01',
            name: ' Unisex Lab Coat30 Basic',
            category: ' Unisex Lab Coat30',
            description: 'High quality and reliable  Unisex Lab Coat30 designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'UNISEXLABCOAT30_01'
        },
        {
            id: 'UNISEXLABCOAT30_02',
            name: ' Unisex Lab Coat30 Premium',
            category: ' Unisex Lab Coat30',
            description: 'Advanced  Unisex Lab Coat30 with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'UNISEXLABCOAT30_02'
        },
        {
            id: 'UNISEXLABCOAT30_03',
            name: ' Unisex Lab Coat30 Professional',
            category: ' Unisex Lab Coat30',
            description: 'Industry-standard  Unisex Lab Coat30 for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'UNISEXLABCOAT30_03'
        },
        {
            id: 'UNISEXLABCOAT30_04',
            name: ' Unisex Lab Coat30 Economy',
            category: ' Unisex Lab Coat30',
            description: 'Cost-effective  Unisex Lab Coat30 solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'UNISEXLABCOAT30_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Unisex Lab Coat30</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Unisex Lab Coat30?</h3>
...
export default UnisexLabCoat30;

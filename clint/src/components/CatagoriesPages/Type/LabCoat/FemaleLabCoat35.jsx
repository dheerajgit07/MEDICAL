...
const FemaleLabCoat35 = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'FEMALELABCOAT35_01',
            name: ' Female Lab Coat35 Basic',
            category: ' Female Lab Coat35',
            description: 'High quality and reliable  Female Lab Coat35 designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'FEMALELABCOAT35_01'
        },
        {
            id: 'FEMALELABCOAT35_02',
            name: ' Female Lab Coat35 Premium',
            category: ' Female Lab Coat35',
            description: 'Advanced  Female Lab Coat35 with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'FEMALELABCOAT35_02'
        },
        {
            id: 'FEMALELABCOAT35_03',
            name: ' Female Lab Coat35 Professional',
            category: ' Female Lab Coat35',
            description: 'Industry-standard  Female Lab Coat35 for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'FEMALELABCOAT35_03'
        },
        {
            id: 'FEMALELABCOAT35_04',
            name: ' Female Lab Coat35 Economy',
            category: ' Female Lab Coat35',
            description: 'Cost-effective  Female Lab Coat35 solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'FEMALELABCOAT35_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Female Lab Coat35</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Female Lab Coat35?</h3>
...
export default FemaleLabCoat35;

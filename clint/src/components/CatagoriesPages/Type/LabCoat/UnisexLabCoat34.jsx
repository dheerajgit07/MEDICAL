...
const UnisexLabCoat34 = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'UNISEXLABCOAT34_01',
            name: ' Unisex Lab Coat34 Basic',
            category: ' Unisex Lab Coat34',
            description: 'High quality and reliable  Unisex Lab Coat34 designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'UNISEXLABCOAT34_01'
        },
        {
            id: 'UNISEXLABCOAT34_02',
            name: ' Unisex Lab Coat34 Premium',
            category: ' Unisex Lab Coat34',
            description: 'Advanced  Unisex Lab Coat34 with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'UNISEXLABCOAT34_02'
        },
        {
            id: 'UNISEXLABCOAT34_03',
            name: ' Unisex Lab Coat34 Professional',
            category: ' Unisex Lab Coat34',
            description: 'Industry-standard  Unisex Lab Coat34 for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'UNISEXLABCOAT34_03'
        },
        {
            id: 'UNISEXLABCOAT34_04',
            name: ' Unisex Lab Coat34 Economy',
            category: ' Unisex Lab Coat34',
            description: 'Cost-effective  Unisex Lab Coat34 solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'UNISEXLABCOAT34_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Unisex Lab Coat34</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Unisex Lab Coat34?</h3>
...
export default UnisexLabCoat34;

...
const FemaleLabCoat28 = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'FEMALELABCOAT28_01',
            name: ' Female Lab Coat28 Basic',
            category: ' Female Lab Coat28',
            description: 'High quality and reliable  Female Lab Coat28 designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'FEMALELABCOAT28_01'
        },
        {
            id: 'FEMALELABCOAT28_02',
            name: ' Female Lab Coat28 Premium',
            category: ' Female Lab Coat28',
            description: 'Advanced  Female Lab Coat28 with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'FEMALELABCOAT28_02'
        },
        {
            id: 'FEMALELABCOAT28_03',
            name: ' Female Lab Coat28 Professional',
            category: ' Female Lab Coat28',
            description: 'Industry-standard  Female Lab Coat28 for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'FEMALELABCOAT28_03'
        },
        {
            id: 'FEMALELABCOAT28_04',
            name: ' Female Lab Coat28 Economy',
            category: ' Female Lab Coat28',
            description: 'Cost-effective  Female Lab Coat28 solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'FEMALELABCOAT28_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Female Lab Coat28</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Female Lab Coat28?</h3>
...
export default FemaleLabCoat28;

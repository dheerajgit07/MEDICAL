...
const LaparoscopicBipolarForceps = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'LAPAROSCOPICBIPOLARFORCEPS_01',
            name: ' Laparoscopic Bipolar Forceps Basic',
            category: ' Laparoscopic Bipolar Forceps',
            description: 'High quality and reliable  Laparoscopic Bipolar Forceps designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'LAPAROSCOPICBIPOLARFORCEPS_01'
        },
        {
            id: 'LAPAROSCOPICBIPOLARFORCEPS_02',
            name: ' Laparoscopic Bipolar Forceps Premium',
            category: ' Laparoscopic Bipolar Forceps',
            description: 'Advanced  Laparoscopic Bipolar Forceps with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICBIPOLARFORCEPS_02'
        },
        {
            id: 'LAPAROSCOPICBIPOLARFORCEPS_03',
            name: ' Laparoscopic Bipolar Forceps Professional',
            category: ' Laparoscopic Bipolar Forceps',
            description: 'Industry-standard  Laparoscopic Bipolar Forceps for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICBIPOLARFORCEPS_03'
        },
        {
            id: 'LAPAROSCOPICBIPOLARFORCEPS_04',
            name: ' Laparoscopic Bipolar Forceps Economy',
            category: ' Laparoscopic Bipolar Forceps',
            description: 'Cost-effective  Laparoscopic Bipolar Forceps solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICBIPOLARFORCEPS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Laparoscopic Bipolar Forceps</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Laparoscopic Bipolar Forceps?</h3>
...
export default LaparoscopicBipolarForceps;

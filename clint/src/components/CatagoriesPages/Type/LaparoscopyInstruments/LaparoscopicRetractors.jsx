...
const LaparoscopicRetractors = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'LAPAROSCOPICRETRACTORS_01',
            name: ' Laparoscopic Retractors Basic',
            category: ' Laparoscopic Retractors',
            description: 'High quality and reliable  Laparoscopic Retractors designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'LAPAROSCOPICRETRACTORS_01'
        },
        {
            id: 'LAPAROSCOPICRETRACTORS_02',
            name: ' Laparoscopic Retractors Premium',
            category: ' Laparoscopic Retractors',
            description: 'Advanced  Laparoscopic Retractors with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICRETRACTORS_02'
        },
        {
            id: 'LAPAROSCOPICRETRACTORS_03',
            name: ' Laparoscopic Retractors Professional',
            category: ' Laparoscopic Retractors',
            description: 'Industry-standard  Laparoscopic Retractors for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICRETRACTORS_03'
        },
        {
            id: 'LAPAROSCOPICRETRACTORS_04',
            name: ' Laparoscopic Retractors Economy',
            category: ' Laparoscopic Retractors',
            description: 'Cost-effective  Laparoscopic Retractors solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICRETRACTORS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Laparoscopic Retractors</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Laparoscopic Retractors?</h3>
...
export default LaparoscopicRetractors;

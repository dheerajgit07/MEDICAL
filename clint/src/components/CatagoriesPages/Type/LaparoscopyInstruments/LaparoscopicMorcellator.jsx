...
const LaparoscopicMorcellator = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'LAPAROSCOPICMORCELLATOR_01',
            name: ' Laparoscopic Morcellator Basic',
            category: ' Laparoscopic Morcellator',
            description: 'High quality and reliable  Laparoscopic Morcellator designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'LAPAROSCOPICMORCELLATOR_01'
        },
        {
            id: 'LAPAROSCOPICMORCELLATOR_02',
            name: ' Laparoscopic Morcellator Premium',
            category: ' Laparoscopic Morcellator',
            description: 'Advanced  Laparoscopic Morcellator with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICMORCELLATOR_02'
        },
        {
            id: 'LAPAROSCOPICMORCELLATOR_03',
            name: ' Laparoscopic Morcellator Professional',
            category: ' Laparoscopic Morcellator',
            description: 'Industry-standard  Laparoscopic Morcellator for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICMORCELLATOR_03'
        },
        {
            id: 'LAPAROSCOPICMORCELLATOR_04',
            name: ' Laparoscopic Morcellator Economy',
            category: ' Laparoscopic Morcellator',
            description: 'Cost-effective  Laparoscopic Morcellator solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICMORCELLATOR_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Laparoscopic Morcellator</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Laparoscopic Morcellator?</h3>
...
export default LaparoscopicMorcellator;

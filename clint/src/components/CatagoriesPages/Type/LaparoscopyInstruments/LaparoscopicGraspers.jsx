...
const LaparoscopicGraspers = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'LAPAROSCOPICGRASPERS_01',
            name: ' Laparoscopic Graspers Basic',
            category: ' Laparoscopic Graspers',
            description: 'High quality and reliable  Laparoscopic Graspers designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'LAPAROSCOPICGRASPERS_01'
        },
        {
            id: 'LAPAROSCOPICGRASPERS_02',
            name: ' Laparoscopic Graspers Premium',
            category: ' Laparoscopic Graspers',
            description: 'Advanced  Laparoscopic Graspers with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICGRASPERS_02'
        },
        {
            id: 'LAPAROSCOPICGRASPERS_03',
            name: ' Laparoscopic Graspers Professional',
            category: ' Laparoscopic Graspers',
            description: 'Industry-standard  Laparoscopic Graspers for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICGRASPERS_03'
        },
        {
            id: 'LAPAROSCOPICGRASPERS_04',
            name: ' Laparoscopic Graspers Economy',
            category: ' Laparoscopic Graspers',
            description: 'Cost-effective  Laparoscopic Graspers solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICGRASPERS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Laparoscopic Graspers</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Laparoscopic Graspers?</h3>
...
export default LaparoscopicGraspers;

...
const LaparoscopicDissectors = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'LAPAROSCOPICDISSECTORS_01',
            name: ' Laparoscopic Dissectors Basic',
            category: ' Laparoscopic Dissectors',
            description: 'High quality and reliable  Laparoscopic Dissectors designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'LAPAROSCOPICDISSECTORS_01'
        },
        {
            id: 'LAPAROSCOPICDISSECTORS_02',
            name: ' Laparoscopic Dissectors Premium',
            category: ' Laparoscopic Dissectors',
            description: 'Advanced  Laparoscopic Dissectors with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICDISSECTORS_02'
        },
        {
            id: 'LAPAROSCOPICDISSECTORS_03',
            name: ' Laparoscopic Dissectors Professional',
            category: ' Laparoscopic Dissectors',
            description: 'Industry-standard  Laparoscopic Dissectors for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICDISSECTORS_03'
        },
        {
            id: 'LAPAROSCOPICDISSECTORS_04',
            name: ' Laparoscopic Dissectors Economy',
            category: ' Laparoscopic Dissectors',
            description: 'Cost-effective  Laparoscopic Dissectors solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICDISSECTORS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Laparoscopic Dissectors</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Laparoscopic Dissectors?</h3>
...
export default LaparoscopicDissectors;

...
const LaparoscopicTrocarCannula = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'LAPAROSCOPICTROCARCANNULA_01',
            name: ' Laparoscopic Trocar Cannula Basic',
            category: ' Laparoscopic Trocar Cannula',
            description: 'High quality and reliable  Laparoscopic Trocar Cannula designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'LAPAROSCOPICTROCARCANNULA_01'
        },
        {
            id: 'LAPAROSCOPICTROCARCANNULA_02',
            name: ' Laparoscopic Trocar Cannula Premium',
            category: ' Laparoscopic Trocar Cannula',
            description: 'Advanced  Laparoscopic Trocar Cannula with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICTROCARCANNULA_02'
        },
        {
            id: 'LAPAROSCOPICTROCARCANNULA_03',
            name: ' Laparoscopic Trocar Cannula Professional',
            category: ' Laparoscopic Trocar Cannula',
            description: 'Industry-standard  Laparoscopic Trocar Cannula for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICTROCARCANNULA_03'
        },
        {
            id: 'LAPAROSCOPICTROCARCANNULA_04',
            name: ' Laparoscopic Trocar Cannula Economy',
            category: ' Laparoscopic Trocar Cannula',
            description: 'Cost-effective  Laparoscopic Trocar Cannula solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICTROCARCANNULA_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Laparoscopic Trocar Cannula</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Laparoscopic Trocar Cannula?</h3>
...
export default LaparoscopicTrocarCannula;

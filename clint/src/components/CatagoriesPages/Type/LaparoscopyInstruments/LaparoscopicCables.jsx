...
const LaparoscopicCables = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'LAPAROSCOPICCABLES_01',
            name: ' Laparoscopic Cables Basic',
            category: ' Laparoscopic Cables',
            description: 'High quality and reliable  Laparoscopic Cables designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'LAPAROSCOPICCABLES_01'
        },
        {
            id: 'LAPAROSCOPICCABLES_02',
            name: ' Laparoscopic Cables Premium',
            category: ' Laparoscopic Cables',
            description: 'Advanced  Laparoscopic Cables with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICCABLES_02'
        },
        {
            id: 'LAPAROSCOPICCABLES_03',
            name: ' Laparoscopic Cables Professional',
            category: ' Laparoscopic Cables',
            description: 'Industry-standard  Laparoscopic Cables for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICCABLES_03'
        },
        {
            id: 'LAPAROSCOPICCABLES_04',
            name: ' Laparoscopic Cables Economy',
            category: ' Laparoscopic Cables',
            description: 'Cost-effective  Laparoscopic Cables solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICCABLES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Laparoscopic Cables</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Laparoscopic Cables?</h3>
...
export default LaparoscopicCables;

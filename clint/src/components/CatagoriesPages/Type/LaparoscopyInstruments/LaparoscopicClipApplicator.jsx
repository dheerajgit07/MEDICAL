...
const LaparoscopicClipApplicator = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'LAPAROSCOPICCLIPAPPLICATOR_01',
            name: ' Laparoscopic Clip Applicator Basic',
            category: ' Laparoscopic Clip Applicator',
            description: 'High quality and reliable  Laparoscopic Clip Applicator designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'LAPAROSCOPICCLIPAPPLICATOR_01'
        },
        {
            id: 'LAPAROSCOPICCLIPAPPLICATOR_02',
            name: ' Laparoscopic Clip Applicator Premium',
            category: ' Laparoscopic Clip Applicator',
            description: 'Advanced  Laparoscopic Clip Applicator with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICCLIPAPPLICATOR_02'
        },
        {
            id: 'LAPAROSCOPICCLIPAPPLICATOR_03',
            name: ' Laparoscopic Clip Applicator Professional',
            category: ' Laparoscopic Clip Applicator',
            description: 'Industry-standard  Laparoscopic Clip Applicator for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICCLIPAPPLICATOR_03'
        },
        {
            id: 'LAPAROSCOPICCLIPAPPLICATOR_04',
            name: ' Laparoscopic Clip Applicator Economy',
            category: ' Laparoscopic Clip Applicator',
            description: 'Cost-effective  Laparoscopic Clip Applicator solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICCLIPAPPLICATOR_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Laparoscopic Clip Applicator</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Laparoscopic Clip Applicator?</h3>
...
export default LaparoscopicClipApplicator;

...
const LaparoscopicUterineManipulator = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'LAPAROSCOPICUTERINEMANIPULATOR_01',
            name: ' Laparoscopic Uterine Manipulator Basic',
            category: ' Laparoscopic Uterine Manipulator',
            description: 'High quality and reliable  Laparoscopic Uterine Manipulator designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'LAPAROSCOPICUTERINEMANIPULATOR_01'
        },
        {
            id: 'LAPAROSCOPICUTERINEMANIPULATOR_02',
            name: ' Laparoscopic Uterine Manipulator Premium',
            category: ' Laparoscopic Uterine Manipulator',
            description: 'Advanced  Laparoscopic Uterine Manipulator with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICUTERINEMANIPULATOR_02'
        },
        {
            id: 'LAPAROSCOPICUTERINEMANIPULATOR_03',
            name: ' Laparoscopic Uterine Manipulator Professional',
            category: ' Laparoscopic Uterine Manipulator',
            description: 'Industry-standard  Laparoscopic Uterine Manipulator for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICUTERINEMANIPULATOR_03'
        },
        {
            id: 'LAPAROSCOPICUTERINEMANIPULATOR_04',
            name: ' Laparoscopic Uterine Manipulator Economy',
            category: ' Laparoscopic Uterine Manipulator',
            description: 'Cost-effective  Laparoscopic Uterine Manipulator solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICUTERINEMANIPULATOR_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Laparoscopic Uterine Manipulator</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Laparoscopic Uterine Manipulator?</h3>
...
export default LaparoscopicUterineManipulator;

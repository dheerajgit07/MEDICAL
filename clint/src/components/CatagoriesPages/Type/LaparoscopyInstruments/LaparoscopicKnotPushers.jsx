...
const LaparoscopicKnotPushers = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'LAPAROSCOPICKNOTPUSHERS_01',
            name: ' Laparoscopic Knot Pushers Basic',
            category: ' Laparoscopic Knot Pushers',
            description: 'High quality and reliable  Laparoscopic Knot Pushers designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'LAPAROSCOPICKNOTPUSHERS_01'
        },
        {
            id: 'LAPAROSCOPICKNOTPUSHERS_02',
            name: ' Laparoscopic Knot Pushers Premium',
            category: ' Laparoscopic Knot Pushers',
            description: 'Advanced  Laparoscopic Knot Pushers with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICKNOTPUSHERS_02'
        },
        {
            id: 'LAPAROSCOPICKNOTPUSHERS_03',
            name: ' Laparoscopic Knot Pushers Professional',
            category: ' Laparoscopic Knot Pushers',
            description: 'Industry-standard  Laparoscopic Knot Pushers for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICKNOTPUSHERS_03'
        },
        {
            id: 'LAPAROSCOPICKNOTPUSHERS_04',
            name: ' Laparoscopic Knot Pushers Economy',
            category: ' Laparoscopic Knot Pushers',
            description: 'Cost-effective  Laparoscopic Knot Pushers solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICKNOTPUSHERS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Laparoscopic Knot Pushers</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Laparoscopic Knot Pushers?</h3>
...
export default LaparoscopicKnotPushers;

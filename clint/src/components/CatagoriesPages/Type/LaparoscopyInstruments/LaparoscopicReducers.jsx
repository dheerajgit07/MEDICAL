...
const LaparoscopicReducers = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'LAPAROSCOPICREDUCERS_01',
            name: ' Laparoscopic Reducers Basic',
            category: ' Laparoscopic Reducers',
            description: 'High quality and reliable  Laparoscopic Reducers designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'LAPAROSCOPICREDUCERS_01'
        },
        {
            id: 'LAPAROSCOPICREDUCERS_02',
            name: ' Laparoscopic Reducers Premium',
            category: ' Laparoscopic Reducers',
            description: 'Advanced  Laparoscopic Reducers with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICREDUCERS_02'
        },
        {
            id: 'LAPAROSCOPICREDUCERS_03',
            name: ' Laparoscopic Reducers Professional',
            category: ' Laparoscopic Reducers',
            description: 'Industry-standard  Laparoscopic Reducers for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICREDUCERS_03'
        },
        {
            id: 'LAPAROSCOPICREDUCERS_04',
            name: ' Laparoscopic Reducers Economy',
            category: ' Laparoscopic Reducers',
            description: 'Cost-effective  Laparoscopic Reducers solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICREDUCERS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Laparoscopic Reducers</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Laparoscopic Reducers?</h3>
...
export default LaparoscopicReducers;

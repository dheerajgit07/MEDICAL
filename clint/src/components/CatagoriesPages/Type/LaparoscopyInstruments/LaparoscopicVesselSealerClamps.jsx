...
const LaparoscopicVesselSealerClamps = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'LAPAROSCOPICVESSELSEALERCLAMPS_01',
            name: ' Laparoscopic Vessel Sealer Clamps Basic',
            category: ' Laparoscopic Vessel Sealer Clamps',
            description: 'High quality and reliable  Laparoscopic Vessel Sealer Clamps designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'LAPAROSCOPICVESSELSEALERCLAMPS_01'
        },
        {
            id: 'LAPAROSCOPICVESSELSEALERCLAMPS_02',
            name: ' Laparoscopic Vessel Sealer Clamps Premium',
            category: ' Laparoscopic Vessel Sealer Clamps',
            description: 'Advanced  Laparoscopic Vessel Sealer Clamps with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICVESSELSEALERCLAMPS_02'
        },
        {
            id: 'LAPAROSCOPICVESSELSEALERCLAMPS_03',
            name: ' Laparoscopic Vessel Sealer Clamps Professional',
            category: ' Laparoscopic Vessel Sealer Clamps',
            description: 'Industry-standard  Laparoscopic Vessel Sealer Clamps for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICVESSELSEALERCLAMPS_03'
        },
        {
            id: 'LAPAROSCOPICVESSELSEALERCLAMPS_04',
            name: ' Laparoscopic Vessel Sealer Clamps Economy',
            category: ' Laparoscopic Vessel Sealer Clamps',
            description: 'Cost-effective  Laparoscopic Vessel Sealer Clamps solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICVESSELSEALERCLAMPS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Laparoscopic Vessel Sealer Clamps</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Laparoscopic Vessel Sealer Clamps?</h3>
...
export default LaparoscopicVesselSealerClamps;

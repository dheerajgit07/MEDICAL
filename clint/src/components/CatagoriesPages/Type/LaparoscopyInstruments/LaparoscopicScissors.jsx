...
const LaparoscopicScissors = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'LAPAROSCOPICSCISSORS_01',
            name: ' Laparoscopic Scissors Basic',
            category: ' Laparoscopic Scissors',
            description: 'High quality and reliable  Laparoscopic Scissors designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'LAPAROSCOPICSCISSORS_01'
        },
        {
            id: 'LAPAROSCOPICSCISSORS_02',
            name: ' Laparoscopic Scissors Premium',
            category: ' Laparoscopic Scissors',
            description: 'Advanced  Laparoscopic Scissors with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICSCISSORS_02'
        },
        {
            id: 'LAPAROSCOPICSCISSORS_03',
            name: ' Laparoscopic Scissors Professional',
            category: ' Laparoscopic Scissors',
            description: 'Industry-standard  Laparoscopic Scissors for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICSCISSORS_03'
        },
        {
            id: 'LAPAROSCOPICSCISSORS_04',
            name: ' Laparoscopic Scissors Economy',
            category: ' Laparoscopic Scissors',
            description: 'Cost-effective  Laparoscopic Scissors solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICSCISSORS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Laparoscopic Scissors</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Laparoscopic Scissors?</h3>
...
export default LaparoscopicScissors;

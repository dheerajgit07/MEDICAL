...
const LaparoscopicStoneHoldingForceps = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'LAPAROSCOPICSTONEHOLDINGFORCEPS_01',
            name: ' Laparoscopic Stone Holding Forceps Basic',
            category: ' Laparoscopic Stone Holding Forceps',
            description: 'High quality and reliable  Laparoscopic Stone Holding Forceps designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'LAPAROSCOPICSTONEHOLDINGFORCEPS_01'
        },
        {
            id: 'LAPAROSCOPICSTONEHOLDINGFORCEPS_02',
            name: ' Laparoscopic Stone Holding Forceps Premium',
            category: ' Laparoscopic Stone Holding Forceps',
            description: 'Advanced  Laparoscopic Stone Holding Forceps with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICSTONEHOLDINGFORCEPS_02'
        },
        {
            id: 'LAPAROSCOPICSTONEHOLDINGFORCEPS_03',
            name: ' Laparoscopic Stone Holding Forceps Professional',
            category: ' Laparoscopic Stone Holding Forceps',
            description: 'Industry-standard  Laparoscopic Stone Holding Forceps for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICSTONEHOLDINGFORCEPS_03'
        },
        {
            id: 'LAPAROSCOPICSTONEHOLDINGFORCEPS_04',
            name: ' Laparoscopic Stone Holding Forceps Economy',
            category: ' Laparoscopic Stone Holding Forceps',
            description: 'Cost-effective  Laparoscopic Stone Holding Forceps solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICSTONEHOLDINGFORCEPS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Laparoscopic Stone Holding Forceps</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Laparoscopic Stone Holding Forceps?</h3>
...
export default LaparoscopicStoneHoldingForceps;

...
const LaparoscopicNeedleHolders = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'LAPAROSCOPICNEEDLEHOLDERS_01',
            name: ' Laparoscopic Needle Holders Basic',
            category: ' Laparoscopic Needle Holders',
            description: 'High quality and reliable  Laparoscopic Needle Holders designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'LAPAROSCOPICNEEDLEHOLDERS_01'
        },
        {
            id: 'LAPAROSCOPICNEEDLEHOLDERS_02',
            name: ' Laparoscopic Needle Holders Premium',
            category: ' Laparoscopic Needle Holders',
            description: 'Advanced  Laparoscopic Needle Holders with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICNEEDLEHOLDERS_02'
        },
        {
            id: 'LAPAROSCOPICNEEDLEHOLDERS_03',
            name: ' Laparoscopic Needle Holders Professional',
            category: ' Laparoscopic Needle Holders',
            description: 'Industry-standard  Laparoscopic Needle Holders for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICNEEDLEHOLDERS_03'
        },
        {
            id: 'LAPAROSCOPICNEEDLEHOLDERS_04',
            name: ' Laparoscopic Needle Holders Economy',
            category: ' Laparoscopic Needle Holders',
            description: 'Cost-effective  Laparoscopic Needle Holders solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICNEEDLEHOLDERS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Laparoscopic Needle Holders</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Laparoscopic Needle Holders?</h3>
...
export default LaparoscopicNeedleHolders;

...
const LaparoscopicVeressNeedle = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'LAPAROSCOPICVERESSNEEDLE_01',
            name: ' Laparoscopic Veress Needle Basic',
            category: ' Laparoscopic Veress Needle',
            description: 'High quality and reliable  Laparoscopic Veress Needle designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'LAPAROSCOPICVERESSNEEDLE_01'
        },
        {
            id: 'LAPAROSCOPICVERESSNEEDLE_02',
            name: ' Laparoscopic Veress Needle Premium',
            category: ' Laparoscopic Veress Needle',
            description: 'Advanced  Laparoscopic Veress Needle with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICVERESSNEEDLE_02'
        },
        {
            id: 'LAPAROSCOPICVERESSNEEDLE_03',
            name: ' Laparoscopic Veress Needle Professional',
            category: ' Laparoscopic Veress Needle',
            description: 'Industry-standard  Laparoscopic Veress Needle for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICVERESSNEEDLE_03'
        },
        {
            id: 'LAPAROSCOPICVERESSNEEDLE_04',
            name: ' Laparoscopic Veress Needle Economy',
            category: ' Laparoscopic Veress Needle',
            description: 'Cost-effective  Laparoscopic Veress Needle solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LAPAROSCOPICVERESSNEEDLE_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Laparoscopic Veress Needle</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Laparoscopic Veress Needle?</h3>
...
export default LaparoscopicVeressNeedle;

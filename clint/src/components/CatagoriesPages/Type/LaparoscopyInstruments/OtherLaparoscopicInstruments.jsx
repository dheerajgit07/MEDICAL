...
const OtherLaparoscopicInstruments = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'OTHERLAPAROSCOPICINSTRUMENTS_01',
            name: ' Other Laparoscopic Instruments Basic',
            category: ' Other Laparoscopic Instruments',
            description: 'High quality and reliable  Other Laparoscopic Instruments designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'OTHERLAPAROSCOPICINSTRUMENTS_01'
        },
        {
            id: 'OTHERLAPAROSCOPICINSTRUMENTS_02',
            name: ' Other Laparoscopic Instruments Premium',
            category: ' Other Laparoscopic Instruments',
            description: 'Advanced  Other Laparoscopic Instruments with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OTHERLAPAROSCOPICINSTRUMENTS_02'
        },
        {
            id: 'OTHERLAPAROSCOPICINSTRUMENTS_03',
            name: ' Other Laparoscopic Instruments Professional',
            category: ' Other Laparoscopic Instruments',
            description: 'Industry-standard  Other Laparoscopic Instruments for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OTHERLAPAROSCOPICINSTRUMENTS_03'
        },
        {
            id: 'OTHERLAPAROSCOPICINSTRUMENTS_04',
            name: ' Other Laparoscopic Instruments Economy',
            category: ' Other Laparoscopic Instruments',
            description: 'Cost-effective  Other Laparoscopic Instruments solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OTHERLAPAROSCOPICINSTRUMENTS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Other Laparoscopic Instruments</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Other Laparoscopic Instruments?</h3>
...
export default OtherLaparoscopicInstruments;

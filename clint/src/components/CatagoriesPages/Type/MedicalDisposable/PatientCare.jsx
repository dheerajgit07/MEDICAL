...
const PatientCare = () => {
    ...
    const mockProducts = [
        {
            id: 'PATIENTCARE_01',
            name: ' Patient Care Basic',
            category: ' Patient Care',
            description: 'High quality and reliable  Patient Care designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'PATIENTCARE_02',
            name: ' Patient Care Premium',
            category: ' Patient Care',
            description: 'Advanced  Patient Care with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PATIENTCARE_02'
        },
        {
            id: 'PATIENTCARE_03',
            name: ' Patient Care Professional',
            category: ' Patient Care',
            description: 'Industry-standard  Patient Care for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PATIENTCARE_03'
        },
        {
            id: 'PATIENTCARE_04',
            name: ' Patient Care Economy',
            category: ' Patient Care',
            description: 'Cost-effective  Patient Care solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PATIENTCARE_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Patient Care</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Patient Care?</h3>

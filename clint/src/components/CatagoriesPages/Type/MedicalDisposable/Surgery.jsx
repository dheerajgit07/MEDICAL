...
const Surgery = () => {
    ...
    const mockProducts = [
        {
            ...
            name: ' Surgery Basic',
            category: ' Surgery',
            description: 'High quality and reliable  Surgery designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'SURGERY_02',
            name: ' Surgery Premium',
            category: ' Surgery',
            description: 'Advanced  Surgery with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SURGERY_02'
        },
        {
            id: 'SURGERY_03',
            name: ' Surgery Professional',
            category: ' Surgery',
            description: 'Industry-standard  Surgery for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SURGERY_03'
        },
        {
            id: 'SURGERY_04',
            name: ' Surgery Economy',
            category: ' Surgery',
            description: 'Cost-effective  Surgery solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SURGERY_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Surgery</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Surgery?</h3>

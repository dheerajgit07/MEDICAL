...
const GastroCare = () => {
    ...
    const mockProducts = [
        {
            id: 'GASTROCARE_01',
            name: ' Gastro Care Basic',
            category: ' Gastro Care',
            description: 'High quality and reliable  Gastro Care designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'GASTROCARE_02',
            name: ' Gastro Care Premium',
            category: ' Gastro Care',
            description: 'Advanced  Gastro Care with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GASTROCARE_02'
        },
        {
            id: 'GASTROCARE_03',
            name: ' Gastro Care Professional',
            category: ' Gastro Care',
            description: 'Industry-standard  Gastro Care for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GASTROCARE_03'
        },
        {
            id: 'GASTROCARE_04',
            name: ' Gastro Care Economy',
            category: ' Gastro Care',
            description: 'Cost-effective  Gastro Care solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GASTROCARE_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Gastro Care</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Gastro Care?</h3>

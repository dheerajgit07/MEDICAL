...
const Anesthesia = () => {
    ...
    const mockProducts = [
        {
            id: 'ANESTHESIA_01',
            name: ' Anesthesia Basic',
            category: ' Anesthesia',
            description: 'High quality and reliable  Anesthesia designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'ANESTHESIA_02',
            name: ' Anesthesia Premium',
            category: ' Anesthesia',
            description: 'Advanced  Anesthesia with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ANESTHESIA_02'
        },
        {
            ...
            category: ' Anesthesia',
            description: 'Industry-standard  Anesthesia for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ANESTHESIA_03'
        },
        {
            id: 'ANESTHESIA_04',
            name: ' Anesthesia Economy',
            category: ' Anesthesia',
            description: 'Cost-effective  Anesthesia solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ANESTHESIA_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Anesthesia</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Anesthesia?</h3>

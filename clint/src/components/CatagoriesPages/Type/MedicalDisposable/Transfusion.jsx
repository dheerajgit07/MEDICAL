...
const Transfusion = () => {
    ...
    const mockProducts = [
        {
            id: 'TRANSFUSION_01',
            name: ' Transfusion Basic',
            category: ' Transfusion',
            description: 'High quality and reliable  Transfusion designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'TRANSFUSION_02',
            name: ' Transfusion Premium',
            category: ' Transfusion',
            description: 'Advanced  Transfusion with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'TRANSFUSION_02'
        },
        {
            id: 'TRANSFUSION_03',
            name: ' Transfusion Professional',
            category: ' Transfusion',
            description: 'Industry-standard  Transfusion for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'TRANSFUSION_03'
        },
        {
            id: 'TRANSFUSION_04',
            name: ' Transfusion Economy',
            category: ' Transfusion',
            description: 'Cost-effective  Transfusion solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'TRANSFUSION_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Transfusion</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Transfusion?</h3>

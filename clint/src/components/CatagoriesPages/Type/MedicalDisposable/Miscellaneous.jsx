...
const Miscellaneous = () => {
    ...
    const mockProducts = [
        {
            ...
            description: 'High quality and reliable  Miscellaneous designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'MISCELLANEOUS_01'
        },
        {
            id: 'MISCELLANEOUS_02',
            name: ' Miscellaneous Premium',
            category: ' Miscellaneous',
            description: 'Advanced  Miscellaneous with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MISCELLANEOUS_02'
        },
        {
            id: 'MISCELLANEOUS_03',
            name: ' Miscellaneous Professional',
            category: ' Miscellaneous',
            description: 'Industry-standard  Miscellaneous for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MISCELLANEOUS_03'
        },
        {
            id: 'MISCELLANEOUS_04',
            name: ' Miscellaneous Economy',
            category: ' Miscellaneous',
            description: 'Cost-effective  Miscellaneous solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MISCELLANEOUS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Miscellaneous</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Miscellaneous?</h3>

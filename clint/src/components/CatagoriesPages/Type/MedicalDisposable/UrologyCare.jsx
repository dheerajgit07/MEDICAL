...
const UrologyCare = () => {
    ...
    const mockProducts = [
        {
            id: 'UROLOGYCARE_01',
            name: ' Urology Care Basic',
            category: ' Urology Care',
            description: 'High quality and reliable  Urology Care designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'UROLOGYCARE_02',
            name: ' Urology Care Premium',
            category: ' Urology Care',
            description: 'Advanced  Urology Care with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'UROLOGYCARE_02'
        },
        {
            id: 'UROLOGYCARE_03',
            name: ' Urology Care Professional',
            category: ' Urology Care',
            description: 'Industry-standard  Urology Care for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'UROLOGYCARE_03'
        },
        {
            id: 'UROLOGYCARE_04',
            name: ' Urology Care Economy',
            category: ' Urology Care',
            description: 'Cost-effective  Urology Care solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'UROLOGYCARE_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Urology Care</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Urology Care?</h3>

...
const CardiacCare = () => {
    ...
    const mockProducts = [
        {
            id: 'CARDIACCARE_01',
            name: ' Cardiac Care Basic',
            category: ' Cardiac Care',
            description: 'High quality and reliable  Cardiac Care designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'CARDIACCARE_02',
            name: ' Cardiac Care Premium',
            category: ' Cardiac Care',
            description: 'Advanced  Cardiac Care with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CARDIACCARE_02'
        },
        {
            id: 'CARDIACCARE_03',
            name: ' Cardiac Care Professional',
            category: ' Cardiac Care',
            description: 'Industry-standard  Cardiac Care for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CARDIACCARE_03'
        },
        {
            id: 'CARDIACCARE_04',
            name: ' Cardiac Care Economy',
            category: ' Cardiac Care',
            description: 'Cost-effective  Cardiac Care solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CARDIACCARE_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Cardiac Care</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Cardiac Care?</h3>

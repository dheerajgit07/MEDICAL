...
const DisposableFaceMask = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'DISPOSABLEFACEMASK_01',
            name: ' Disposable Face Mask Basic',
            category: ' Disposable Face Mask',
            description: 'High quality and reliable  Disposable Face Mask designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'DISPOSABLEFACEMASK_01'
        },
        {
            id: 'DISPOSABLEFACEMASK_02',
            name: ' Disposable Face Mask Premium',
            category: ' Disposable Face Mask',
            description: 'Advanced  Disposable Face Mask with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DISPOSABLEFACEMASK_02'
        },
        {
            id: 'DISPOSABLEFACEMASK_03',
            name: ' Disposable Face Mask Professional',
            category: ' Disposable Face Mask',
            description: 'Industry-standard  Disposable Face Mask for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DISPOSABLEFACEMASK_03'
        },
        {
            id: 'DISPOSABLEFACEMASK_04',
            name: ' Disposable Face Mask Economy',
            category: ' Disposable Face Mask',
            description: 'Cost-effective  Disposable Face Mask solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DISPOSABLEFACEMASK_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Disposable Face Mask</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Disposable Face Mask?</h3>
...
export default DisposableFaceMask;

...
const DisposableBeardMask = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'DISPOSABLEBEARDMASK_01',
            name: ' Disposable Beard Mask Basic',
            category: ' Disposable Beard Mask',
            description: 'High quality and reliable  Disposable Beard Mask designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'DISPOSABLEBEARDMASK_01'
        },
        {
            id: 'DISPOSABLEBEARDMASK_02',
            name: ' Disposable Beard Mask Premium',
            category: ' Disposable Beard Mask',
            description: 'Advanced  Disposable Beard Mask with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DISPOSABLEBEARDMASK_02'
        },
        {
            id: 'DISPOSABLEBEARDMASK_03',
            name: ' Disposable Beard Mask Professional',
            category: ' Disposable Beard Mask',
            description: 'Industry-standard  Disposable Beard Mask for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DISPOSABLEBEARDMASK_03'
        },
        {
            id: 'DISPOSABLEBEARDMASK_04',
            name: ' Disposable Beard Mask Economy',
            category: ' Disposable Beard Mask',
            description: 'Cost-effective  Disposable Beard Mask solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DISPOSABLEBEARDMASK_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Disposable Beard Mask</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Disposable Beard Mask?</h3>
...
export default DisposableBeardMask;

...
const DisposableSurgicalGown = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'DISPOSABLESURGICALGOWN_01',
            name: ' Disposable Surgical Gown Basic',
            category: ' Disposable Surgical Gown',
            description: 'High quality and reliable  Disposable Surgical Gown designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'DISPOSABLESURGICALGOWN_01'
        },
        {
            id: 'DISPOSABLESURGICALGOWN_02',
            name: ' Disposable Surgical Gown Premium',
            category: ' Disposable Surgical Gown',
            description: 'Advanced  Disposable Surgical Gown with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DISPOSABLESURGICALGOWN_02'
        },
        {
            id: 'DISPOSABLESURGICALGOWN_03',
            name: ' Disposable Surgical Gown Professional',
            category: ' Disposable Surgical Gown',
            description: 'Industry-standard  Disposable Surgical Gown for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DISPOSABLESURGICALGOWN_03'
        },
        {
            id: 'DISPOSABLESURGICALGOWN_04',
            name: ' Disposable Surgical Gown Economy',
            category: ' Disposable Surgical Gown',
            description: 'Cost-effective  Disposable Surgical Gown solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DISPOSABLESURGICALGOWN_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Disposable Surgical Gown</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Disposable Surgical Gown?</h3>
...
export default DisposableSurgicalGown;

...
const DisposableCap = () => {
    ...
    const mockProducts = [
        {
            id: 'DISPOSABLECAP_01',
            name: ' Disposable Cap Basic',
            category: ' Disposable Cap',
            description: 'High quality and reliable  Disposable Cap designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'DISPOSABLECAP_01'
        },
        {
            id: 'DISPOSABLECAP_02',
            name: ' Disposable Cap Premium',
            category: ' Disposable Cap',
            description: 'Advanced  Disposable Cap with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DISPOSABLECAP_02'
        },
        {
            id: 'DISPOSABLECAP_03',
            name: ' Disposable Cap Professional',
            category: ' Disposable Cap',
            description: 'Industry-standard  Disposable Cap for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DISPOSABLECAP_03'
        },
        {
            id: 'DISPOSABLECAP_04',
            name: ' Disposable Cap Economy',
            category: ' Disposable Cap',
            description: 'Cost-effective  Disposable Cap solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DISPOSABLECAP_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Disposable Cap</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Disposable Cap?</h3>

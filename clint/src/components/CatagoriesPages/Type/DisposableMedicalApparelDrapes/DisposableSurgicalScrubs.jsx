...
const DisposableSurgicalScrubs = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'DISPOSABLESURGICALSCRUBS_01',
            name: ' Disposable Surgical Scrubs Basic',
            category: ' Disposable Surgical Scrubs',
            description: 'High quality and reliable  Disposable Surgical Scrubs designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'DISPOSABLESURGICALSCRUBS_01'
        },
        {
            id: 'DISPOSABLESURGICALSCRUBS_02',
            name: ' Disposable Surgical Scrubs Premium',
            category: ' Disposable Surgical Scrubs',
            description: 'Advanced  Disposable Surgical Scrubs with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DISPOSABLESURGICALSCRUBS_02'
        },
        {
            id: 'DISPOSABLESURGICALSCRUBS_03',
            name: ' Disposable Surgical Scrubs Professional',
            category: ' Disposable Surgical Scrubs',
            description: 'Industry-standard  Disposable Surgical Scrubs for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DISPOSABLESURGICALSCRUBS_03'
        },
        {
            id: 'DISPOSABLESURGICALSCRUBS_04',
            name: ' Disposable Surgical Scrubs Economy',
            category: ' Disposable Surgical Scrubs',
            description: 'Cost-effective  Disposable Surgical Scrubs solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DISPOSABLESURGICALSCRUBS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Disposable Surgical Scrubs</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Disposable Surgical Scrubs?</h3>
...
export default DisposableSurgicalScrubs;

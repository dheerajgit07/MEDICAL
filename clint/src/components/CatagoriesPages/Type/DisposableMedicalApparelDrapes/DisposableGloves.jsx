...
const DisposableGloves = () => {
    ...
    const mockProducts = [
        {
            id: 'DISPOSABLEGLOVES_01',
            name: ' Disposable Gloves Basic',
            category: ' Disposable Gloves',
            description: 'High quality and reliable  Disposable Gloves designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'DISPOSABLEGLOVES_01'
        },
        {
            id: 'DISPOSABLEGLOVES_02',
            name: ' Disposable Gloves Premium',
            category: ' Disposable Gloves',
            description: 'Advanced  Disposable Gloves with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DISPOSABLEGLOVES_02'
        },
        {
            id: 'DISPOSABLEGLOVES_03',
            name: ' Disposable Gloves Professional',
            category: ' Disposable Gloves',
            description: 'Industry-standard  Disposable Gloves for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DISPOSABLEGLOVES_03'
        },
        {
            id: 'DISPOSABLEGLOVES_04',
            name: ' Disposable Gloves Economy',
            category: ' Disposable Gloves',
            description: 'Cost-effective  Disposable Gloves solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DISPOSABLEGLOVES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Disposable Gloves</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Disposable Gloves?</h3>

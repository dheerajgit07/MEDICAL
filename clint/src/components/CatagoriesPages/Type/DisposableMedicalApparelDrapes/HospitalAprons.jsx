...
const HospitalAprons = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'HOSPITALAPRONS_01',
            name: ' Hospital Aprons Basic',
            category: ' Hospital Aprons',
            description: 'High quality and reliable  Hospital Aprons designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'HOSPITALAPRONS_01'
        },
        {
            id: 'HOSPITALAPRONS_02',
            name: ' Hospital Aprons Premium',
            category: ' Hospital Aprons',
            description: 'Advanced  Hospital Aprons with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOSPITALAPRONS_02'
        },
        {
            id: 'HOSPITALAPRONS_03',
            name: ' Hospital Aprons Professional',
            category: ' Hospital Aprons',
            description: 'Industry-standard  Hospital Aprons for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOSPITALAPRONS_03'
        },
        {
            id: 'HOSPITALAPRONS_04',
            name: ' Hospital Aprons Economy',
            category: ' Hospital Aprons',
            description: 'Cost-effective  Hospital Aprons solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOSPITALAPRONS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Hospital Aprons</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Hospital Aprons?</h3>

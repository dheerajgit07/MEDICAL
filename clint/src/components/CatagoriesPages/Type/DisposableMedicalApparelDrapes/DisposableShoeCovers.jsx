...
const DisposableShoeCovers = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'DISPOSABLESHOECOVERS_01',
            name: ' Disposable Shoe Covers Basic',
            category: ' Disposable Shoe Covers',
            description: 'High quality and reliable  Disposable Shoe Covers designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'DISPOSABLESHOECOVERS_01'
        },
        {
            id: 'DISPOSABLESHOECOVERS_02',
            name: ' Disposable Shoe Covers Premium',
            category: ' Disposable Shoe Covers',
            description: 'Advanced  Disposable Shoe Covers with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DISPOSABLESHOECOVERS_02'
        },
        {
            id: 'DISPOSABLESHOECOVERS_03',
            name: ' Disposable Shoe Covers Professional',
            category: ' Disposable Shoe Covers',
            description: 'Industry-standard  Disposable Shoe Covers for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DISPOSABLESHOECOVERS_03'
        },
        {
            id: 'DISPOSABLESHOECOVERS_04',
            name: ' Disposable Shoe Covers Economy',
            category: ' Disposable Shoe Covers',
            description: 'Cost-effective  Disposable Shoe Covers solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DISPOSABLESHOECOVERS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Disposable Shoe Covers</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Disposable Shoe Covers?</h3>
...
export default DisposableShoeCovers;

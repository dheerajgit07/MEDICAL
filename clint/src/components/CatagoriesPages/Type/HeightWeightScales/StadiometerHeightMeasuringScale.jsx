...
const StadiometerHeightMeasuringScale = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'STADIOMETERHEIGHTMEASURINGSCALE_01',
            name: ' Stadiometer Height Measuring Scale Basic',
            category: ' Stadiometer Height Measuring Scale',
            description: 'High quality and reliable  Stadiometer Height Measuring Scale designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'STADIOMETERHEIGHTMEASURINGSCALE_01'
        },
        {
            id: 'STADIOMETERHEIGHTMEASURINGSCALE_02',
            name: ' Stadiometer Height Measuring Scale Premium',
            category: ' Stadiometer Height Measuring Scale',
            description: 'Advanced  Stadiometer Height Measuring Scale with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'STADIOMETERHEIGHTMEASURINGSCALE_02'
        },
        {
            id: 'STADIOMETERHEIGHTMEASURINGSCALE_03',
            name: ' Stadiometer Height Measuring Scale Professional',
            category: ' Stadiometer Height Measuring Scale',
            description: 'Industry-standard  Stadiometer Height Measuring Scale for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'STADIOMETERHEIGHTMEASURINGSCALE_03'
        },
        {
            id: 'STADIOMETERHEIGHTMEASURINGSCALE_04',
            name: ' Stadiometer Height Measuring Scale Economy',
            category: ' Stadiometer Height Measuring Scale',
            description: 'Cost-effective  Stadiometer Height Measuring Scale solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'STADIOMETERHEIGHTMEASURINGSCALE_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Stadiometer Height Measuring Scale</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Stadiometer Height Measuring Scale?</h3>
...
export default StadiometerHeightMeasuringScale;

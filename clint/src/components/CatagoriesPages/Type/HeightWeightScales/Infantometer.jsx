...
const Infantometer = () => {
    ...
    const mockProducts = [
        {
            id: 'INFANTOMETER_01',
            name: ' Infantometer Basic',
            category: ' Infantometer',
            description: 'High quality and reliable  Infantometer designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'INFANTOMETER_02',
            name: ' Infantometer Premium',
            category: ' Infantometer',
            description: 'Advanced  Infantometer with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'INFANTOMETER_02'
        },
        {
            id: 'INFANTOMETER_03',
            name: ' Infantometer Professional',
            category: ' Infantometer',
            description: 'Industry-standard  Infantometer for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'INFANTOMETER_03'
        },
        {
            id: 'INFANTOMETER_04',
            name: ' Infantometer Economy',
            category: ' Infantometer',
            description: 'Cost-effective  Infantometer solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'INFANTOMETER_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Infantometer</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Infantometer?</h3>

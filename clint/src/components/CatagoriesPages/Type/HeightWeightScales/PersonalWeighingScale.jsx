...
const PersonalWeighingScale = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'PERSONALWEIGHINGSCALE_01',
            name: ' Personal Weighing Scale Basic',
            category: ' Personal Weighing Scale',
            description: 'High quality and reliable  Personal Weighing Scale designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PERSONALWEIGHINGSCALE_01'
        },
        {
            id: 'PERSONALWEIGHINGSCALE_02',
            name: ' Personal Weighing Scale Premium',
            category: ' Personal Weighing Scale',
            description: 'Advanced  Personal Weighing Scale with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PERSONALWEIGHINGSCALE_02'
        },
        {
            id: 'PERSONALWEIGHINGSCALE_03',
            name: ' Personal Weighing Scale Professional',
            category: ' Personal Weighing Scale',
            description: 'Industry-standard  Personal Weighing Scale for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PERSONALWEIGHINGSCALE_03'
        },
        {
            id: 'PERSONALWEIGHINGSCALE_04',
            name: ' Personal Weighing Scale Economy',
            category: ' Personal Weighing Scale',
            description: 'Cost-effective  Personal Weighing Scale solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PERSONALWEIGHINGSCALE_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Personal Weighing Scale</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Personal Weighing Scale?</h3>
...
export default PersonalWeighingScale;

...
const BabyWeighingScales = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'BABYWEIGHINGSCALES_01',
            name: ' Baby Weighing Scales Basic',
            category: ' Baby Weighing Scales',
            description: 'High quality and reliable  Baby Weighing Scales designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'BABYWEIGHINGSCALES_01'
        },
        {
            id: 'BABYWEIGHINGSCALES_02',
            name: ' Baby Weighing Scales Premium',
            category: ' Baby Weighing Scales',
            description: 'Advanced  Baby Weighing Scales with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BABYWEIGHINGSCALES_02'
        },
        {
            id: 'BABYWEIGHINGSCALES_03',
            name: ' Baby Weighing Scales Professional',
            category: ' Baby Weighing Scales',
            description: 'Industry-standard  Baby Weighing Scales for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BABYWEIGHINGSCALES_03'
        },
        {
            id: 'BABYWEIGHINGSCALES_04',
            name: ' Baby Weighing Scales Economy',
            category: ' Baby Weighing Scales',
            description: 'Cost-effective  Baby Weighing Scales solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BABYWEIGHINGSCALES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Baby Weighing Scales</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Baby Weighing Scales?</h3>
...
export default BabyWeighingScales;

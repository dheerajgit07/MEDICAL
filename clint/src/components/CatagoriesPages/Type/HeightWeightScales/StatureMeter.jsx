...
const StatureMeter = () => {
    ...
    const mockProducts = [
        {
            id: 'STATUREMETER_01',
            name: ' Stature Meter Basic',
            category: ' Stature Meter',
            description: 'High quality and reliable  Stature Meter designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'STATUREMETER_02',
            name: ' Stature Meter Premium',
            category: ' Stature Meter',
            description: 'Advanced  Stature Meter with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'STATUREMETER_02'
        },
        {
            id: 'STATUREMETER_03',
            name: ' Stature Meter Professional',
            category: ' Stature Meter',
            description: 'Industry-standard  Stature Meter for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'STATUREMETER_03'
        },
        {
            id: 'STATUREMETER_04',
            name: ' Stature Meter Economy',
            category: ' Stature Meter',
            description: 'Cost-effective  Stature Meter solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'STATUREMETER_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Stature Meter</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Stature Meter?</h3>

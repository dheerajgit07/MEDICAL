...
const MeasuringTape = () => {
    ...
    const mockProducts = [
        {
            id: 'MEASURINGTAPE_01',
            name: ' Measuring Tape Basic',
            category: ' Measuring Tape',
            description: 'High quality and reliable  Measuring Tape designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'MEASURINGTAPE_01'
        },
        {
            id: 'MEASURINGTAPE_02',
            name: ' Measuring Tape Premium',
            category: ' Measuring Tape',
            description: 'Advanced  Measuring Tape with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MEASURINGTAPE_02'
        },
        {
            id: 'MEASURINGTAPE_03',
            name: ' Measuring Tape Professional',
            category: ' Measuring Tape',
            description: 'Industry-standard  Measuring Tape for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MEASURINGTAPE_03'
        },
        {
            id: 'MEASURINGTAPE_04',
            name: ' Measuring Tape Economy',
            category: ' Measuring Tape',
            description: 'Cost-effective  Measuring Tape solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MEASURINGTAPE_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Measuring Tape</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Measuring Tape?</h3>

...
const GeneralProducts = () => {
    ...
    const mockProducts = [
        {
            id: 'GENERALPRODUCTS_01',
            name: ' General Products Basic',
            category: ' General Products',
            description: 'High quality and reliable  General Products designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'GENERALPRODUCTS_01'
        },
        {
            id: 'GENERALPRODUCTS_02',
            name: ' General Products Premium',
            category: ' General Products',
            description: 'Advanced  General Products with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GENERALPRODUCTS_02'
        },
        {
            id: 'GENERALPRODUCTS_03',
            name: ' General Products Professional',
            category: ' General Products',
            description: 'Industry-standard  General Products for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GENERALPRODUCTS_03'
        },
        {
            id: 'GENERALPRODUCTS_04',
            name: ' General Products Economy',
            category: ' General Products',
            description: 'Cost-effective  General Products solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GENERALPRODUCTS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> General Products</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  General Products?</h3>

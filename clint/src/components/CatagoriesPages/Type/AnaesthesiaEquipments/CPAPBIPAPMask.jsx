...
const CPAPBIPAPMask = () => {
    ...
    const mockProducts = [
        {
            id: 'CPAPBIPAPMASK_01',
            name: ' C P A P B I P A P Mask Basic',
            category: ' C P A P B I P A P Mask',
            description: 'High quality and reliable  C P A P B I P A P Mask designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'CPAPBIPAPMASK_01'
        },
        {
            id: 'CPAPBIPAPMASK_02',
            name: ' C P A P B I P A P Mask Premium',
            category: ' C P A P B I P A P Mask',
            description: 'Advanced  C P A P B I P A P Mask with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CPAPBIPAPMASK_02'
        },
        {
            id: 'CPAPBIPAPMASK_03',
            name: ' C P A P B I P A P Mask Professional',
            category: ' C P A P B I P A P Mask',
            description: 'Industry-standard  C P A P B I P A P Mask for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CPAPBIPAPMASK_03'
        },
        {
            id: 'CPAPBIPAPMASK_04',
            name: ' C P A P B I P A P Mask Economy',
            category: ' C P A P B I P A P Mask',
            description: 'Cost-effective  C P A P B I P A P Mask solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CPAPBIPAPMASK_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> C P A P B I P A P Mask</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  C P A P B I P A P Mask?</h3>

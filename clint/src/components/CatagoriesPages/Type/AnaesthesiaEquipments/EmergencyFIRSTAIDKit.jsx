...
const EmergencyFIRSTAIDKit = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'EMERGENCYFIRSTAIDKIT_01',
            name: ' Emergency F I R S T A I D Kit Basic',
            category: ' Emergency F I R S T A I D Kit',
            description: 'High quality and reliable  Emergency F I R S T A I D Kit designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'EMERGENCYFIRSTAIDKIT_01'
        },
        {
            id: 'EMERGENCYFIRSTAIDKIT_02',
            name: ' Emergency F I R S T A I D Kit Premium',
            category: ' Emergency F I R S T A I D Kit',
            description: 'Advanced  Emergency F I R S T A I D Kit with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'EMERGENCYFIRSTAIDKIT_02'
        },
        {
            id: 'EMERGENCYFIRSTAIDKIT_03',
            name: ' Emergency F I R S T A I D Kit Professional',
            category: ' Emergency F I R S T A I D Kit',
            description: 'Industry-standard  Emergency F I R S T A I D Kit for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'EMERGENCYFIRSTAIDKIT_03'
        },
        {
            id: 'EMERGENCYFIRSTAIDKIT_04',
            name: ' Emergency F I R S T A I D Kit Economy',
            category: ' Emergency F I R S T A I D Kit',
            description: 'Cost-effective  Emergency F I R S T A I D Kit solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'EMERGENCYFIRSTAIDKIT_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Emergency F I R S T A I D Kit</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Emergency F I R S T A I D Kit?</h3>
...
export default EmergencyFIRSTAIDKit;

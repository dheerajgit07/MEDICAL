...
const GuedelAirways = () => {
    ...
    const mockProducts = [
        {
            id: 'GUEDELAIRWAYS_01',
            name: ' Guedel Airways Basic',
            category: ' Guedel Airways',
            description: 'High quality and reliable  Guedel Airways designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'GUEDELAIRWAYS_01'
        },
        {
            id: 'GUEDELAIRWAYS_02',
            name: ' Guedel Airways Premium',
            category: ' Guedel Airways',
            description: 'Advanced  Guedel Airways with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GUEDELAIRWAYS_02'
        },
        {
            id: 'GUEDELAIRWAYS_03',
            name: ' Guedel Airways Professional',
            category: ' Guedel Airways',
            description: 'Industry-standard  Guedel Airways for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GUEDELAIRWAYS_03'
        },
        {
            id: 'GUEDELAIRWAYS_04',
            name: ' Guedel Airways Economy',
            category: ' Guedel Airways',
            description: 'Cost-effective  Guedel Airways solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GUEDELAIRWAYS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Guedel Airways</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Guedel Airways?</h3>

...
const NIVNonVentedMask = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'NIVNONVENTEDMASK_01',
            name: ' N I V Non Vented Mask Basic',
            category: ' N I V Non Vented Mask',
            description: 'High quality and reliable  N I V Non Vented Mask designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'NIVNONVENTEDMASK_01'
        },
        {
            id: 'NIVNONVENTEDMASK_02',
            name: ' N I V Non Vented Mask Premium',
            category: ' N I V Non Vented Mask',
            description: 'Advanced  N I V Non Vented Mask with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'NIVNONVENTEDMASK_02'
        },
        {
            id: 'NIVNONVENTEDMASK_03',
            name: ' N I V Non Vented Mask Professional',
            category: ' N I V Non Vented Mask',
            description: 'Industry-standard  N I V Non Vented Mask for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'NIVNONVENTEDMASK_03'
        },
        {
            id: 'NIVNONVENTEDMASK_04',
            name: ' N I V Non Vented Mask Economy',
            category: ' N I V Non Vented Mask',
            description: 'Cost-effective  N I V Non Vented Mask solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'NIVNONVENTEDMASK_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> N I V Non Vented Mask</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  N I V Non Vented Mask?</h3>
...
export default NIVNonVentedMask;

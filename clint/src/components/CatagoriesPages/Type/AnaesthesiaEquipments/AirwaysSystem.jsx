...
const AirwaysSystem = () => {
    ...
    const mockProducts = [
        {
            id: 'AIRWAYSSYSTEM_01',
            name: ' Airways System Basic',
            category: ' Airways System',
            description: 'High quality and reliable  Airways System designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'AIRWAYSSYSTEM_01'
        },
        {
            id: 'AIRWAYSSYSTEM_02',
            name: ' Airways System Premium',
            category: ' Airways System',
            description: 'Advanced  Airways System with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'AIRWAYSSYSTEM_02'
        },
        {
            id: 'AIRWAYSSYSTEM_03',
            name: ' Airways System Professional',
            category: ' Airways System',
            description: 'Industry-standard  Airways System for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'AIRWAYSSYSTEM_03'
        },
        {
            id: 'AIRWAYSSYSTEM_04',
            name: ' Airways System Economy',
            category: ' Airways System',
            description: 'Cost-effective  Airways System solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'AIRWAYSSYSTEM_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Airways System</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Airways System?</h3>

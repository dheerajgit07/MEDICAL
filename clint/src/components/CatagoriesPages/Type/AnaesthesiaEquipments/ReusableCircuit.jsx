...
const ReusableCircuit = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'REUSABLECIRCUIT_01',
            name: ' Reusable Circuit Basic',
            category: ' Reusable Circuit',
            description: 'High quality and reliable  Reusable Circuit designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'REUSABLECIRCUIT_01'
        },
        {
            id: 'REUSABLECIRCUIT_02',
            name: ' Reusable Circuit Premium',
            category: ' Reusable Circuit',
            description: 'Advanced  Reusable Circuit with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'REUSABLECIRCUIT_02'
        },
        {
            id: 'REUSABLECIRCUIT_03',
            name: ' Reusable Circuit Professional',
            category: ' Reusable Circuit',
            description: 'Industry-standard  Reusable Circuit for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'REUSABLECIRCUIT_03'
        },
        {
            id: 'REUSABLECIRCUIT_04',
            name: ' Reusable Circuit Economy',
            category: ' Reusable Circuit',
            description: 'Cost-effective  Reusable Circuit solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'REUSABLECIRCUIT_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Reusable Circuit</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Reusable Circuit?</h3>
...
export default ReusableCircuit;

...
const RebreathingBags = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'REBREATHINGBAGS_01',
            name: ' Rebreathing Bags Basic',
            category: ' Rebreathing Bags',
            description: 'High quality and reliable  Rebreathing Bags designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'REBREATHINGBAGS_01'
        },
        {
            id: 'REBREATHINGBAGS_02',
            name: ' Rebreathing Bags Premium',
            category: ' Rebreathing Bags',
            description: 'Advanced  Rebreathing Bags with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'REBREATHINGBAGS_02'
        },
        {
            id: 'REBREATHINGBAGS_03',
            name: ' Rebreathing Bags Professional',
            category: ' Rebreathing Bags',
            description: 'Industry-standard  Rebreathing Bags for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'REBREATHINGBAGS_03'
        },
        {
            id: 'REBREATHINGBAGS_04',
            name: ' Rebreathing Bags Economy',
            category: ' Rebreathing Bags',
            description: 'Cost-effective  Rebreathing Bags solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'REBREATHINGBAGS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Rebreathing Bags</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Rebreathing Bags?</h3>
...
export default RebreathingBags;

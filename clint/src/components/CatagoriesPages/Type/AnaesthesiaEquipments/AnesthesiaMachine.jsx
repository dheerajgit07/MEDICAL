...
const AnesthesiaMachine = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'ANESTHESIAMACHINE_01',
            name: ' Anesthesia Machine Basic',
            category: ' Anesthesia Machine',
            description: 'High quality and reliable  Anesthesia Machine designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'ANESTHESIAMACHINE_01'
        },
        {
            id: 'ANESTHESIAMACHINE_02',
            name: ' Anesthesia Machine Premium',
            category: ' Anesthesia Machine',
            description: 'Advanced  Anesthesia Machine with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ANESTHESIAMACHINE_02'
        },
        {
            id: 'ANESTHESIAMACHINE_03',
            name: ' Anesthesia Machine Professional',
            category: ' Anesthesia Machine',
            description: 'Industry-standard  Anesthesia Machine for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ANESTHESIAMACHINE_03'
        },
        {
            id: 'ANESTHESIAMACHINE_04',
            name: ' Anesthesia Machine Economy',
            category: ' Anesthesia Machine',
            description: 'Cost-effective  Anesthesia Machine solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ANESTHESIAMACHINE_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Anesthesia Machine</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Anesthesia Machine?</h3>
...
export default AnesthesiaMachine;

...
const MouthOpener = () => {
    ...
    const mockProducts = [
        {
            id: 'MOUTHOPENER_01',
            name: ' Mouth Opener Basic',
            category: ' Mouth Opener',
            description: 'High quality and reliable  Mouth Opener designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'MOUTHOPENER_02',
            name: ' Mouth Opener Premium',
            category: ' Mouth Opener',
            description: 'Advanced  Mouth Opener with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MOUTHOPENER_02'
        },
        {
            id: 'MOUTHOPENER_03',
            name: ' Mouth Opener Professional',
            category: ' Mouth Opener',
            description: 'Industry-standard  Mouth Opener for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MOUTHOPENER_03'
        },
        {
            id: 'MOUTHOPENER_04',
            name: ' Mouth Opener Economy',
            category: ' Mouth Opener',
            description: 'Cost-effective  Mouth Opener solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MOUTHOPENER_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Mouth Opener</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Mouth Opener?</h3>

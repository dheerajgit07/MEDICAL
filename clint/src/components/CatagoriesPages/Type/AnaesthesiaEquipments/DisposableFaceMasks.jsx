...
const DisposableFaceMasks = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'DISPOSABLEFACEMASKS_01',
            name: ' Disposable Face Masks Basic',
            category: ' Disposable Face Masks',
            description: 'High quality and reliable  Disposable Face Masks designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'DISPOSABLEFACEMASKS_01'
        },
        {
            id: 'DISPOSABLEFACEMASKS_02',
            name: ' Disposable Face Masks Premium',
            category: ' Disposable Face Masks',
            description: 'Advanced  Disposable Face Masks with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DISPOSABLEFACEMASKS_02'
        },
        {
            id: 'DISPOSABLEFACEMASKS_03',
            name: ' Disposable Face Masks Professional',
            category: ' Disposable Face Masks',
            description: 'Industry-standard  Disposable Face Masks for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DISPOSABLEFACEMASKS_03'
        },
        {
            id: 'DISPOSABLEFACEMASKS_04',
            name: ' Disposable Face Masks Economy',
            category: ' Disposable Face Masks',
            description: 'Cost-effective  Disposable Face Masks solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'DISPOSABLEFACEMASKS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Disposable Face Masks</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Disposable Face Masks?</h3>
...
export default DisposableFaceMasks;

...
const BreathingCircuit = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'BREATHINGCIRCUIT_01',
            name: ' Breathing Circuit Basic',
            category: ' Breathing Circuit',
            description: 'High quality and reliable  Breathing Circuit designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'BREATHINGCIRCUIT_01'
        },
        {
            id: 'BREATHINGCIRCUIT_02',
            name: ' Breathing Circuit Premium',
            category: ' Breathing Circuit',
            description: 'Advanced  Breathing Circuit with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BREATHINGCIRCUIT_02'
        },
        {
            id: 'BREATHINGCIRCUIT_03',
            name: ' Breathing Circuit Professional',
            category: ' Breathing Circuit',
            description: 'Industry-standard  Breathing Circuit for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BREATHINGCIRCUIT_03'
        },
        {
            id: 'BREATHINGCIRCUIT_04',
            name: ' Breathing Circuit Economy',
            category: ' Breathing Circuit',
            description: 'Cost-effective  Breathing Circuit solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BREATHINGCIRCUIT_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Breathing Circuit</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Breathing Circuit?</h3>
...
export default BreathingCircuit;

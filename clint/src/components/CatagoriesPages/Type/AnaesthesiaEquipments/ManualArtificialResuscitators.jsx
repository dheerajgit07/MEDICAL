...
const ManualArtificialResuscitators = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'MANUALARTIFICIALRESUSCITATORS_01',
            name: ' Manual Artificial Resuscitators Basic',
            category: ' Manual Artificial Resuscitators',
            description: 'High quality and reliable  Manual Artificial Resuscitators designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'MANUALARTIFICIALRESUSCITATORS_01'
        },
        {
            id: 'MANUALARTIFICIALRESUSCITATORS_02',
            name: ' Manual Artificial Resuscitators Premium',
            category: ' Manual Artificial Resuscitators',
            description: 'Advanced  Manual Artificial Resuscitators with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MANUALARTIFICIALRESUSCITATORS_02'
        },
        {
            id: 'MANUALARTIFICIALRESUSCITATORS_03',
            name: ' Manual Artificial Resuscitators Professional',
            category: ' Manual Artificial Resuscitators',
            description: 'Industry-standard  Manual Artificial Resuscitators for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MANUALARTIFICIALRESUSCITATORS_03'
        },
        {
            id: 'MANUALARTIFICIALRESUSCITATORS_04',
            name: ' Manual Artificial Resuscitators Economy',
            category: ' Manual Artificial Resuscitators',
            description: 'Cost-effective  Manual Artificial Resuscitators solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MANUALARTIFICIALRESUSCITATORS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Manual Artificial Resuscitators</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Manual Artificial Resuscitators?</h3>
...
export default ManualArtificialResuscitators;

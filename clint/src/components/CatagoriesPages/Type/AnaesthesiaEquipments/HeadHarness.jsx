...
const HeadHarness = () => {
    ...
    const mockProducts = [
        {
            id: 'HEADHARNESS_01',
            name: ' Head Harness Basic',
            category: ' Head Harness',
            description: 'High quality and reliable  Head Harness designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'HEADHARNESS_02',
            name: ' Head Harness Premium',
            category: ' Head Harness',
            description: 'Advanced  Head Harness with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HEADHARNESS_02'
        },
        {
            id: 'HEADHARNESS_03',
            name: ' Head Harness Professional',
            category: ' Head Harness',
            description: 'Industry-standard  Head Harness for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HEADHARNESS_03'
        },
        {
            id: 'HEADHARNESS_04',
            name: ' Head Harness Economy',
            category: ' Head Harness',
            description: 'Cost-effective  Head Harness solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HEADHARNESS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Head Harness</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Head Harness?</h3>

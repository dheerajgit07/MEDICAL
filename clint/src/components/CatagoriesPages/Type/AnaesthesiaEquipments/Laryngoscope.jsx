...
const Laryngoscope = () => {
    ...
    const mockProducts = [
        {
            id: 'LARYNGOSCOPE_01',
            name: ' Laryngoscope Basic',
            category: ' Laryngoscope',
            description: 'High quality and reliable  Laryngoscope designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'LARYNGOSCOPE_02',
            name: ' Laryngoscope Premium',
            category: ' Laryngoscope',
            description: 'Advanced  Laryngoscope with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LARYNGOSCOPE_02'
        },
        {
            id: 'LARYNGOSCOPE_03',
            name: ' Laryngoscope Professional',
            category: ' Laryngoscope',
            description: 'Industry-standard  Laryngoscope for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LARYNGOSCOPE_03'
        },
        {
            id: 'LARYNGOSCOPE_04',
            name: ' Laryngoscope Economy',
            category: ' Laryngoscope',
            description: 'Cost-effective  Laryngoscope solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LARYNGOSCOPE_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Laryngoscope</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Laryngoscope?</h3>

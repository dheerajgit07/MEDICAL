...
const HighFlowNasalCannula = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'HIGHFLOWNASALCANNULA_01',
            name: ' High Flow Nasal Cannula Basic',
            category: ' High Flow Nasal Cannula',
            description: 'High quality and reliable  High Flow Nasal Cannula designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'HIGHFLOWNASALCANNULA_01'
        },
        {
            id: 'HIGHFLOWNASALCANNULA_02',
            name: ' High Flow Nasal Cannula Premium',
            category: ' High Flow Nasal Cannula',
            description: 'Advanced  High Flow Nasal Cannula with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HIGHFLOWNASALCANNULA_02'
        },
        {
            id: 'HIGHFLOWNASALCANNULA_03',
            name: ' High Flow Nasal Cannula Professional',
            category: ' High Flow Nasal Cannula',
            description: 'Industry-standard  High Flow Nasal Cannula for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HIGHFLOWNASALCANNULA_03'
        },
        {
            id: 'HIGHFLOWNASALCANNULA_04',
            name: ' High Flow Nasal Cannula Economy',
            category: ' High Flow Nasal Cannula',
            description: 'Cost-effective  High Flow Nasal Cannula solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HIGHFLOWNASALCANNULA_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> High Flow Nasal Cannula</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  High Flow Nasal Cannula?</h3>

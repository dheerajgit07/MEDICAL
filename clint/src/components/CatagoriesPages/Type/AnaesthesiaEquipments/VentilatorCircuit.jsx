...
const VentilatorCircuit = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'VENTILATORCIRCUIT_01',
            name: ' Ventilator Circuit Basic',
            category: ' Ventilator Circuit',
            description: 'High quality and reliable  Ventilator Circuit designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'VENTILATORCIRCUIT_01'
        },
        {
            id: 'VENTILATORCIRCUIT_02',
            name: ' Ventilator Circuit Premium',
            category: ' Ventilator Circuit',
            description: 'Advanced  Ventilator Circuit with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'VENTILATORCIRCUIT_02'
        },
        {
            id: 'VENTILATORCIRCUIT_03',
            name: ' Ventilator Circuit Professional',
            category: ' Ventilator Circuit',
            description: 'Industry-standard  Ventilator Circuit for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'VENTILATORCIRCUIT_03'
        },
        {
            id: 'VENTILATORCIRCUIT_04',
            name: ' Ventilator Circuit Economy',
            category: ' Ventilator Circuit',
            description: 'Cost-effective  Ventilator Circuit solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'VENTILATORCIRCUIT_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Ventilator Circuit</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Ventilator Circuit?</h3>
...
export default VentilatorCircuit;

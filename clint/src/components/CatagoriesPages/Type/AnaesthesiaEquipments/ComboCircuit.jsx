...
const ComboCircuit = () => {
    ...
    const mockProducts = [
        {
            id: 'COMBOCIRCUIT_01',
            name: ' Combo Circuit Basic',
            category: ' Combo Circuit',
            description: 'High quality and reliable  Combo Circuit designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'COMBOCIRCUIT_02',
            name: ' Combo Circuit Premium',
            category: ' Combo Circuit',
            description: 'Advanced  Combo Circuit with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'COMBOCIRCUIT_02'
        },
        {
            id: 'COMBOCIRCUIT_03',
            name: ' Combo Circuit Professional',
            category: ' Combo Circuit',
            description: 'Industry-standard  Combo Circuit for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'COMBOCIRCUIT_03'
        },
        {
            id: 'COMBOCIRCUIT_04',
            name: ' Combo Circuit Economy',
            category: ' Combo Circuit',
            description: 'Cost-effective  Combo Circuit solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'COMBOCIRCUIT_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Combo Circuit</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Combo Circuit?</h3>

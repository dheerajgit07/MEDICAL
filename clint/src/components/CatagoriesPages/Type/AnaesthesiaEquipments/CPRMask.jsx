...
const CPRMask = () => {
    ...
    const mockProducts = [
        {
            id: 'CPRMASK_01',
            name: ' C P R Mask Basic',
            category: ' C P R Mask',
            description: 'High quality and reliable  C P R Mask designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'CPRMASK_02',
            name: ' C P R Mask Premium',
            category: ' C P R Mask',
            description: 'Advanced  C P R Mask with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CPRMASK_02'
        },
        {
            id: 'CPRMASK_03',
            name: ' C P R Mask Professional',
            category: ' C P R Mask',
            description: 'Industry-standard  C P R Mask for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CPRMASK_03'
        },
        {
            id: 'CPRMASK_04',
            name: ' C P R Mask Economy',
            category: ' C P R Mask',
            description: 'Cost-effective  C P R Mask solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CPRMASK_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> C P R Mask</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  C P R Mask?</h3>

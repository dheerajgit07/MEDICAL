...
const AnaesthesiaFaceMasks = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'ANAESTHESIAFACEMASKS_01',
            name: ' Anaesthesia Face Masks Basic',
            category: ' Anaesthesia Face Masks',
            description: 'High quality and reliable  Anaesthesia Face Masks designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'ANAESTHESIAFACEMASKS_01'
        },
        {
            id: 'ANAESTHESIAFACEMASKS_02',
            name: ' Anaesthesia Face Masks Premium',
            category: ' Anaesthesia Face Masks',
            description: 'Advanced  Anaesthesia Face Masks with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ANAESTHESIAFACEMASKS_02'
        },
        {
            id: 'ANAESTHESIAFACEMASKS_03',
            name: ' Anaesthesia Face Masks Professional',
            category: ' Anaesthesia Face Masks',
            description: 'Industry-standard  Anaesthesia Face Masks for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ANAESTHESIAFACEMASKS_03'
        },
        {
            id: 'ANAESTHESIAFACEMASKS_04',
            name: ' Anaesthesia Face Masks Economy',
            category: ' Anaesthesia Face Masks',
            description: 'Cost-effective  Anaesthesia Face Masks solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ANAESTHESIAFACEMASKS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Anaesthesia Face Masks</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Anaesthesia Face Masks?</h3>
...
export default AnaesthesiaFaceMasks;

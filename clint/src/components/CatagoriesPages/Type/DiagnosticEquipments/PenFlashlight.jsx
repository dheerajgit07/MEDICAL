...
const PenFlashlight = () => {
    ...
    const mockProducts = [
        {
            id: 'PENFLASHLIGHT_01',
            name: ' Pen Flashlight Basic',
            category: ' Pen Flashlight',
            description: 'High quality and reliable  Pen Flashlight designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PENFLASHLIGHT_01'
        },
        {
            id: 'PENFLASHLIGHT_02',
            name: ' Pen Flashlight Premium',
            category: ' Pen Flashlight',
            description: 'Advanced  Pen Flashlight with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PENFLASHLIGHT_02'
        },
        {
            id: 'PENFLASHLIGHT_03',
            name: ' Pen Flashlight Professional',
            category: ' Pen Flashlight',
            description: 'Industry-standard  Pen Flashlight for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PENFLASHLIGHT_03'
        },
        {
            id: 'PENFLASHLIGHT_04',
            name: ' Pen Flashlight Economy',
            category: ' Pen Flashlight',
            description: 'Cost-effective  Pen Flashlight solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PENFLASHLIGHT_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Pen Flashlight</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Pen Flashlight?</h3>

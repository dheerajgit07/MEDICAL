...
const PodiatryProducts = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'PODIATRYPRODUCTS_01',
            name: ' Podiatry Products Basic',
            category: ' Podiatry Products',
            description: 'High quality and reliable  Podiatry Products designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PODIATRYPRODUCTS_01'
        },
        {
            id: 'PODIATRYPRODUCTS_02',
            name: ' Podiatry Products Premium',
            category: ' Podiatry Products',
            description: 'Advanced  Podiatry Products with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PODIATRYPRODUCTS_02'
        },
        {
            id: 'PODIATRYPRODUCTS_03',
            name: ' Podiatry Products Professional',
            category: ' Podiatry Products',
            description: 'Industry-standard  Podiatry Products for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PODIATRYPRODUCTS_03'
        },
        {
            id: 'PODIATRYPRODUCTS_04',
            name: ' Podiatry Products Economy',
            category: ' Podiatry Products',
            description: 'Cost-effective  Podiatry Products solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PODIATRYPRODUCTS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Podiatry Products</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Podiatry Products?</h3>
...
export default PodiatryProducts;

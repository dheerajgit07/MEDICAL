...
const TongueDepressors = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'TONGUEDEPRESSORS_01',
            name: ' Tongue Depressors Basic',
            category: ' Tongue Depressors',
            description: 'High quality and reliable  Tongue Depressors designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'TONGUEDEPRESSORS_01'
        },
        {
            id: 'TONGUEDEPRESSORS_02',
            name: ' Tongue Depressors Premium',
            category: ' Tongue Depressors',
            description: 'Advanced  Tongue Depressors with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'TONGUEDEPRESSORS_02'
        },
        {
            id: 'TONGUEDEPRESSORS_03',
            name: ' Tongue Depressors Professional',
            category: ' Tongue Depressors',
            description: 'Industry-standard  Tongue Depressors for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'TONGUEDEPRESSORS_03'
        },
        {
            id: 'TONGUEDEPRESSORS_04',
            name: ' Tongue Depressors Economy',
            category: ' Tongue Depressors',
            description: 'Cost-effective  Tongue Depressors solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'TONGUEDEPRESSORS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Tongue Depressors</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Tongue Depressors?</h3>
...
export default TongueDepressors;

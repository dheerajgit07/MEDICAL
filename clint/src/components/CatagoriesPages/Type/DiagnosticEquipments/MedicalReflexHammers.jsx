...
const MedicalReflexHammers = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'MEDICALREFLEXHAMMERS_01',
            name: ' Medical Reflex Hammers Basic',
            category: ' Medical Reflex Hammers',
            description: 'High quality and reliable  Medical Reflex Hammers designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'MEDICALREFLEXHAMMERS_01'
        },
        {
            id: 'MEDICALREFLEXHAMMERS_02',
            name: ' Medical Reflex Hammers Premium',
            category: ' Medical Reflex Hammers',
            description: 'Advanced  Medical Reflex Hammers with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MEDICALREFLEXHAMMERS_02'
        },
        {
            id: 'MEDICALREFLEXHAMMERS_03',
            name: ' Medical Reflex Hammers Professional',
            category: ' Medical Reflex Hammers',
            description: 'Industry-standard  Medical Reflex Hammers for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MEDICALREFLEXHAMMERS_03'
        },
        {
            id: 'MEDICALREFLEXHAMMERS_04',
            name: ' Medical Reflex Hammers Economy',
            category: ' Medical Reflex Hammers',
            description: 'Cost-effective  Medical Reflex Hammers solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MEDICALREFLEXHAMMERS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Medical Reflex Hammers</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Medical Reflex Hammers?</h3>
...
export default MedicalReflexHammers;

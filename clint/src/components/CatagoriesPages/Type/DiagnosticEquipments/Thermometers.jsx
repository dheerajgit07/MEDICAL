...
const Thermometers = () => {
    ...
    const mockProducts = [
        {
            id: 'THERMOMETERS_01',
            name: ' Thermometers Basic',
            category: ' Thermometers',
            description: 'High quality and reliable  Thermometers designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'THERMOMETERS_02',
            name: ' Thermometers Premium',
            category: ' Thermometers',
            description: 'Advanced  Thermometers with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'THERMOMETERS_02'
        },
        {
            id: 'THERMOMETERS_03',
            name: ' Thermometers Professional',
            category: ' Thermometers',
            description: 'Industry-standard  Thermometers for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'THERMOMETERS_03'
        },
        {
            id: 'THERMOMETERS_04',
            name: ' Thermometers Economy',
            category: ' Thermometers',
            description: 'Cost-effective  Thermometers solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'THERMOMETERS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Thermometers</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Thermometers?</h3>

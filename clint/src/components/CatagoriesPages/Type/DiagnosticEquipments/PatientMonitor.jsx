...
const PatientMonitor = () => {
    ...
    const mockProducts = [
        {
            id: 'PATIENTMONITOR_01',
            name: ' Patient Monitor Basic',
            category: ' Patient Monitor',
            description: 'High quality and reliable  Patient Monitor designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PATIENTMONITOR_01'
        },
        {
            id: 'PATIENTMONITOR_02',
            name: ' Patient Monitor Premium',
            category: ' Patient Monitor',
            description: 'Advanced  Patient Monitor with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PATIENTMONITOR_02'
        },
        {
            id: 'PATIENTMONITOR_03',
            name: ' Patient Monitor Professional',
            category: ' Patient Monitor',
            description: 'Industry-standard  Patient Monitor for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PATIENTMONITOR_03'
        },
        {
            id: 'PATIENTMONITOR_04',
            name: ' Patient Monitor Economy',
            category: ' Patient Monitor',
            description: 'Cost-effective  Patient Monitor solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PATIENTMONITOR_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Patient Monitor</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Patient Monitor?</h3>

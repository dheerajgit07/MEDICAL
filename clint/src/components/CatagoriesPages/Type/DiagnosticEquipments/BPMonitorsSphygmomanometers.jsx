...
const BPMonitorsSphygmomanometers = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'BPMONITORSSPHYGMOMANOMETERS_01',
            name: ' B P Monitors Sphygmomanometers Basic',
            category: ' B P Monitors Sphygmomanometers',
            description: 'High quality and reliable  B P Monitors Sphygmomanometers designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'BPMONITORSSPHYGMOMANOMETERS_01'
        },
        {
            id: 'BPMONITORSSPHYGMOMANOMETERS_02',
            name: ' B P Monitors Sphygmomanometers Premium',
            category: ' B P Monitors Sphygmomanometers',
            description: 'Advanced  B P Monitors Sphygmomanometers with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BPMONITORSSPHYGMOMANOMETERS_02'
        },
        {
            id: 'BPMONITORSSPHYGMOMANOMETERS_03',
            name: ' B P Monitors Sphygmomanometers Professional',
            category: ' B P Monitors Sphygmomanometers',
            description: 'Industry-standard  B P Monitors Sphygmomanometers for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BPMONITORSSPHYGMOMANOMETERS_03'
        },
        {
            id: 'BPMONITORSSPHYGMOMANOMETERS_04',
            name: ' B P Monitors Sphygmomanometers Economy',
            category: ' B P Monitors Sphygmomanometers',
            description: 'Cost-effective  B P Monitors Sphygmomanometers solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BPMONITORSSPHYGMOMANOMETERS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> B P Monitors Sphygmomanometers</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  B P Monitors Sphygmomanometers?</h3>
...
export default BPMonitorsSphygmomanometers;

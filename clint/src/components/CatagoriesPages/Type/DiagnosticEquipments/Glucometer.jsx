...
const Glucometer = () => {
    ...
    const mockProducts = [
        {
            ...
            category: ' Glucometer',
            description: 'High quality and reliable  Glucometer designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'GLUCOMETER_02',
            name: ' Glucometer Premium',
            category: ' Glucometer',
            description: 'Advanced  Glucometer with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GLUCOMETER_02'
        },
        {
            id: 'GLUCOMETER_03',
            name: ' Glucometer Professional',
            category: ' Glucometer',
            description: 'Industry-standard  Glucometer for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GLUCOMETER_03'
        },
        {
            id: 'GLUCOMETER_04',
            name: ' Glucometer Economy',
            category: ' Glucometer',
            description: 'Cost-effective  Glucometer solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GLUCOMETER_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Glucometer</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Glucometer?</h3>

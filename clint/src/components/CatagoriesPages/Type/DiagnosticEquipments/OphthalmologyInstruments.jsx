...
const OphthalmologyInstruments = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'OPHTHALMOLOGYINSTRUMENTS_01',
            name: ' Ophthalmology Instruments Basic',
            category: ' Ophthalmology Instruments',
            description: 'High quality and reliable  Ophthalmology Instruments designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'OPHTHALMOLOGYINSTRUMENTS_01'
        },
        {
            id: 'OPHTHALMOLOGYINSTRUMENTS_02',
            name: ' Ophthalmology Instruments Premium',
            category: ' Ophthalmology Instruments',
            description: 'Advanced  Ophthalmology Instruments with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OPHTHALMOLOGYINSTRUMENTS_02'
        },
        {
            id: 'OPHTHALMOLOGYINSTRUMENTS_03',
            name: ' Ophthalmology Instruments Professional',
            category: ' Ophthalmology Instruments',
            description: 'Industry-standard  Ophthalmology Instruments for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OPHTHALMOLOGYINSTRUMENTS_03'
        },
        {
            id: 'OPHTHALMOLOGYINSTRUMENTS_04',
            name: ' Ophthalmology Instruments Economy',
            category: ' Ophthalmology Instruments',
            description: 'Cost-effective  Ophthalmology Instruments solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OPHTHALMOLOGYINSTRUMENTS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Ophthalmology Instruments</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Ophthalmology Instruments?</h3>
...
export default OphthalmologyInstruments;

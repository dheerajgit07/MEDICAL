...
const Stethoscopes = () => {
    ...
    const mockProducts = [
        {
            id: 'STETHOSCOPES_01',
            name: ' Stethoscopes Basic',
            category: ' Stethoscopes',
            description: 'High quality and reliable  Stethoscopes designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'STETHOSCOPES_02',
            name: ' Stethoscopes Premium',
            category: ' Stethoscopes',
            description: 'Advanced  Stethoscopes with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'STETHOSCOPES_02'
        },
        {
            id: 'STETHOSCOPES_03',
            name: ' Stethoscopes Professional',
            category: ' Stethoscopes',
            description: 'Industry-standard  Stethoscopes for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'STETHOSCOPES_03'
        },
        {
            id: 'STETHOSCOPES_04',
            name: ' Stethoscopes Economy',
            category: ' Stethoscopes',
            description: 'Cost-effective  Stethoscopes solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'STETHOSCOPES_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Stethoscopes</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Stethoscopes?</h3>

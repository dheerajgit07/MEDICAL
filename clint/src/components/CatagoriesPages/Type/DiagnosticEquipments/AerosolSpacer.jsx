...
const AerosolSpacer = () => {
    ...
    const mockProducts = [
        {
            id: 'AEROSOLSPACER_01',
            name: ' Aerosol Spacer Basic',
            category: ' Aerosol Spacer',
            description: 'High quality and reliable  Aerosol Spacer designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'AEROSOLSPACER_01'
        },
        {
            id: 'AEROSOLSPACER_02',
            name: ' Aerosol Spacer Premium',
            category: ' Aerosol Spacer',
            description: 'Advanced  Aerosol Spacer with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'AEROSOLSPACER_02'
        },
        {
            id: 'AEROSOLSPACER_03',
            name: ' Aerosol Spacer Professional',
            category: ' Aerosol Spacer',
            description: 'Industry-standard  Aerosol Spacer for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'AEROSOLSPACER_03'
        },
        {
            id: 'AEROSOLSPACER_04',
            name: ' Aerosol Spacer Economy',
            category: ' Aerosol Spacer',
            description: 'Cost-effective  Aerosol Spacer solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'AEROSOLSPACER_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Aerosol Spacer</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Aerosol Spacer?</h3>

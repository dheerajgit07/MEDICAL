...
const ECGMachineECGPaperRolls = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'ECGMACHINEECGPAPERROLLS_01',
            name: ' E C G Machine E C G Paper Rolls Basic',
            category: ' E C G Machine E C G Paper Rolls',
            description: 'High quality and reliable  E C G Machine E C G Paper Rolls designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'ECGMACHINEECGPAPERROLLS_01'
        },
        {
            id: 'ECGMACHINEECGPAPERROLLS_02',
            name: ' E C G Machine E C G Paper Rolls Premium',
            category: ' E C G Machine E C G Paper Rolls',
            description: 'Advanced  E C G Machine E C G Paper Rolls with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ECGMACHINEECGPAPERROLLS_02'
        },
        {
            id: 'ECGMACHINEECGPAPERROLLS_03',
            name: ' E C G Machine E C G Paper Rolls Professional',
            category: ' E C G Machine E C G Paper Rolls',
            description: 'Industry-standard  E C G Machine E C G Paper Rolls for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ECGMACHINEECGPAPERROLLS_03'
        },
        {
            id: 'ECGMACHINEECGPAPERROLLS_04',
            name: ' E C G Machine E C G Paper Rolls Economy',
            category: ' E C G Machine E C G Paper Rolls',
            description: 'Cost-effective  E C G Machine E C G Paper Rolls solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ECGMACHINEECGPAPERROLLS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> E C G Machine E C G Paper Rolls</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  E C G Machine E C G Paper Rolls?</h3>
...
export default ECGMachineECGPaperRolls;

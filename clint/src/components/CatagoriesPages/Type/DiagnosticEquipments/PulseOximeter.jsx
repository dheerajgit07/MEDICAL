...
const PulseOximeter = () => {
    ...
    const mockProducts = [
        {
            ...
            description: 'High quality and reliable  Pulse Oximeter designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PULSEOXIMETER_01'
        },
        {
            id: 'PULSEOXIMETER_02',
            name: ' Pulse Oximeter Premium',
            category: ' Pulse Oximeter',
            description: 'Advanced  Pulse Oximeter with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PULSEOXIMETER_02'
        },
        {
            id: 'PULSEOXIMETER_03',
            name: ' Pulse Oximeter Professional',
            category: ' Pulse Oximeter',
            description: 'Industry-standard  Pulse Oximeter for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PULSEOXIMETER_03'
        },
        {
            id: 'PULSEOXIMETER_04',
            name: ' Pulse Oximeter Economy',
            category: ' Pulse Oximeter',
            description: 'Cost-effective  Pulse Oximeter solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PULSEOXIMETER_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Pulse Oximeter</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Pulse Oximeter?</h3>

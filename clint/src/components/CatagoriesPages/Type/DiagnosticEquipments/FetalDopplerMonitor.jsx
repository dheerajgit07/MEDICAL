...
const FetalDopplerMonitor = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'FETALDOPPLERMONITOR_01',
            name: ' Fetal Doppler Monitor Basic',
            category: ' Fetal Doppler Monitor',
            description: 'High quality and reliable  Fetal Doppler Monitor designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'FETALDOPPLERMONITOR_01'
        },
        {
            id: 'FETALDOPPLERMONITOR_02',
            name: ' Fetal Doppler Monitor Premium',
            category: ' Fetal Doppler Monitor',
            description: 'Advanced  Fetal Doppler Monitor with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'FETALDOPPLERMONITOR_02'
        },
        {
            id: 'FETALDOPPLERMONITOR_03',
            name: ' Fetal Doppler Monitor Professional',
            category: ' Fetal Doppler Monitor',
            description: 'Industry-standard  Fetal Doppler Monitor for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'FETALDOPPLERMONITOR_03'
        },
        {
            id: 'FETALDOPPLERMONITOR_04',
            name: ' Fetal Doppler Monitor Economy',
            category: ' Fetal Doppler Monitor',
            description: 'Cost-effective  Fetal Doppler Monitor solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'FETALDOPPLERMONITOR_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Fetal Doppler Monitor</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Fetal Doppler Monitor?</h3>
...
export default FetalDopplerMonitor;

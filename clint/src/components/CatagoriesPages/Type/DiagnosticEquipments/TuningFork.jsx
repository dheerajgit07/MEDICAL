...
const TuningFork = () => {
    ...
    const mockProducts = [
        {
            id: 'TUNINGFORK_01',
            name: ' Tuning Fork Basic',
            category: ' Tuning Fork',
            description: 'High quality and reliable  Tuning Fork designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'TUNINGFORK_02',
            name: ' Tuning Fork Premium',
            category: ' Tuning Fork',
            description: 'Advanced  Tuning Fork with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'TUNINGFORK_02'
        },
        {
            id: 'TUNINGFORK_03',
            name: ' Tuning Fork Professional',
            category: ' Tuning Fork',
            description: 'Industry-standard  Tuning Fork for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'TUNINGFORK_03'
        },
        {
            id: 'TUNINGFORK_04',
            name: ' Tuning Fork Economy',
            category: ' Tuning Fork',
            description: 'Cost-effective  Tuning Fork solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'TUNINGFORK_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Tuning Fork</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Tuning Fork?</h3>

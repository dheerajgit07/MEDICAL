...
const Goniometer = () => {
    ...
    const mockProducts = [
        {
            id: 'GONIOMETER_01',
            name: ' Goniometer Basic',
            category: ' Goniometer',
            description: 'High quality and reliable  Goniometer designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'GONIOMETER_02',
            name: ' Goniometer Premium',
            category: ' Goniometer',
            description: 'Advanced  Goniometer with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GONIOMETER_02'
        },
        {
            id: 'GONIOMETER_03',
            name: ' Goniometer Professional',
            category: ' Goniometer',
            description: 'Industry-standard  Goniometer for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GONIOMETER_03'
        },
        {
            id: 'GONIOMETER_04',
            name: ' Goniometer Economy',
            category: ' Goniometer',
            description: 'Cost-effective  Goniometer solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GONIOMETER_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Goniometer</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Goniometer?</h3>

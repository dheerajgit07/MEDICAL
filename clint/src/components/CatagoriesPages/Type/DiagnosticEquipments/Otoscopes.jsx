...
const Otoscopes = () => {
    ...
    const mockProducts = [
        {
            id: 'OTOSCOPES_01',
            name: ' Otoscopes Basic',
            category: ' Otoscopes',
            description: 'High quality and reliable  Otoscopes designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'OTOSCOPES_02',
            name: ' Otoscopes Premium',
            category: ' Otoscopes',
            description: 'Advanced  Otoscopes with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OTOSCOPES_02'
        },
        {
            id: 'OTOSCOPES_03',
            name: ' Otoscopes Professional',
            category: ' Otoscopes',
            description: 'Industry-standard  Otoscopes for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OTOSCOPES_03'
        },
        {
            id: 'OTOSCOPES_04',
            name: ' Otoscopes Economy',
            category: ' Otoscopes',
            description: 'Cost-effective  Otoscopes solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OTOSCOPES_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Otoscopes</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Otoscopes?</h3>

...
const PeakFlowMeter = () => {
    ...
    const mockProducts = [
        {
            id: 'PEAKFLOWMETER_01',
            name: ' Peak Flow Meter Basic',
            category: ' Peak Flow Meter',
            description: 'High quality and reliable  Peak Flow Meter designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PEAKFLOWMETER_01'
        },
        {
            id: 'PEAKFLOWMETER_02',
            name: ' Peak Flow Meter Premium',
            category: ' Peak Flow Meter',
            description: 'Advanced  Peak Flow Meter with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PEAKFLOWMETER_02'
        },
        {
            id: 'PEAKFLOWMETER_03',
            name: ' Peak Flow Meter Professional',
            category: ' Peak Flow Meter',
            description: 'Industry-standard  Peak Flow Meter for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PEAKFLOWMETER_03'
        },
        {
            id: 'PEAKFLOWMETER_04',
            name: ' Peak Flow Meter Economy',
            category: ' Peak Flow Meter',
            description: 'Cost-effective  Peak Flow Meter solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PEAKFLOWMETER_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Peak Flow Meter</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Peak Flow Meter?</h3>

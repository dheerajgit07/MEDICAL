...
const CardiothoracicInstruments = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'CARDIOTHORACICINSTRUMENTS_01',
            name: ' Cardiothoracic Instruments Basic',
            category: ' Cardiothoracic Instruments',
            description: 'High quality and reliable  Cardiothoracic Instruments designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'CARDIOTHORACICINSTRUMENTS_01'
        },
        {
            id: 'CARDIOTHORACICINSTRUMENTS_02',
            name: ' Cardiothoracic Instruments Premium',
            category: ' Cardiothoracic Instruments',
            description: 'Advanced  Cardiothoracic Instruments with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CARDIOTHORACICINSTRUMENTS_02'
        },
        {
            id: 'CARDIOTHORACICINSTRUMENTS_03',
            name: ' Cardiothoracic Instruments Professional',
            category: ' Cardiothoracic Instruments',
            description: 'Industry-standard  Cardiothoracic Instruments for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CARDIOTHORACICINSTRUMENTS_03'
        },
        {
            id: 'CARDIOTHORACICINSTRUMENTS_04',
            name: ' Cardiothoracic Instruments Economy',
            category: ' Cardiothoracic Instruments',
            description: 'Cost-effective  Cardiothoracic Instruments solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CARDIOTHORACICINSTRUMENTS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Cardiothoracic Instruments</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Cardiothoracic Instruments?</h3>
...
export default CardiothoracicInstruments;

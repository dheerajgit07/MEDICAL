...
const InstrumentKit = () => {
    ...
    const mockProducts = [
        {
            id: 'INSTRUMENTKIT_01',
            name: ' Instrument Kit Basic',
            category: ' Instrument Kit',
            description: 'High quality and reliable  Instrument Kit designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'INSTRUMENTKIT_01'
        },
        {
            id: 'INSTRUMENTKIT_02',
            name: ' Instrument Kit Premium',
            category: ' Instrument Kit',
            description: 'Advanced  Instrument Kit with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'INSTRUMENTKIT_02'
        },
        {
            id: 'INSTRUMENTKIT_03',
            name: ' Instrument Kit Professional',
            category: ' Instrument Kit',
            description: 'Industry-standard  Instrument Kit for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'INSTRUMENTKIT_03'
        },
        {
            id: 'INSTRUMENTKIT_04',
            name: ' Instrument Kit Economy',
            category: ' Instrument Kit',
            description: 'Cost-effective  Instrument Kit solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'INSTRUMENTKIT_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Instrument Kit</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Instrument Kit?</h3>

...
const SurgicalCannula = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'SURGICALCANNULA_01',
            name: ' Surgical Cannula Basic',
            category: ' Surgical Cannula',
            description: 'High quality and reliable  Surgical Cannula designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'SURGICALCANNULA_01'
        },
        {
            id: 'SURGICALCANNULA_02',
            name: ' Surgical Cannula Premium',
            category: ' Surgical Cannula',
            description: 'Advanced  Surgical Cannula with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SURGICALCANNULA_02'
        },
        {
            id: 'SURGICALCANNULA_03',
            name: ' Surgical Cannula Professional',
            category: ' Surgical Cannula',
            description: 'Industry-standard  Surgical Cannula for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SURGICALCANNULA_03'
        },
        {
            id: 'SURGICALCANNULA_04',
            name: ' Surgical Cannula Economy',
            category: ' Surgical Cannula',
            description: 'Cost-effective  Surgical Cannula solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SURGICALCANNULA_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Surgical Cannula</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Surgical Cannula?</h3>
...
export default SurgicalCannula;

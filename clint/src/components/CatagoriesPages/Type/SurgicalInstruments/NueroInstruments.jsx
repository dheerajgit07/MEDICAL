...
const NueroInstruments = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'NUEROINSTRUMENTS_01',
            name: ' Nuero Instruments Basic',
            category: ' Nuero Instruments',
            description: 'High quality and reliable  Nuero Instruments designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'NUEROINSTRUMENTS_01'
        },
        {
            id: 'NUEROINSTRUMENTS_02',
            name: ' Nuero Instruments Premium',
            category: ' Nuero Instruments',
            description: 'Advanced  Nuero Instruments with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'NUEROINSTRUMENTS_02'
        },
        {
            id: 'NUEROINSTRUMENTS_03',
            name: ' Nuero Instruments Professional',
            category: ' Nuero Instruments',
            description: 'Industry-standard  Nuero Instruments for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'NUEROINSTRUMENTS_03'
        },
        {
            id: 'NUEROINSTRUMENTS_04',
            name: ' Nuero Instruments Economy',
            category: ' Nuero Instruments',
            description: 'Cost-effective  Nuero Instruments solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'NUEROINSTRUMENTS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Nuero Instruments</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Nuero Instruments?</h3>
...
export default NueroInstruments;

...
const GeneralDissectingForceps = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'GENERALDISSECTINGFORCEPS_01',
            name: ' General Dissecting Forceps Basic',
            category: ' General Dissecting Forceps',
            description: 'High quality and reliable  General Dissecting Forceps designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'GENERALDISSECTINGFORCEPS_01'
        },
        {
            id: 'GENERALDISSECTINGFORCEPS_02',
            name: ' General Dissecting Forceps Premium',
            category: ' General Dissecting Forceps',
            description: 'Advanced  General Dissecting Forceps with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GENERALDISSECTINGFORCEPS_02'
        },
        {
            id: 'GENERALDISSECTINGFORCEPS_03',
            name: ' General Dissecting Forceps Professional',
            category: ' General Dissecting Forceps',
            description: 'Industry-standard  General Dissecting Forceps for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GENERALDISSECTINGFORCEPS_03'
        },
        {
            id: 'GENERALDISSECTINGFORCEPS_04',
            name: ' General Dissecting Forceps Economy',
            category: ' General Dissecting Forceps',
            description: 'Cost-effective  General Dissecting Forceps solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GENERALDISSECTINGFORCEPS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> General Dissecting Forceps</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  General Dissecting Forceps?</h3>
...
export default GeneralDissectingForceps;

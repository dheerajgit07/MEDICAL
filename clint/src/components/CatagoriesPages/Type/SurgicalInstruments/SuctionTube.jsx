...
const SuctionTube = () => {
    ...
    const mockProducts = [
        {
            id: 'SUCTIONTUBE_01',
            name: ' Suction Tube Basic',
            category: ' Suction Tube',
            description: 'High quality and reliable  Suction Tube designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'SUCTIONTUBE_02',
            name: ' Suction Tube Premium',
            category: ' Suction Tube',
            description: 'Advanced  Suction Tube with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SUCTIONTUBE_02'
        },
        {
            id: 'SUCTIONTUBE_03',
            name: ' Suction Tube Professional',
            category: ' Suction Tube',
            description: 'Industry-standard  Suction Tube for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SUCTIONTUBE_03'
        },
        {
            id: 'SUCTIONTUBE_04',
            name: ' Suction Tube Economy',
            category: ' Suction Tube',
            description: 'Cost-effective  Suction Tube solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SUCTIONTUBE_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Suction Tube</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Suction Tube?</h3>

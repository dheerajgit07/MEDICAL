...
const OtherInstruments = () => {
    ...
    const mockProducts = [
        {
            id: 'OTHERINSTRUMENTS_01',
            name: ' Other Instruments Basic',
            category: ' Other Instruments',
            description: 'High quality and reliable  Other Instruments designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'OTHERINSTRUMENTS_01'
        },
        {
            id: 'OTHERINSTRUMENTS_02',
            name: ' Other Instruments Premium',
            category: ' Other Instruments',
            description: 'Advanced  Other Instruments with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OTHERINSTRUMENTS_02'
        },
        {
            id: 'OTHERINSTRUMENTS_03',
            name: ' Other Instruments Professional',
            category: ' Other Instruments',
            description: 'Industry-standard  Other Instruments for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OTHERINSTRUMENTS_03'
        },
        {
            id: 'OTHERINSTRUMENTS_04',
            name: ' Other Instruments Economy',
            category: ' Other Instruments',
            description: 'Cost-effective  Other Instruments solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OTHERINSTRUMENTS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Other Instruments</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Other Instruments?</h3>

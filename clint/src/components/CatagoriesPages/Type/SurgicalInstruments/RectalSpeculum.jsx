...
const RectalSpeculum = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'RECTALSPECULUM_01',
            name: ' Rectal Speculum Basic',
            category: ' Rectal Speculum',
            description: 'High quality and reliable  Rectal Speculum designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'RECTALSPECULUM_01'
        },
        {
            id: 'RECTALSPECULUM_02',
            name: ' Rectal Speculum Premium',
            category: ' Rectal Speculum',
            description: 'Advanced  Rectal Speculum with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'RECTALSPECULUM_02'
        },
        {
            id: 'RECTALSPECULUM_03',
            name: ' Rectal Speculum Professional',
            category: ' Rectal Speculum',
            description: 'Industry-standard  Rectal Speculum for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'RECTALSPECULUM_03'
        },
        {
            id: 'RECTALSPECULUM_04',
            name: ' Rectal Speculum Economy',
            category: ' Rectal Speculum',
            description: 'Cost-effective  Rectal Speculum solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'RECTALSPECULUM_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Rectal Speculum</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Rectal Speculum?</h3>

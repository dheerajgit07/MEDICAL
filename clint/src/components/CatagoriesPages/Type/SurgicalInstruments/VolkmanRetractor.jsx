...
const VolkmanRetractor = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'VOLKMANRETRACTOR_01',
            name: ' Volkman Retractor Basic',
            category: ' Volkman Retractor',
            description: 'High quality and reliable  Volkman Retractor designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'VOLKMANRETRACTOR_01'
        },
        {
            id: 'VOLKMANRETRACTOR_02',
            name: ' Volkman Retractor Premium',
            category: ' Volkman Retractor',
            description: 'Advanced  Volkman Retractor with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'VOLKMANRETRACTOR_02'
        },
        {
            id: 'VOLKMANRETRACTOR_03',
            name: ' Volkman Retractor Professional',
            category: ' Volkman Retractor',
            description: 'Industry-standard  Volkman Retractor for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'VOLKMANRETRACTOR_03'
        },
        {
            id: 'VOLKMANRETRACTOR_04',
            name: ' Volkman Retractor Economy',
            category: ' Volkman Retractor',
            description: 'Cost-effective  Volkman Retractor solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'VOLKMANRETRACTOR_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Volkman Retractor</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Volkman Retractor?</h3>
...
export default VolkmanRetractor;

...
const OphthalmicInstruments = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'OPHTHALMICINSTRUMENTS_01',
            name: ' Ophthalmic Instruments Basic',
            category: ' Ophthalmic Instruments',
            description: 'High quality and reliable  Ophthalmic Instruments designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'OPHTHALMICINSTRUMENTS_01'
        },
        {
            id: 'OPHTHALMICINSTRUMENTS_02',
            name: ' Ophthalmic Instruments Premium',
            category: ' Ophthalmic Instruments',
            description: 'Advanced  Ophthalmic Instruments with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OPHTHALMICINSTRUMENTS_02'
        },
        {
            id: 'OPHTHALMICINSTRUMENTS_03',
            name: ' Ophthalmic Instruments Professional',
            category: ' Ophthalmic Instruments',
            description: 'Industry-standard  Ophthalmic Instruments for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OPHTHALMICINSTRUMENTS_03'
        },
        {
            id: 'OPHTHALMICINSTRUMENTS_04',
            name: ' Ophthalmic Instruments Economy',
            category: ' Ophthalmic Instruments',
            description: 'Cost-effective  Ophthalmic Instruments solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OPHTHALMICINSTRUMENTS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Ophthalmic Instruments</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Ophthalmic Instruments?</h3>
...
export default OphthalmicInstruments;

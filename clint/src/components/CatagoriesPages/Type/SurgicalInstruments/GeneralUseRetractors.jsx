...
const GeneralUseRetractors = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'GENERALUSERETRACTORS_01',
            name: ' General Use Retractors Basic',
            category: ' General Use Retractors',
            description: 'High quality and reliable  General Use Retractors designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'GENERALUSERETRACTORS_01'
        },
        {
            id: 'GENERALUSERETRACTORS_02',
            name: ' General Use Retractors Premium',
            category: ' General Use Retractors',
            description: 'Advanced  General Use Retractors with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GENERALUSERETRACTORS_02'
        },
        {
            id: 'GENERALUSERETRACTORS_03',
            name: ' General Use Retractors Professional',
            category: ' General Use Retractors',
            description: 'Industry-standard  General Use Retractors for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GENERALUSERETRACTORS_03'
        },
        {
            id: 'GENERALUSERETRACTORS_04',
            name: ' General Use Retractors Economy',
            category: ' General Use Retractors',
            description: 'Cost-effective  General Use Retractors solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GENERALUSERETRACTORS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> General Use Retractors</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  General Use Retractors?</h3>
...
export default GeneralUseRetractors;

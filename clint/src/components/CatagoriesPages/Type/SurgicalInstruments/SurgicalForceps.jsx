...
const SurgicalForceps = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'SURGICALFORCEPS_01',
            name: ' Surgical Forceps Basic',
            category: ' Surgical Forceps',
            description: 'High quality and reliable  Surgical Forceps designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'SURGICALFORCEPS_01'
        },
        {
            id: 'SURGICALFORCEPS_02',
            name: ' Surgical Forceps Premium',
            category: ' Surgical Forceps',
            description: 'Advanced  Surgical Forceps with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SURGICALFORCEPS_02'
        },
        {
            id: 'SURGICALFORCEPS_03',
            name: ' Surgical Forceps Professional',
            category: ' Surgical Forceps',
            description: 'Industry-standard  Surgical Forceps for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SURGICALFORCEPS_03'
        },
        {
            id: 'SURGICALFORCEPS_04',
            name: ' Surgical Forceps Economy',
            category: ' Surgical Forceps',
            description: 'Cost-effective  Surgical Forceps solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SURGICALFORCEPS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Surgical Forceps</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Surgical Forceps?</h3>
...
export default SurgicalForceps;

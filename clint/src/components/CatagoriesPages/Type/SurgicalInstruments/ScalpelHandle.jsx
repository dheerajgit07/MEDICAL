...
const ScalpelHandle = () => {
    ...
    const mockProducts = [
        {
            id: 'SCALPELHANDLE_01',
            name: ' Scalpel Handle Basic',
            category: ' Scalpel Handle',
            description: 'High quality and reliable  Scalpel Handle designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'SCALPELHANDLE_01'
        },
        {
            id: 'SCALPELHANDLE_02',
            name: ' Scalpel Handle Premium',
            category: ' Scalpel Handle',
            description: 'Advanced  Scalpel Handle with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SCALPELHANDLE_02'
        },
        {
            id: 'SCALPELHANDLE_03',
            name: ' Scalpel Handle Professional',
            category: ' Scalpel Handle',
            description: 'Industry-standard  Scalpel Handle for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SCALPELHANDLE_03'
        },
        {
            id: 'SCALPELHANDLE_04',
            name: ' Scalpel Handle Economy',
            category: ' Scalpel Handle',
            description: 'Cost-effective  Scalpel Handle solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SCALPELHANDLE_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Scalpel Handle</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Scalpel Handle?</h3>

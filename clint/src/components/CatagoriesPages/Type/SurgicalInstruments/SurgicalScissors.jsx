...
const SurgicalScissors = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'SURGICALSCISSORS_01',
            name: ' Surgical Scissors Basic',
            category: ' Surgical Scissors',
            description: 'High quality and reliable  Surgical Scissors designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'SURGICALSCISSORS_01'
        },
        {
            id: 'SURGICALSCISSORS_02',
            name: ' Surgical Scissors Premium',
            category: ' Surgical Scissors',
            description: 'Advanced  Surgical Scissors with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SURGICALSCISSORS_02'
        },
        {
            id: 'SURGICALSCISSORS_03',
            name: ' Surgical Scissors Professional',
            category: ' Surgical Scissors',
            description: 'Industry-standard  Surgical Scissors for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SURGICALSCISSORS_03'
        },
        {
            id: 'SURGICALSCISSORS_04',
            name: ' Surgical Scissors Economy',
            category: ' Surgical Scissors',
            description: 'Cost-effective  Surgical Scissors solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SURGICALSCISSORS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Surgical Scissors</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Surgical Scissors?</h3>
...
export default SurgicalScissors;

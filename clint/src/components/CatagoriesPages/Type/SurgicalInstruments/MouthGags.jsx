...
const MouthGags = () => {
    ...
    const mockProducts = [
        {
            id: 'MOUTHGAGS_01',
            name: ' Mouth Gags Basic',
            category: ' Mouth Gags',
            description: 'High quality and reliable  Mouth Gags designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'MOUTHGAGS_02',
            name: ' Mouth Gags Premium',
            category: ' Mouth Gags',
            description: 'Advanced  Mouth Gags with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MOUTHGAGS_02'
        },
        {
            id: 'MOUTHGAGS_03',
            name: ' Mouth Gags Professional',
            category: ' Mouth Gags',
            description: 'Industry-standard  Mouth Gags for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MOUTHGAGS_03'
        },
        {
            id: 'MOUTHGAGS_04',
            name: ' Mouth Gags Economy',
            category: ' Mouth Gags',
            description: 'Cost-effective  Mouth Gags solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MOUTHGAGS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Mouth Gags</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Mouth Gags?</h3>

...
const SelfRetainingRetractors = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'SELFRETAININGRETRACTORS_01',
            name: ' Self Retaining Retractors Basic',
            category: ' Self Retaining Retractors',
            description: 'High quality and reliable  Self Retaining Retractors designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'SELFRETAININGRETRACTORS_01'
        },
        {
            id: 'SELFRETAININGRETRACTORS_02',
            name: ' Self Retaining Retractors Premium',
            category: ' Self Retaining Retractors',
            description: 'Advanced  Self Retaining Retractors with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SELFRETAININGRETRACTORS_02'
        },
        {
            id: 'SELFRETAININGRETRACTORS_03',
            name: ' Self Retaining Retractors Professional',
            category: ' Self Retaining Retractors',
            description: 'Industry-standard  Self Retaining Retractors for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SELFRETAININGRETRACTORS_03'
        },
        {
            id: 'SELFRETAININGRETRACTORS_04',
            name: ' Self Retaining Retractors Economy',
            category: ' Self Retaining Retractors',
            description: 'Cost-effective  Self Retaining Retractors solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SELFRETAININGRETRACTORS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Self Retaining Retractors</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Self Retaining Retractors?</h3>
...
export default SelfRetainingRetractors;

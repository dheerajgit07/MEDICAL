...
const OBGYN = () => {
    ...
    const mockProducts = [
        {
            id: 'OBGYN_01',
            name: ' O B G Y N Basic',
            category: ' O B G Y N',
            description: 'High quality and reliable  O B G Y N designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'OBGYN_02',
            name: ' O B G Y N Premium',
            category: ' O B G Y N',
            description: 'Advanced  O B G Y N with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OBGYN_02'
        },
        {
            id: 'OBGYN_03',
            name: ' O B G Y N Professional',
            category: ' O B G Y N',
            description: 'Industry-standard  O B G Y N for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OBGYN_03'
        },
        {
            id: 'OBGYN_04',
            name: ' O B G Y N Economy',
            category: ' O B G Y N',
            description: 'Cost-effective  O B G Y N solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'OBGYN_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> O B G Y N</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  O B G Y N?</h3>

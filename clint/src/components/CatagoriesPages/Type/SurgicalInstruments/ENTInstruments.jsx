...
const ENTInstruments = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'ENTINSTRUMENTS_01',
            name: ' E N T Instruments Basic',
            category: ' E N T Instruments',
            description: 'High quality and reliable  E N T Instruments designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'ENTINSTRUMENTS_01'
        },
        {
            id: 'ENTINSTRUMENTS_02',
            name: ' E N T Instruments Premium',
            category: ' E N T Instruments',
            description: 'Advanced  E N T Instruments with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ENTINSTRUMENTS_02'
        },
        {
            id: 'ENTINSTRUMENTS_03',
            name: ' E N T Instruments Professional',
            category: ' E N T Instruments',
            description: 'Industry-standard  E N T Instruments for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ENTINSTRUMENTS_03'
        },
        {
            id: 'ENTINSTRUMENTS_04',
            name: ' E N T Instruments Economy',
            category: ' E N T Instruments',
            description: 'Cost-effective  E N T Instruments solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ENTINSTRUMENTS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> E N T Instruments</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  E N T Instruments?</h3>

...
const TrachealRetractors = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'TRACHEALRETRACTORS_01',
            name: ' Tracheal Retractors Basic',
            category: ' Tracheal Retractors',
            description: 'High quality and reliable  Tracheal Retractors designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'TRACHEALRETRACTORS_01'
        },
        {
            id: 'TRACHEALRETRACTORS_02',
            name: ' Tracheal Retractors Premium',
            category: ' Tracheal Retractors',
            description: 'Advanced  Tracheal Retractors with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'TRACHEALRETRACTORS_02'
        },
        {
            id: 'TRACHEALRETRACTORS_03',
            name: ' Tracheal Retractors Professional',
            category: ' Tracheal Retractors',
            description: 'Industry-standard  Tracheal Retractors for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'TRACHEALRETRACTORS_03'
        },
        {
            id: 'TRACHEALRETRACTORS_04',
            name: ' Tracheal Retractors Economy',
            category: ' Tracheal Retractors',
            description: 'Cost-effective  Tracheal Retractors solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'TRACHEALRETRACTORS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Tracheal Retractors</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Tracheal Retractors?</h3>
...
export default TrachealRetractors;

...
const BoneCuttingForceps = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'BONECUTTINGFORCEPS_01',
            name: ' Bone Cutting Forceps Basic',
            category: ' Bone Cutting Forceps',
            description: 'High quality and reliable  Bone Cutting Forceps designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'BONECUTTINGFORCEPS_01'
        },
        {
            id: 'BONECUTTINGFORCEPS_02',
            name: ' Bone Cutting Forceps Premium',
            category: ' Bone Cutting Forceps',
            description: 'Advanced  Bone Cutting Forceps with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BONECUTTINGFORCEPS_02'
        },
        {
            id: 'BONECUTTINGFORCEPS_03',
            name: ' Bone Cutting Forceps Professional',
            category: ' Bone Cutting Forceps',
            description: 'Industry-standard  Bone Cutting Forceps for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BONECUTTINGFORCEPS_03'
        },
        {
            id: 'BONECUTTINGFORCEPS_04',
            name: ' Bone Cutting Forceps Economy',
            category: ' Bone Cutting Forceps',
            description: 'Cost-effective  Bone Cutting Forceps solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BONECUTTINGFORCEPS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Bone Cutting Forceps</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Bone Cutting Forceps?</h3>
...
export default BoneCuttingForceps;

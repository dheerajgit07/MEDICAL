...
const ScissorsAndShears = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'SCISSORSANDSHEARS_01',
            name: ' Scissors And Shears Basic',
            category: ' Scissors And Shears',
            description: 'High quality and reliable  Scissors And Shears designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'SCISSORSANDSHEARS_01'
        },
        {
            id: 'SCISSORSANDSHEARS_02',
            name: ' Scissors And Shears Premium',
            category: ' Scissors And Shears',
            description: 'Advanced  Scissors And Shears with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SCISSORSANDSHEARS_02'
        },
        {
            id: 'SCISSORSANDSHEARS_03',
            name: ' Scissors And Shears Professional',
            category: ' Scissors And Shears',
            description: 'Industry-standard  Scissors And Shears for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SCISSORSANDSHEARS_03'
        },
        {
            id: 'SCISSORSANDSHEARS_04',
            name: ' Scissors And Shears Economy',
            category: ' Scissors And Shears',
            description: 'Cost-effective  Scissors And Shears solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SCISSORSANDSHEARS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Scissors And Shears</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Scissors And Shears?</h3>
...
export default ScissorsAndShears;

...
const PremiumOrthopedicInstrumentSets = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'PREMIUMORTHOPEDICINSTRUMENTSETS_01',
            name: ' Premium Orthopedic Instrument Sets Basic',
            category: ' Premium Orthopedic Instrument Sets',
            description: 'High quality and reliable  Premium Orthopedic Instrument Sets designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PREMIUMORTHOPEDICINSTRUMENTSETS_01'
        },
        {
            id: 'PREMIUMORTHOPEDICINSTRUMENTSETS_02',
            name: ' Premium Orthopedic Instrument Sets Premium',
            category: ' Premium Orthopedic Instrument Sets',
            description: 'Advanced  Premium Orthopedic Instrument Sets with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PREMIUMORTHOPEDICINSTRUMENTSETS_02'
        },
        {
            id: 'PREMIUMORTHOPEDICINSTRUMENTSETS_03',
            name: ' Premium Orthopedic Instrument Sets Professional',
            category: ' Premium Orthopedic Instrument Sets',
            description: 'Industry-standard  Premium Orthopedic Instrument Sets for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PREMIUMORTHOPEDICINSTRUMENTSETS_03'
        },
        {
            id: 'PREMIUMORTHOPEDICINSTRUMENTSETS_04',
            name: ' Premium Orthopedic Instrument Sets Economy',
            category: ' Premium Orthopedic Instrument Sets',
            description: 'Cost-effective  Premium Orthopedic Instrument Sets solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PREMIUMORTHOPEDICINSTRUMENTSETS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Premium Orthopedic Instrument Sets</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Premium Orthopedic Instrument Sets?</h3>
...
export default PremiumOrthopedicInstrumentSets;

...
const GeneralOrthopedicInstruments = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'GENERALORTHOPEDICINSTRUMENTS_01',
            name: ' General Orthopedic Instruments Basic',
            category: ' General Orthopedic Instruments',
            description: 'High quality and reliable  General Orthopedic Instruments designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'GENERALORTHOPEDICINSTRUMENTS_01'
        },
        {
            id: 'GENERALORTHOPEDICINSTRUMENTS_02',
            name: ' General Orthopedic Instruments Premium',
            category: ' General Orthopedic Instruments',
            description: 'Advanced  General Orthopedic Instruments with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GENERALORTHOPEDICINSTRUMENTS_02'
        },
        {
            id: 'GENERALORTHOPEDICINSTRUMENTS_03',
            name: ' General Orthopedic Instruments Professional',
            category: ' General Orthopedic Instruments',
            description: 'Industry-standard  General Orthopedic Instruments for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GENERALORTHOPEDICINSTRUMENTS_03'
        },
        {
            id: 'GENERALORTHOPEDICINSTRUMENTS_04',
            name: ' General Orthopedic Instruments Economy',
            category: ' General Orthopedic Instruments',
            description: 'Cost-effective  General Orthopedic Instruments solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GENERALORTHOPEDICINSTRUMENTS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> General Orthopedic Instruments</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  General Orthopedic Instruments?</h3>
...
export default GeneralOrthopedicInstruments;

...
const BoneChisel = () => {
    ...
    const mockProducts = [
        {
            id: 'BONECHISEL_01',
            name: ' Bone Chisel Basic',
            category: ' Bone Chisel',
            description: 'High quality and reliable  Bone Chisel designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'BONECHISEL_02',
            name: ' Bone Chisel Premium',
            category: ' Bone Chisel',
            description: 'Advanced  Bone Chisel with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BONECHISEL_02'
        },
        {
            id: 'BONECHISEL_03',
            name: ' Bone Chisel Professional',
            category: ' Bone Chisel',
            description: 'Industry-standard  Bone Chisel for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BONECHISEL_03'
        },
        {
            id: 'BONECHISEL_04',
            name: ' Bone Chisel Economy',
            category: ' Bone Chisel',
            description: 'Cost-effective  Bone Chisel solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BONECHISEL_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Bone Chisel</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Bone Chisel?</h3>

...
const PlateBender = () => {
    ...
    const mockProducts = [
        {
            id: 'PLATEBENDER_01',
            name: ' Plate Bender Basic',
            category: ' Plate Bender',
            description: 'High quality and reliable  Plate Bender designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'PLATEBENDER_02',
            name: ' Plate Bender Premium',
            category: ' Plate Bender',
            description: 'Advanced  Plate Bender with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLATEBENDER_02'
        },
        {
            id: 'PLATEBENDER_03',
            name: ' Plate Bender Professional',
            category: ' Plate Bender',
            description: 'Industry-standard  Plate Bender for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLATEBENDER_03'
        },
        {
            id: 'PLATEBENDER_04',
            name: ' Plate Bender Economy',
            category: ' Plate Bender',
            description: 'Cost-effective  Plate Bender solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLATEBENDER_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Plate Bender</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Plate Bender?</h3>

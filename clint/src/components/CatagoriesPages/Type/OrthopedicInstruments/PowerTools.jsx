...
const PowerTools = () => {
    ...
    const mockProducts = [
        {
            id: 'POWERTOOLS_01',
            name: ' Power Tools Basic',
            category: ' Power Tools',
            description: 'High quality and reliable  Power Tools designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'POWERTOOLS_02',
            name: ' Power Tools Premium',
            category: ' Power Tools',
            description: 'Advanced  Power Tools with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'POWERTOOLS_02'
        },
        {
            ...
            category: ' Power Tools',
            description: 'Industry-standard  Power Tools for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'POWERTOOLS_03'
        },
        {
            id: 'POWERTOOLS_04',
            name: ' Power Tools Economy',
            category: ' Power Tools',
            description: 'Cost-effective  Power Tools solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'POWERTOOLS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Power Tools</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Power Tools?</h3>

...
const BoneHammer = () => {
    ...
    const mockProducts = [
        {
            id: 'BONEHAMMER_01',
            name: ' Bone Hammer Basic',
            category: ' Bone Hammer',
            description: 'High quality and reliable  Bone Hammer designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'BONEHAMMER_02',
            name: ' Bone Hammer Premium',
            category: ' Bone Hammer',
            description: 'Advanced  Bone Hammer with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BONEHAMMER_02'
        },
        {
            id: 'BONEHAMMER_03',
            name: ' Bone Hammer Professional',
            category: ' Bone Hammer',
            description: 'Industry-standard  Bone Hammer for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BONEHAMMER_03'
        },
        {
            id: 'BONEHAMMER_04',
            name: ' Bone Hammer Economy',
            category: ' Bone Hammer',
            description: 'Cost-effective  Bone Hammer solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BONEHAMMER_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Bone Hammer</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Bone Hammer?</h3>

...
const SterilizationTubes = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'STERILIZATIONTUBES_01',
            name: ' Sterilization Tubes Basic',
            category: ' Sterilization Tubes',
            description: 'High quality and reliable  Sterilization Tubes designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'STERILIZATIONTUBES_01'
        },
        {
            id: 'STERILIZATIONTUBES_02',
            name: ' Sterilization Tubes Premium',
            category: ' Sterilization Tubes',
            description: 'Advanced  Sterilization Tubes with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'STERILIZATIONTUBES_02'
        },
        {
            id: 'STERILIZATIONTUBES_03',
            name: ' Sterilization Tubes Professional',
            category: ' Sterilization Tubes',
            description: 'Industry-standard  Sterilization Tubes for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'STERILIZATIONTUBES_03'
        },
        {
            id: 'STERILIZATIONTUBES_04',
            name: ' Sterilization Tubes Economy',
            category: ' Sterilization Tubes',
            description: 'Cost-effective  Sterilization Tubes solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'STERILIZATIONTUBES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Sterilization Tubes</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Sterilization Tubes?</h3>
...
export default SterilizationTubes;

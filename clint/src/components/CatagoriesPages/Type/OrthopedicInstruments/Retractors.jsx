...
const Retractors = () => {
    ...
    const mockProducts = [
        {
            id: 'RETRACTORS_01',
            name: ' Retractors Basic',
            category: ' Retractors',
            description: 'High quality and reliable  Retractors designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'RETRACTORS_02',
            name: ' Retractors Premium',
            category: ' Retractors',
            description: 'Advanced  Retractors with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'RETRACTORS_02'
        },
        {
            id: 'RETRACTORS_03',
            name: ' Retractors Professional',
            category: ' Retractors',
            description: 'Industry-standard  Retractors for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'RETRACTORS_03'
        },
        {
            id: 'RETRACTORS_04',
            name: ' Retractors Economy',
            category: ' Retractors',
            description: 'Cost-effective  Retractors solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'RETRACTORS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Retractors</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Retractors?</h3>

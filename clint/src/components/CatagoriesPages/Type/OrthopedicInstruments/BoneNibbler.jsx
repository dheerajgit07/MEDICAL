...
const BoneNibbler = () => {
    ...
    const mockProducts = [
        {
            id: 'BONENIBBLER_01',
            name: ' Bone Nibbler Basic',
            category: ' Bone Nibbler',
            description: 'High quality and reliable  Bone Nibbler designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'BONENIBBLER_02',
            name: ' Bone Nibbler Premium',
            category: ' Bone Nibbler',
            description: 'Advanced  Bone Nibbler with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BONENIBBLER_02'
        },
        {
            id: 'BONENIBBLER_03',
            name: ' Bone Nibbler Professional',
            category: ' Bone Nibbler',
            description: 'Industry-standard  Bone Nibbler for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BONENIBBLER_03'
        },
        {
            id: 'BONENIBBLER_04',
            name: ' Bone Nibbler Economy',
            category: ' Bone Nibbler',
            description: 'Cost-effective  Bone Nibbler solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BONENIBBLER_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Bone Nibbler</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Bone Nibbler?</h3>

...
const OrthopedicBoneOsteotomes = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'ORTHOPEDICBONEOSTEOTOMES_01',
            name: ' Orthopedic Bone Osteotomes Basic',
            category: ' Orthopedic Bone Osteotomes',
            description: 'High quality and reliable  Orthopedic Bone Osteotomes designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'ORTHOPEDICBONEOSTEOTOMES_01'
        },
        {
            id: 'ORTHOPEDICBONEOSTEOTOMES_02',
            name: ' Orthopedic Bone Osteotomes Premium',
            category: ' Orthopedic Bone Osteotomes',
            description: 'Advanced  Orthopedic Bone Osteotomes with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ORTHOPEDICBONEOSTEOTOMES_02'
        },
        {
            id: 'ORTHOPEDICBONEOSTEOTOMES_03',
            name: ' Orthopedic Bone Osteotomes Professional',
            category: ' Orthopedic Bone Osteotomes',
            description: 'Industry-standard  Orthopedic Bone Osteotomes for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ORTHOPEDICBONEOSTEOTOMES_03'
        },
        {
            id: 'ORTHOPEDICBONEOSTEOTOMES_04',
            name: ' Orthopedic Bone Osteotomes Economy',
            category: ' Orthopedic Bone Osteotomes',
            description: 'Cost-effective  Orthopedic Bone Osteotomes solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ORTHOPEDICBONEOSTEOTOMES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Orthopedic Bone Osteotomes</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Orthopedic Bone Osteotomes?</h3>
...
export default OrthopedicBoneOsteotomes;

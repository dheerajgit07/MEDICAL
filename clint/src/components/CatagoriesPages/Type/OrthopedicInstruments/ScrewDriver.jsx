...
const ScrewDriver = () => {
    ...
    const mockProducts = [
        {
            id: 'SCREWDRIVER_01',
            name: ' Screw Driver Basic',
            category: ' Screw Driver',
            description: 'High quality and reliable  Screw Driver designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'SCREWDRIVER_02',
            name: ' Screw Driver Premium',
            category: ' Screw Driver',
            description: 'Advanced  Screw Driver with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SCREWDRIVER_02'
        },
        {
            id: 'SCREWDRIVER_03',
            name: ' Screw Driver Professional',
            category: ' Screw Driver',
            description: 'Industry-standard  Screw Driver for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SCREWDRIVER_03'
        },
        {
            id: 'SCREWDRIVER_04',
            name: ' Screw Driver Economy',
            category: ' Screw Driver',
            description: 'Cost-effective  Screw Driver solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SCREWDRIVER_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Screw Driver</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Screw Driver?</h3>

...
const PeriostealElevator = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'PERIOSTEALELEVATOR_01',
            name: ' Periosteal Elevator Basic',
            category: ' Periosteal Elevator',
            description: 'High quality and reliable  Periosteal Elevator designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PERIOSTEALELEVATOR_01'
        },
        {
            id: 'PERIOSTEALELEVATOR_02',
            name: ' Periosteal Elevator Premium',
            category: ' Periosteal Elevator',
            description: 'Advanced  Periosteal Elevator with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PERIOSTEALELEVATOR_02'
        },
        {
            id: 'PERIOSTEALELEVATOR_03',
            name: ' Periosteal Elevator Professional',
            category: ' Periosteal Elevator',
            description: 'Industry-standard  Periosteal Elevator for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PERIOSTEALELEVATOR_03'
        },
        {
            id: 'PERIOSTEALELEVATOR_04',
            name: ' Periosteal Elevator Economy',
            category: ' Periosteal Elevator',
            description: 'Cost-effective  Periosteal Elevator solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PERIOSTEALELEVATOR_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Periosteal Elevator</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Periosteal Elevator?</h3>
...
export default PeriostealElevator;

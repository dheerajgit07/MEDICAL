...
const Reamer = () => {
    ...
    const mockProducts = [
        {
            ...
            name: ' Reamer Basic',
            category: ' Reamer',
            description: 'High quality and reliable  Reamer designed for medical professionals.',
            price: 50.00,
        ...
        },
        {
            ...
            name: ' Reamer Premium',
            category: ' Reamer',
            description: 'Advanced  Reamer with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'REAMER_02'
        },
        {
            id: 'REAMER_03',
            name: ' Reamer Professional',
            category: ' Reamer',
            description: 'Industry-standard  Reamer for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'REAMER_03'
        },
        {
            ...
            name: ' Reamer Economy',
            category: ' Reamer',
            description: 'Cost-effective  Reamer solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'REAMER_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Reamer</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Reamer?</h3>

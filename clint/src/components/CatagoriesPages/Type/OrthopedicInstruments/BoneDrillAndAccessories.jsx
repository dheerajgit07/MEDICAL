...
const BoneDrillAndAccessories = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'BONEDRILLANDACCESSORIES_01',
            name: ' Bone Drill And Accessories Basic',
            category: ' Bone Drill And Accessories',
            description: 'High quality and reliable  Bone Drill And Accessories designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'BONEDRILLANDACCESSORIES_01'
        },
        {
            id: 'BONEDRILLANDACCESSORIES_02',
            name: ' Bone Drill And Accessories Premium',
            category: ' Bone Drill And Accessories',
            description: 'Advanced  Bone Drill And Accessories with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BONEDRILLANDACCESSORIES_02'
        },
        {
            id: 'BONEDRILLANDACCESSORIES_03',
            name: ' Bone Drill And Accessories Professional',
            category: ' Bone Drill And Accessories',
            description: 'Industry-standard  Bone Drill And Accessories for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BONEDRILLANDACCESSORIES_03'
        },
        {
            id: 'BONEDRILLANDACCESSORIES_04',
            name: ' Bone Drill And Accessories Economy',
            category: ' Bone Drill And Accessories',
            description: 'Cost-effective  Bone Drill And Accessories solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BONEDRILLANDACCESSORIES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Bone Drill And Accessories</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Bone Drill And Accessories?</h3>
...
export default BoneDrillAndAccessories;

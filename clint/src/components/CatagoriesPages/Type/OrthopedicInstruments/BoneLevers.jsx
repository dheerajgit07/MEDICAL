...
const BoneLevers = () => {
    ...
    const mockProducts = [
        {
            id: 'BONELEVERS_01',
            name: ' Bone Levers Basic',
            category: ' Bone Levers',
            description: 'High quality and reliable  Bone Levers designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'BONELEVERS_02',
            name: ' Bone Levers Premium',
            category: ' Bone Levers',
            description: 'Advanced  Bone Levers with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BONELEVERS_02'
        },
        {
            id: 'BONELEVERS_03',
            name: ' Bone Levers Professional',
            category: ' Bone Levers',
            description: 'Industry-standard  Bone Levers for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BONELEVERS_03'
        },
        {
            id: 'BONELEVERS_04',
            name: ' Bone Levers Economy',
            category: ' Bone Levers',
            description: 'Cost-effective  Bone Levers solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BONELEVERS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Bone Levers</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Bone Levers?</h3>

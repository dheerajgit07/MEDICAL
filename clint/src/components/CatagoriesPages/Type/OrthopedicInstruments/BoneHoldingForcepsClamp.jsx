...
const BoneHoldingForcepsClamp = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'BONEHOLDINGFORCEPSCLAMP_01',
            name: ' Bone Holding Forceps Clamp Basic',
            category: ' Bone Holding Forceps Clamp',
            description: 'High quality and reliable  Bone Holding Forceps Clamp designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'BONEHOLDINGFORCEPSCLAMP_01'
        },
        {
            id: 'BONEHOLDINGFORCEPSCLAMP_02',
            name: ' Bone Holding Forceps Clamp Premium',
            category: ' Bone Holding Forceps Clamp',
            description: 'Advanced  Bone Holding Forceps Clamp with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BONEHOLDINGFORCEPSCLAMP_02'
        },
        {
            id: 'BONEHOLDINGFORCEPSCLAMP_03',
            name: ' Bone Holding Forceps Clamp Professional',
            category: ' Bone Holding Forceps Clamp',
            description: 'Industry-standard  Bone Holding Forceps Clamp for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BONEHOLDINGFORCEPSCLAMP_03'
        },
        {
            id: 'BONEHOLDINGFORCEPSCLAMP_04',
            name: ' Bone Holding Forceps Clamp Economy',
            category: ' Bone Holding Forceps Clamp',
            description: 'Cost-effective  Bone Holding Forceps Clamp solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BONEHOLDINGFORCEPSCLAMP_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Bone Holding Forceps Clamp</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Bone Holding Forceps Clamp?</h3>
...
export default BoneHoldingForcepsClamp;

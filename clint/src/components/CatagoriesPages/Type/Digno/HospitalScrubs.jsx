...
const HospitalScrubs = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'HOSPITALSCRUBS_01',
            name: ' Hospital Scrubs Basic',
            category: ' Hospital Scrubs',
            description: 'High quality and reliable  Hospital Scrubs designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'HOSPITALSCRUBS_01'
        },
        {
            id: 'HOSPITALSCRUBS_02',
            name: ' Hospital Scrubs Premium',
            category: ' Hospital Scrubs',
            description: 'Advanced  Hospital Scrubs with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOSPITALSCRUBS_02'
        },
        {
            id: 'HOSPITALSCRUBS_03',
            name: ' Hospital Scrubs Professional',
            category: ' Hospital Scrubs',
            description: 'Industry-standard  Hospital Scrubs for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOSPITALSCRUBS_03'
        },
        {
            id: 'HOSPITALSCRUBS_04',
            name: ' Hospital Scrubs Economy',
            category: ' Hospital Scrubs',
            description: 'Cost-effective  Hospital Scrubs solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOSPITALSCRUBS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Hospital Scrubs</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Hospital Scrubs?</h3>

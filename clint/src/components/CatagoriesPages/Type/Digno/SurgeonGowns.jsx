...
const SurgeonGowns = () => {
    ...
    const mockProducts = [
        {
            id: 'SURGEONGOWNS_01',
            name: ' Surgeon Gowns Basic',
            category: ' Surgeon Gowns',
            description: 'High quality and reliable  Surgeon Gowns designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'SURGEONGOWNS_02',
            name: ' Surgeon Gowns Premium',
            category: ' Surgeon Gowns',
            description: 'Advanced  Surgeon Gowns with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SURGEONGOWNS_02'
        },
        {
            id: 'SURGEONGOWNS_03',
            name: ' Surgeon Gowns Professional',
            category: ' Surgeon Gowns',
            description: 'Industry-standard  Surgeon Gowns for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SURGEONGOWNS_03'
        },
        {
            id: 'SURGEONGOWNS_04',
            name: ' Surgeon Gowns Economy',
            category: ' Surgeon Gowns',
            description: 'Cost-effective  Surgeon Gowns solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SURGEONGOWNS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Surgeon Gowns</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Surgeon Gowns?</h3>

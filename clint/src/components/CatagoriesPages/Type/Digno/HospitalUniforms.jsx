...
const HospitalUniforms = () => {
    ...
    const mockProducts = [
        {
            id: 'HOSPITALUNIFORMS_01',
            name: ' Hospital Uniforms Basic',
            category: ' Hospital Uniforms',
            description: 'High quality and reliable  Hospital Uniforms designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'HOSPITALUNIFORMS_01'
        },
        {
            id: 'HOSPITALUNIFORMS_02',
            name: ' Hospital Uniforms Premium',
            category: ' Hospital Uniforms',
            description: 'Advanced  Hospital Uniforms with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOSPITALUNIFORMS_02'
        },
        {
            id: 'HOSPITALUNIFORMS_03',
            name: ' Hospital Uniforms Professional',
            category: ' Hospital Uniforms',
            description: 'Industry-standard  Hospital Uniforms for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOSPITALUNIFORMS_03'
        },
        {
            id: 'HOSPITALUNIFORMS_04',
            name: ' Hospital Uniforms Economy',
            category: ' Hospital Uniforms',
            description: 'Cost-effective  Hospital Uniforms solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOSPITALUNIFORMS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Hospital Uniforms</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Hospital Uniforms?</h3>

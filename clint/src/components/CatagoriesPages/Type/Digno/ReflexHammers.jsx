...
const ReflexHammers = () => {
    ...
    const mockProducts = [
        {
            id: 'REFLEXHAMMERS_01',
            name: ' Reflex Hammers Basic',
            category: ' Reflex Hammers',
            description: 'High quality and reliable  Reflex Hammers designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'REFLEXHAMMERS_01'
        },
        {
            id: 'REFLEXHAMMERS_02',
            name: ' Reflex Hammers Premium',
            category: ' Reflex Hammers',
            description: 'Advanced  Reflex Hammers with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'REFLEXHAMMERS_02'
        },
        {
            id: 'REFLEXHAMMERS_03',
            name: ' Reflex Hammers Professional',
            category: ' Reflex Hammers',
            description: 'Industry-standard  Reflex Hammers for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'REFLEXHAMMERS_03'
        },
        {
            id: 'REFLEXHAMMERS_04',
            name: ' Reflex Hammers Economy',
            category: ' Reflex Hammers',
            description: 'Cost-effective  Reflex Hammers solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'REFLEXHAMMERS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Reflex Hammers</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Reflex Hammers?</h3>

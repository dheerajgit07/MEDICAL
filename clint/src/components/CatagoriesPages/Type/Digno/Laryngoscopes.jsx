...
const Laryngoscopes = () => {
    ...
    const mockProducts = [
        {
            id: 'LARYNGOSCOPES_01',
            name: ' Laryngoscopes Basic',
            category: ' Laryngoscopes',
            description: 'High quality and reliable  Laryngoscopes designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'LARYNGOSCOPES_01'
        },
        {
            id: 'LARYNGOSCOPES_02',
            name: ' Laryngoscopes Premium',
            category: ' Laryngoscopes',
            description: 'Advanced  Laryngoscopes with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LARYNGOSCOPES_02'
        },
        {
            id: 'LARYNGOSCOPES_03',
            name: ' Laryngoscopes Professional',
            category: ' Laryngoscopes',
            description: 'Industry-standard  Laryngoscopes for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LARYNGOSCOPES_03'
        },
        {
            id: 'LARYNGOSCOPES_04',
            name: ' Laryngoscopes Economy',
            category: ' Laryngoscopes',
            description: 'Cost-effective  Laryngoscopes solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'LARYNGOSCOPES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Laryngoscopes</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Laryngoscopes?</h3>

...
const PulseOximeters = () => {
    ...
    const mockProducts = [
        {
            id: 'PULSEOXIMETERS_01',
            name: ' Pulse Oximeters Basic',
            category: ' Pulse Oximeters',
            description: 'High quality and reliable  Pulse Oximeters designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PULSEOXIMETERS_01'
        },
        {
            id: 'PULSEOXIMETERS_02',
            name: ' Pulse Oximeters Premium',
            category: ' Pulse Oximeters',
            description: 'Advanced  Pulse Oximeters with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PULSEOXIMETERS_02'
        },
        {
            id: 'PULSEOXIMETERS_03',
            name: ' Pulse Oximeters Professional',
            category: ' Pulse Oximeters',
            description: 'Industry-standard  Pulse Oximeters for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PULSEOXIMETERS_03'
        },
        {
            id: 'PULSEOXIMETERS_04',
            name: ' Pulse Oximeters Economy',
            category: ' Pulse Oximeters',
            description: 'Cost-effective  Pulse Oximeters solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PULSEOXIMETERS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Pulse Oximeters</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Pulse Oximeters?</h3>

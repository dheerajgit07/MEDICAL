...
const ECGMachines = () => {
    ...
    const mockProducts = [
        {
            id: 'ECGMACHINES_01',
            name: ' E C G Machines Basic',
            category: ' E C G Machines',
            description: 'High quality and reliable  E C G Machines designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'ECGMACHINES_02',
            name: ' E C G Machines Premium',
            category: ' E C G Machines',
            description: 'Advanced  E C G Machines with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ECGMACHINES_02'
        },
        {
            id: 'ECGMACHINES_03',
            name: ' E C G Machines Professional',
            category: ' E C G Machines',
            description: 'Industry-standard  E C G Machines for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ECGMACHINES_03'
        },
        {
            id: 'ECGMACHINES_04',
            name: ' E C G Machines Economy',
            category: ' E C G Machines',
            description: 'Cost-effective  E C G Machines solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ECGMACHINES_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> E C G Machines</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  E C G Machines?</h3>

...
const HospitalLinens = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'HOSPITALLINENS_01',
            name: ' Hospital Linens Basic',
            category: ' Hospital Linens',
            description: 'High quality and reliable  Hospital Linens designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'HOSPITALLINENS_01'
        },
        {
            id: 'HOSPITALLINENS_02',
            name: ' Hospital Linens Premium',
            category: ' Hospital Linens',
            description: 'Advanced  Hospital Linens with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOSPITALLINENS_02'
        },
        {
            id: 'HOSPITALLINENS_03',
            name: ' Hospital Linens Professional',
            category: ' Hospital Linens',
            description: 'Industry-standard  Hospital Linens for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOSPITALLINENS_03'
        },
        {
            id: 'HOSPITALLINENS_04',
            name: ' Hospital Linens Economy',
            category: ' Hospital Linens',
            description: 'Cost-effective  Hospital Linens solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'HOSPITALLINENS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Hospital Linens</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Hospital Linens?</h3>

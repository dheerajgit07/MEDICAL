...
const Sethoscop = () => {
    ...
    const mockProducts = [
        {
            id: 'SETHOSCOP_01',
            name: ' Sethoscop Basic',
            category: ' Sethoscop',
            description: 'High quality and reliable  Sethoscop designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'SETHOSCOP_02',
            name: ' Sethoscop Premium',
            category: ' Sethoscop',
            description: 'Advanced  Sethoscop with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SETHOSCOP_02'
        },
        {
            id: 'SETHOSCOP_03',
            name: ' Sethoscop Professional',
            category: ' Sethoscop',
            description: 'Industry-standard  Sethoscop for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SETHOSCOP_03'
        },
        {
            id: 'SETHOSCOP_04',
            name: ' Sethoscop Economy',
            category: ' Sethoscop',
            description: 'Cost-effective  Sethoscop solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SETHOSCOP_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Sethoscop</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Sethoscop?</h3>

...
const Nebulizers = () => {
    ...
    const mockProducts = [
        {
            id: 'NEBULIZERS_01',
            name: ' Nebulizers Basic',
            category: ' Nebulizers',
            description: 'High quality and reliable  Nebulizers designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'NEBULIZERS_02',
            name: ' Nebulizers Premium',
            category: ' Nebulizers',
            description: 'Advanced  Nebulizers with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'NEBULIZERS_02'
        },
        {
            id: 'NEBULIZERS_03',
            name: ' Nebulizers Professional',
            category: ' Nebulizers',
            description: 'Industry-standard  Nebulizers for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'NEBULIZERS_03'
        },
        {
            id: 'NEBULIZERS_04',
            name: ' Nebulizers Economy',
            category: ' Nebulizers',
            description: 'Cost-effective  Nebulizers solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'NEBULIZERS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Nebulizers</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Nebulizers?</h3>

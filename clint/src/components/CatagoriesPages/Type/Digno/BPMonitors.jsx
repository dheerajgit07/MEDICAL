...
const BPMonitors = () => {
    ...
    const mockProducts = [
        {
            id: 'BPMONITORS_01',
            name: ' B P Monitors Basic',
            category: ' B P Monitors',
            description: 'High quality and reliable  B P Monitors designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'BPMONITORS_02',
            name: ' B P Monitors Premium',
            category: ' B P Monitors',
            description: 'Advanced  B P Monitors with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BPMONITORS_02'
        },
        {
            id: 'BPMONITORS_03',
            name: ' B P Monitors Professional',
            category: ' B P Monitors',
            description: 'Industry-standard  B P Monitors for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BPMONITORS_03'
        },
        {
            id: 'BPMONITORS_04',
            name: ' B P Monitors Economy',
            category: ' B P Monitors',
            description: 'Cost-effective  B P Monitors solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BPMONITORS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> B P Monitors</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  B P Monitors?</h3>

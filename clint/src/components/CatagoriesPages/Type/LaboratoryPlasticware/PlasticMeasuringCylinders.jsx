...
const PlasticMeasuringCylinders = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'PLASTICMEASURINGCYLINDERS_01',
            name: ' Plastic Measuring Cylinders Basic',
            category: ' Plastic Measuring Cylinders',
            description: 'High quality and reliable  Plastic Measuring Cylinders designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PLASTICMEASURINGCYLINDERS_01'
        },
        {
            id: 'PLASTICMEASURINGCYLINDERS_02',
            name: ' Plastic Measuring Cylinders Premium',
            category: ' Plastic Measuring Cylinders',
            description: 'Advanced  Plastic Measuring Cylinders with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICMEASURINGCYLINDERS_02'
        },
        {
            id: 'PLASTICMEASURINGCYLINDERS_03',
            name: ' Plastic Measuring Cylinders Professional',
            category: ' Plastic Measuring Cylinders',
            description: 'Industry-standard  Plastic Measuring Cylinders for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICMEASURINGCYLINDERS_03'
        },
        {
            id: 'PLASTICMEASURINGCYLINDERS_04',
            name: ' Plastic Measuring Cylinders Economy',
            category: ' Plastic Measuring Cylinders',
            description: 'Cost-effective  Plastic Measuring Cylinders solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICMEASURINGCYLINDERS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Plastic Measuring Cylinders</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Plastic Measuring Cylinders?</h3>
...
export default PlasticMeasuringCylinders;

...
const PlasticAtomicModels = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'PLASTICATOMICMODELS_01',
            name: ' Plastic Atomic Models Basic',
            category: ' Plastic Atomic Models',
            description: 'High quality and reliable  Plastic Atomic Models designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PLASTICATOMICMODELS_01'
        },
        {
            id: 'PLASTICATOMICMODELS_02',
            name: ' Plastic Atomic Models Premium',
            category: ' Plastic Atomic Models',
            description: 'Advanced  Plastic Atomic Models with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICATOMICMODELS_02'
        },
        {
            id: 'PLASTICATOMICMODELS_03',
            name: ' Plastic Atomic Models Professional',
            category: ' Plastic Atomic Models',
            description: 'Industry-standard  Plastic Atomic Models for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICATOMICMODELS_03'
        },
        {
            id: 'PLASTICATOMICMODELS_04',
            name: ' Plastic Atomic Models Economy',
            category: ' Plastic Atomic Models',
            description: 'Cost-effective  Plastic Atomic Models solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICATOMICMODELS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Plastic Atomic Models</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Plastic Atomic Models?</h3>
...
export default PlasticAtomicModels;

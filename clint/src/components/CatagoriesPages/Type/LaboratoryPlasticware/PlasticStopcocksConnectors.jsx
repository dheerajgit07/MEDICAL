...
const PlasticStopcocksConnectors = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'PLASTICSTOPCOCKSCONNECTORS_01',
            name: ' Plastic Stopcocks Connectors Basic',
            category: ' Plastic Stopcocks Connectors',
            description: 'High quality and reliable  Plastic Stopcocks Connectors designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PLASTICSTOPCOCKSCONNECTORS_01'
        },
        {
            id: 'PLASTICSTOPCOCKSCONNECTORS_02',
            name: ' Plastic Stopcocks Connectors Premium',
            category: ' Plastic Stopcocks Connectors',
            description: 'Advanced  Plastic Stopcocks Connectors with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICSTOPCOCKSCONNECTORS_02'
        },
        {
            id: 'PLASTICSTOPCOCKSCONNECTORS_03',
            name: ' Plastic Stopcocks Connectors Professional',
            category: ' Plastic Stopcocks Connectors',
            description: 'Industry-standard  Plastic Stopcocks Connectors for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICSTOPCOCKSCONNECTORS_03'
        },
        {
            id: 'PLASTICSTOPCOCKSCONNECTORS_04',
            name: ' Plastic Stopcocks Connectors Economy',
            category: ' Plastic Stopcocks Connectors',
            description: 'Cost-effective  Plastic Stopcocks Connectors solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICSTOPCOCKSCONNECTORS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Plastic Stopcocks Connectors</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Plastic Stopcocks Connectors?</h3>
...
export default PlasticStopcocksConnectors;

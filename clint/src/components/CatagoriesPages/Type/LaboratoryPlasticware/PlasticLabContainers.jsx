...
const PlasticLabContainers = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'PLASTICLABCONTAINERS_01',
            name: ' Plastic Lab Containers Basic',
            category: ' Plastic Lab Containers',
            description: 'High quality and reliable  Plastic Lab Containers designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PLASTICLABCONTAINERS_01'
        },
        {
            id: 'PLASTICLABCONTAINERS_02',
            name: ' Plastic Lab Containers Premium',
            category: ' Plastic Lab Containers',
            description: 'Advanced  Plastic Lab Containers with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICLABCONTAINERS_02'
        },
        {
            id: 'PLASTICLABCONTAINERS_03',
            name: ' Plastic Lab Containers Professional',
            category: ' Plastic Lab Containers',
            description: 'Industry-standard  Plastic Lab Containers for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICLABCONTAINERS_03'
        },
        {
            id: 'PLASTICLABCONTAINERS_04',
            name: ' Plastic Lab Containers Economy',
            category: ' Plastic Lab Containers',
            description: 'Cost-effective  Plastic Lab Containers solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICLABCONTAINERS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Plastic Lab Containers</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Plastic Lab Containers?</h3>
...
export default PlasticLabContainers;

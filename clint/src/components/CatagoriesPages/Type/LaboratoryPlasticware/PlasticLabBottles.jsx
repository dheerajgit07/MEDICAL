...
const PlasticLabBottles = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'PLASTICLABBOTTLES_01',
            name: ' Plastic Lab Bottles Basic',
            category: ' Plastic Lab Bottles',
            description: 'High quality and reliable  Plastic Lab Bottles designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PLASTICLABBOTTLES_01'
        },
        {
            id: 'PLASTICLABBOTTLES_02',
            name: ' Plastic Lab Bottles Premium',
            category: ' Plastic Lab Bottles',
            description: 'Advanced  Plastic Lab Bottles with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICLABBOTTLES_02'
        },
        {
            id: 'PLASTICLABBOTTLES_03',
            name: ' Plastic Lab Bottles Professional',
            category: ' Plastic Lab Bottles',
            description: 'Industry-standard  Plastic Lab Bottles for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICLABBOTTLES_03'
        },
        {
            id: 'PLASTICLABBOTTLES_04',
            name: ' Plastic Lab Bottles Economy',
            category: ' Plastic Lab Bottles',
            description: 'Cost-effective  Plastic Lab Bottles solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICLABBOTTLES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Plastic Lab Bottles</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Plastic Lab Bottles?</h3>
...
export default PlasticLabBottles;

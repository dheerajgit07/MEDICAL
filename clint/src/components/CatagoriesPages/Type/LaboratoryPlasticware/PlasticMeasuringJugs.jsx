...
const PlasticMeasuringJugs = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'PLASTICMEASURINGJUGS_01',
            name: ' Plastic Measuring Jugs Basic',
            category: ' Plastic Measuring Jugs',
            description: 'High quality and reliable  Plastic Measuring Jugs designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PLASTICMEASURINGJUGS_01'
        },
        {
            id: 'PLASTICMEASURINGJUGS_02',
            name: ' Plastic Measuring Jugs Premium',
            category: ' Plastic Measuring Jugs',
            description: 'Advanced  Plastic Measuring Jugs with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICMEASURINGJUGS_02'
        },
        {
            id: 'PLASTICMEASURINGJUGS_03',
            name: ' Plastic Measuring Jugs Professional',
            category: ' Plastic Measuring Jugs',
            description: 'Industry-standard  Plastic Measuring Jugs for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICMEASURINGJUGS_03'
        },
        {
            id: 'PLASTICMEASURINGJUGS_04',
            name: ' Plastic Measuring Jugs Economy',
            category: ' Plastic Measuring Jugs',
            description: 'Cost-effective  Plastic Measuring Jugs solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICMEASURINGJUGS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Plastic Measuring Jugs</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Plastic Measuring Jugs?</h3>
...
export default PlasticMeasuringJugs;

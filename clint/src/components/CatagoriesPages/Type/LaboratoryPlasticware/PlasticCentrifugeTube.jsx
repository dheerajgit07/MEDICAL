...
const PlasticCentrifugeTube = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'PLASTICCENTRIFUGETUBE_01',
            name: ' Plastic Centrifuge Tube Basic',
            category: ' Plastic Centrifuge Tube',
            description: 'High quality and reliable  Plastic Centrifuge Tube designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PLASTICCENTRIFUGETUBE_01'
        },
        {
            id: 'PLASTICCENTRIFUGETUBE_02',
            name: ' Plastic Centrifuge Tube Premium',
            category: ' Plastic Centrifuge Tube',
            description: 'Advanced  Plastic Centrifuge Tube with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICCENTRIFUGETUBE_02'
        },
        {
            id: 'PLASTICCENTRIFUGETUBE_03',
            name: ' Plastic Centrifuge Tube Professional',
            category: ' Plastic Centrifuge Tube',
            description: 'Industry-standard  Plastic Centrifuge Tube for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICCENTRIFUGETUBE_03'
        },
        {
            id: 'PLASTICCENTRIFUGETUBE_04',
            name: ' Plastic Centrifuge Tube Economy',
            category: ' Plastic Centrifuge Tube',
            description: 'Cost-effective  Plastic Centrifuge Tube solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICCENTRIFUGETUBE_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Plastic Centrifuge Tube</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Plastic Centrifuge Tube?</h3>
...
export default PlasticCentrifugeTube;

...
const ConicalMeasures = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'CONICALMEASURES_01',
            name: ' Conical Measures Basic',
            category: ' Conical Measures',
            description: 'High quality and reliable  Conical Measures designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'CONICALMEASURES_01'
        },
        {
            id: 'CONICALMEASURES_02',
            name: ' Conical Measures Premium',
            category: ' Conical Measures',
            description: 'Advanced  Conical Measures with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CONICALMEASURES_02'
        },
        {
            id: 'CONICALMEASURES_03',
            name: ' Conical Measures Professional',
            category: ' Conical Measures',
            description: 'Industry-standard  Conical Measures for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CONICALMEASURES_03'
        },
        {
            id: 'CONICALMEASURES_04',
            name: ' Conical Measures Economy',
            category: ' Conical Measures',
            description: 'Cost-effective  Conical Measures solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CONICALMEASURES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Conical Measures</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Conical Measures?</h3>
...
export default ConicalMeasures;

...
const RacksStands = () => {
    ...
    const mockProducts = [
        {
            id: 'RACKSSTANDS_01',
            name: ' Racks Stands Basic',
            category: ' Racks Stands',
            description: 'High quality and reliable  Racks Stands designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'RACKSSTANDS_02',
            name: ' Racks Stands Premium',
            category: ' Racks Stands',
            description: 'Advanced  Racks Stands with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'RACKSSTANDS_02'
        },
        {
            id: 'RACKSSTANDS_03',
            name: ' Racks Stands Professional',
            category: ' Racks Stands',
            description: 'Industry-standard  Racks Stands for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'RACKSSTANDS_03'
        },
        {
            id: 'RACKSSTANDS_04',
            name: ' Racks Stands Economy',
            category: ' Racks Stands',
            description: 'Cost-effective  Racks Stands solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'RACKSSTANDS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Racks Stands</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Racks Stands?</h3>

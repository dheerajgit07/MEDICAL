...
const GeneralLabware = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'GENERALLABWARE_01',
            name: ' General Labware Basic',
            category: ' General Labware',
            description: 'High quality and reliable  General Labware designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'GENERALLABWARE_01'
        },
        {
            id: 'GENERALLABWARE_02',
            name: ' General Labware Premium',
            category: ' General Labware',
            description: 'Advanced  General Labware with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GENERALLABWARE_02'
        },
        {
            id: 'GENERALLABWARE_03',
            name: ' General Labware Professional',
            category: ' General Labware',
            description: 'Industry-standard  General Labware for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GENERALLABWARE_03'
        },
        {
            id: 'GENERALLABWARE_04',
            name: ' General Labware Economy',
            category: ' General Labware',
            description: 'Cost-effective  General Labware solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GENERALLABWARE_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> General Labware</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  General Labware?</h3>

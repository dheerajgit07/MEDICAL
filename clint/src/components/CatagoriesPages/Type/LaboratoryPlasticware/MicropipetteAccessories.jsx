...
const MicropipetteAccessories = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'MICROPIPETTEACCESSORIES_01',
            name: ' Micropipette Accessories Basic',
            category: ' Micropipette Accessories',
            description: 'High quality and reliable  Micropipette Accessories designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'MICROPIPETTEACCESSORIES_01'
        },
        {
            id: 'MICROPIPETTEACCESSORIES_02',
            name: ' Micropipette Accessories Premium',
            category: ' Micropipette Accessories',
            description: 'Advanced  Micropipette Accessories with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MICROPIPETTEACCESSORIES_02'
        },
        {
            id: 'MICROPIPETTEACCESSORIES_03',
            name: ' Micropipette Accessories Professional',
            category: ' Micropipette Accessories',
            description: 'Industry-standard  Micropipette Accessories for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MICROPIPETTEACCESSORIES_03'
        },
        {
            id: 'MICROPIPETTEACCESSORIES_04',
            name: ' Micropipette Accessories Economy',
            category: ' Micropipette Accessories',
            description: 'Cost-effective  Micropipette Accessories solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MICROPIPETTEACCESSORIES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Micropipette Accessories</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Micropipette Accessories?</h3>
...
export default MicropipetteAccessories;

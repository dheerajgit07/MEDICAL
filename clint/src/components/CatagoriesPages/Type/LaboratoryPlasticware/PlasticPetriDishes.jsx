...
const PlasticPetriDishes = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'PLASTICPETRIDISHES_01',
            name: ' Plastic Petri Dishes Basic',
            category: ' Plastic Petri Dishes',
            description: 'High quality and reliable  Plastic Petri Dishes designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PLASTICPETRIDISHES_01'
        },
        {
            id: 'PLASTICPETRIDISHES_02',
            name: ' Plastic Petri Dishes Premium',
            category: ' Plastic Petri Dishes',
            description: 'Advanced  Plastic Petri Dishes with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICPETRIDISHES_02'
        },
        {
            id: 'PLASTICPETRIDISHES_03',
            name: ' Plastic Petri Dishes Professional',
            category: ' Plastic Petri Dishes',
            description: 'Industry-standard  Plastic Petri Dishes for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICPETRIDISHES_03'
        },
        {
            id: 'PLASTICPETRIDISHES_04',
            name: ' Plastic Petri Dishes Economy',
            category: ' Plastic Petri Dishes',
            description: 'Cost-effective  Plastic Petri Dishes solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICPETRIDISHES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Plastic Petri Dishes</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Plastic Petri Dishes?</h3>
...
export default PlasticPetriDishes;

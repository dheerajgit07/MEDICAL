...
const PlasticFunnelsHolders = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'PLASTICFUNNELSHOLDERS_01',
            name: ' Plastic Funnels Holders Basic',
            category: ' Plastic Funnels Holders',
            description: 'High quality and reliable  Plastic Funnels Holders designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PLASTICFUNNELSHOLDERS_01'
        },
        {
            id: 'PLASTICFUNNELSHOLDERS_02',
            name: ' Plastic Funnels Holders Premium',
            category: ' Plastic Funnels Holders',
            description: 'Advanced  Plastic Funnels Holders with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICFUNNELSHOLDERS_02'
        },
        {
            id: 'PLASTICFUNNELSHOLDERS_03',
            name: ' Plastic Funnels Holders Professional',
            category: ' Plastic Funnels Holders',
            description: 'Industry-standard  Plastic Funnels Holders for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICFUNNELSHOLDERS_03'
        },
        {
            id: 'PLASTICFUNNELSHOLDERS_04',
            name: ' Plastic Funnels Holders Economy',
            category: ' Plastic Funnels Holders',
            description: 'Cost-effective  Plastic Funnels Holders solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICFUNNELSHOLDERS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Plastic Funnels Holders</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Plastic Funnels Holders?</h3>
...
export default PlasticFunnelsHolders;

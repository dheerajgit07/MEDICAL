...
const SlideStorageBoxesAndAccessories = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'SLIDESTORAGEBOXESANDACCESSORIES_01',
            name: ' Slide Storage Boxes And Accessories Basic',
            category: ' Slide Storage Boxes And Accessories',
            description: 'High quality and reliable  Slide Storage Boxes And Accessories designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'SLIDESTORAGEBOXESANDACCESSORIES_01'
        },
        {
            id: 'SLIDESTORAGEBOXESANDACCESSORIES_02',
            name: ' Slide Storage Boxes And Accessories Premium',
            category: ' Slide Storage Boxes And Accessories',
            description: 'Advanced  Slide Storage Boxes And Accessories with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SLIDESTORAGEBOXESANDACCESSORIES_02'
        },
        {
            id: 'SLIDESTORAGEBOXESANDACCESSORIES_03',
            name: ' Slide Storage Boxes And Accessories Professional',
            category: ' Slide Storage Boxes And Accessories',
            description: 'Industry-standard  Slide Storage Boxes And Accessories for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SLIDESTORAGEBOXESANDACCESSORIES_03'
        },
        {
            id: 'SLIDESTORAGEBOXESANDACCESSORIES_04',
            name: ' Slide Storage Boxes And Accessories Economy',
            category: ' Slide Storage Boxes And Accessories',
            description: 'Cost-effective  Slide Storage Boxes And Accessories solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'SLIDESTORAGEBOXESANDACCESSORIES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Slide Storage Boxes And Accessories</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Slide Storage Boxes And Accessories?</h3>
...
export default SlideStorageBoxesAndAccessories;

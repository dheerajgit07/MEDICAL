...
const MicrocentrifugeTubes = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'MICROCENTRIFUGETUBES_01',
            name: ' Microcentrifuge Tubes Basic',
            category: ' Microcentrifuge Tubes',
            description: 'High quality and reliable  Microcentrifuge Tubes designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'MICROCENTRIFUGETUBES_01'
        },
        {
            id: 'MICROCENTRIFUGETUBES_02',
            name: ' Microcentrifuge Tubes Premium',
            category: ' Microcentrifuge Tubes',
            description: 'Advanced  Microcentrifuge Tubes with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MICROCENTRIFUGETUBES_02'
        },
        {
            id: 'MICROCENTRIFUGETUBES_03',
            name: ' Microcentrifuge Tubes Professional',
            category: ' Microcentrifuge Tubes',
            description: 'Industry-standard  Microcentrifuge Tubes for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MICROCENTRIFUGETUBES_03'
        },
        {
            id: 'MICROCENTRIFUGETUBES_04',
            name: ' Microcentrifuge Tubes Economy',
            category: ' Microcentrifuge Tubes',
            description: 'Cost-effective  Microcentrifuge Tubes solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'MICROCENTRIFUGETUBES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Microcentrifuge Tubes</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Microcentrifuge Tubes?</h3>
...
export default MicrocentrifugeTubes;

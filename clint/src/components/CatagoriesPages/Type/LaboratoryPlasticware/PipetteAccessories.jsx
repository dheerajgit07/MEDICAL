...
const PipetteAccessories = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'PIPETTEACCESSORIES_01',
            name: ' Pipette Accessories Basic',
            category: ' Pipette Accessories',
            description: 'High quality and reliable  Pipette Accessories designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PIPETTEACCESSORIES_01'
        },
        {
            id: 'PIPETTEACCESSORIES_02',
            name: ' Pipette Accessories Premium',
            category: ' Pipette Accessories',
            description: 'Advanced  Pipette Accessories with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PIPETTEACCESSORIES_02'
        },
        {
            id: 'PIPETTEACCESSORIES_03',
            name: ' Pipette Accessories Professional',
            category: ' Pipette Accessories',
            description: 'Industry-standard  Pipette Accessories for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PIPETTEACCESSORIES_03'
        },
        {
            id: 'PIPETTEACCESSORIES_04',
            name: ' Pipette Accessories Economy',
            category: ' Pipette Accessories',
            description: 'Cost-effective  Pipette Accessories solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PIPETTEACCESSORIES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Pipette Accessories</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Pipette Accessories?</h3>
...
export default PipetteAccessories;

...
const PlasticLabVials = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'PLASTICLABVIALS_01',
            name: ' Plastic Lab Vials Basic',
            category: ' Plastic Lab Vials',
            description: 'High quality and reliable  Plastic Lab Vials designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PLASTICLABVIALS_01'
        },
        {
            id: 'PLASTICLABVIALS_02',
            name: ' Plastic Lab Vials Premium',
            category: ' Plastic Lab Vials',
            description: 'Advanced  Plastic Lab Vials with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICLABVIALS_02'
        },
        {
            id: 'PLASTICLABVIALS_03',
            name: ' Plastic Lab Vials Professional',
            category: ' Plastic Lab Vials',
            description: 'Industry-standard  Plastic Lab Vials for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICLABVIALS_03'
        },
        {
            id: 'PLASTICLABVIALS_04',
            name: ' Plastic Lab Vials Economy',
            category: ' Plastic Lab Vials',
            description: 'Cost-effective  Plastic Lab Vials solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICLABVIALS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Plastic Lab Vials</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Plastic Lab Vials?</h3>
...
export default PlasticLabVials;

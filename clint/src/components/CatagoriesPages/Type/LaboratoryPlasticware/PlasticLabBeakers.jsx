...
const PlasticLabBeakers = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'PLASTICLABBEAKERS_01',
            name: ' Plastic Lab Beakers Basic',
            category: ' Plastic Lab Beakers',
            description: 'High quality and reliable  Plastic Lab Beakers designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PLASTICLABBEAKERS_01'
        },
        {
            id: 'PLASTICLABBEAKERS_02',
            name: ' Plastic Lab Beakers Premium',
            category: ' Plastic Lab Beakers',
            description: 'Advanced  Plastic Lab Beakers with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICLABBEAKERS_02'
        },
        {
            id: 'PLASTICLABBEAKERS_03',
            name: ' Plastic Lab Beakers Professional',
            category: ' Plastic Lab Beakers',
            description: 'Industry-standard  Plastic Lab Beakers for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICLABBEAKERS_03'
        },
        {
            id: 'PLASTICLABBEAKERS_04',
            name: ' Plastic Lab Beakers Economy',
            category: ' Plastic Lab Beakers',
            description: 'Cost-effective  Plastic Lab Beakers solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PLASTICLABBEAKERS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Plastic Lab Beakers</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Plastic Lab Beakers?</h3>
...
export default PlasticLabBeakers;

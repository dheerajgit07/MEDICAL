...
const CervicalSplints = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'CERVICALSPLINTS_01',
            name: ' Cervical Splints Basic',
            category: ' Cervical Splints',
            description: 'High quality and reliable  Cervical Splints designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'CERVICALSPLINTS_01'
        },
        {
            id: 'CERVICALSPLINTS_02',
            name: ' Cervical Splints Premium',
            category: ' Cervical Splints',
            description: 'Advanced  Cervical Splints with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CERVICALSPLINTS_02'
        },
        {
            id: 'CERVICALSPLINTS_03',
            name: ' Cervical Splints Professional',
            category: ' Cervical Splints',
            description: 'Industry-standard  Cervical Splints for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CERVICALSPLINTS_03'
        },
        {
            id: 'CERVICALSPLINTS_04',
            name: ' Cervical Splints Economy',
            category: ' Cervical Splints',
            description: 'Cost-effective  Cervical Splints solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CERVICALSPLINTS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Cervical Splints</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Cervical Splints?</h3>
...
export default CervicalSplints;

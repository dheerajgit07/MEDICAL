...
const GeneralAids = () => {
    ...
    const mockProducts = [
        {
            id: 'GENERALAIDS_01',
            name: ' General Aids Basic',
            category: ' General Aids',
            description: 'High quality and reliable  General Aids designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'GENERALAIDS_02',
            name: ' General Aids Premium',
            category: ' General Aids',
            description: 'Advanced  General Aids with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GENERALAIDS_02'
        },
        {
            id: 'GENERALAIDS_03',
            name: ' General Aids Professional',
            category: ' General Aids',
            description: 'Industry-standard  General Aids for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GENERALAIDS_03'
        },
        {
            id: 'GENERALAIDS_04',
            name: ' General Aids Economy',
            category: ' General Aids',
            description: 'Cost-effective  General Aids solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'GENERALAIDS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> General Aids</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  General Aids?</h3>

...
const AbdominalSplint = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'ABDOMINALSPLINT_01',
            name: ' Abdominal Splint Basic',
            category: ' Abdominal Splint',
            description: 'High quality and reliable  Abdominal Splint designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'ABDOMINALSPLINT_01'
        },
        {
            id: 'ABDOMINALSPLINT_02',
            name: ' Abdominal Splint Premium',
            category: ' Abdominal Splint',
            description: 'Advanced  Abdominal Splint with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ABDOMINALSPLINT_02'
        },
        {
            id: 'ABDOMINALSPLINT_03',
            name: ' Abdominal Splint Professional',
            category: ' Abdominal Splint',
            description: 'Industry-standard  Abdominal Splint for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ABDOMINALSPLINT_03'
        },
        {
            id: 'ABDOMINALSPLINT_04',
            name: ' Abdominal Splint Economy',
            category: ' Abdominal Splint',
            description: 'Cost-effective  Abdominal Splint solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'ABDOMINALSPLINT_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Abdominal Splint</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Abdominal Splint?</h3>
...
export default AbdominalSplint;

...
const BackSplints = () => {
    ...
    const mockProducts = [
        {
            id: 'BACKSPLINTS_01',
            name: ' Back Splints Basic',
            category: ' Back Splints',
            description: 'High quality and reliable  Back Splints designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'BACKSPLINTS_02',
            name: ' Back Splints Premium',
            category: ' Back Splints',
            description: 'Advanced  Back Splints with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BACKSPLINTS_02'
        },
        {
            id: 'BACKSPLINTS_03',
            name: ' Back Splints Professional',
            category: ' Back Splints',
            description: 'Industry-standard  Back Splints for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BACKSPLINTS_03'
        },
        {
            id: 'BACKSPLINTS_04',
            name: ' Back Splints Economy',
            category: ' Back Splints',
            description: 'Cost-effective  Back Splints solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'BACKSPLINTS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Back Splints</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Back Splints?</h3>

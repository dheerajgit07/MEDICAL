...
const WristElbowSplints = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'WRISTELBOWSPLINTS_01',
            name: ' Wrist Elbow Splints Basic',
            category: ' Wrist Elbow Splints',
            description: 'High quality and reliable  Wrist Elbow Splints designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'WRISTELBOWSPLINTS_01'
        },
        {
            id: 'WRISTELBOWSPLINTS_02',
            name: ' Wrist Elbow Splints Premium',
            category: ' Wrist Elbow Splints',
            description: 'Advanced  Wrist Elbow Splints with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WRISTELBOWSPLINTS_02'
        },
        {
            id: 'WRISTELBOWSPLINTS_03',
            name: ' Wrist Elbow Splints Professional',
            category: ' Wrist Elbow Splints',
            description: 'Industry-standard  Wrist Elbow Splints for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WRISTELBOWSPLINTS_03'
        },
        {
            id: 'WRISTELBOWSPLINTS_04',
            name: ' Wrist Elbow Splints Economy',
            category: ' Wrist Elbow Splints',
            description: 'Cost-effective  Wrist Elbow Splints solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WRISTELBOWSPLINTS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Wrist Elbow Splints</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Wrist Elbow Splints?</h3>
...
export default WristElbowSplints;

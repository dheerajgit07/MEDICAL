...
const Walkers = () => {
    ...
    const mockProducts = [
        {
            ...
            name: ' Walkers Basic',
            category: ' Walkers',
            description: 'High quality and reliable  Walkers designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'WALKERS_02',
            name: ' Walkers Premium',
            category: ' Walkers',
            description: 'Advanced  Walkers with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WALKERS_02'
        },
        {
            id: 'WALKERS_03',
            name: ' Walkers Professional',
            category: ' Walkers',
            description: 'Industry-standard  Walkers for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WALKERS_03'
        },
        {
            id: 'WALKERS_04',
            name: ' Walkers Economy',
            category: ' Walkers',
            description: 'Cost-effective  Walkers solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WALKERS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Walkers</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Walkers?</h3>

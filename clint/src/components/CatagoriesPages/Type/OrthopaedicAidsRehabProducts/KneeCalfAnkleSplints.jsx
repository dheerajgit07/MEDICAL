...
const KneeCalfAnkleSplints = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'KNEECALFANKLESPLINTS_01',
            name: ' Knee Calf Ankle Splints Basic',
            category: ' Knee Calf Ankle Splints',
            description: 'High quality and reliable  Knee Calf Ankle Splints designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'KNEECALFANKLESPLINTS_01'
        },
        {
            id: 'KNEECALFANKLESPLINTS_02',
            name: ' Knee Calf Ankle Splints Premium',
            category: ' Knee Calf Ankle Splints',
            description: 'Advanced  Knee Calf Ankle Splints with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'KNEECALFANKLESPLINTS_02'
        },
        {
            id: 'KNEECALFANKLESPLINTS_03',
            name: ' Knee Calf Ankle Splints Professional',
            category: ' Knee Calf Ankle Splints',
            description: 'Industry-standard  Knee Calf Ankle Splints for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'KNEECALFANKLESPLINTS_03'
        },
        {
            id: 'KNEECALFANKLESPLINTS_04',
            name: ' Knee Calf Ankle Splints Economy',
            category: ' Knee Calf Ankle Splints',
            description: 'Cost-effective  Knee Calf Ankle Splints solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'KNEECALFANKLESPLINTS_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Knee Calf Ankle Splints</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Knee Calf Ankle Splints?</h3>
...
export default KneeCalfAnkleSplints;

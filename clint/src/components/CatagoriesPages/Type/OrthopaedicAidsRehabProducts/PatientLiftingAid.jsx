...
const PatientLiftingAid = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'PATIENTLIFTINGAID_01',
            name: ' Patient Lifting Aid Basic',
            category: ' Patient Lifting Aid',
            description: 'High quality and reliable  Patient Lifting Aid designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PATIENTLIFTINGAID_01'
        },
        {
            id: 'PATIENTLIFTINGAID_02',
            name: ' Patient Lifting Aid Premium',
            category: ' Patient Lifting Aid',
            description: 'Advanced  Patient Lifting Aid with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PATIENTLIFTINGAID_02'
        },
        {
            id: 'PATIENTLIFTINGAID_03',
            name: ' Patient Lifting Aid Professional',
            category: ' Patient Lifting Aid',
            description: 'Industry-standard  Patient Lifting Aid for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PATIENTLIFTINGAID_03'
        },
        {
            id: 'PATIENTLIFTINGAID_04',
            name: ' Patient Lifting Aid Economy',
            category: ' Patient Lifting Aid',
            description: 'Cost-effective  Patient Lifting Aid solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PATIENTLIFTINGAID_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Patient Lifting Aid</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Patient Lifting Aid?</h3>
...
export default PatientLiftingAid;

...
const CervicalTractionKit = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'CERVICALTRACTIONKIT_01',
            name: ' Cervical Traction Kit Basic',
            category: ' Cervical Traction Kit',
            description: 'High quality and reliable  Cervical Traction Kit designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'CERVICALTRACTIONKIT_01'
        },
        {
            id: 'CERVICALTRACTIONKIT_02',
            name: ' Cervical Traction Kit Premium',
            category: ' Cervical Traction Kit',
            description: 'Advanced  Cervical Traction Kit with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CERVICALTRACTIONKIT_02'
        },
        {
            id: 'CERVICALTRACTIONKIT_03',
            name: ' Cervical Traction Kit Professional',
            category: ' Cervical Traction Kit',
            description: 'Industry-standard  Cervical Traction Kit for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CERVICALTRACTIONKIT_03'
        },
        {
            id: 'CERVICALTRACTIONKIT_04',
            name: ' Cervical Traction Kit Economy',
            category: ' Cervical Traction Kit',
            description: 'Cost-effective  Cervical Traction Kit solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'CERVICALTRACTIONKIT_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Cervical Traction Kit</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Cervical Traction Kit?</h3>
...
export default CervicalTractionKit;

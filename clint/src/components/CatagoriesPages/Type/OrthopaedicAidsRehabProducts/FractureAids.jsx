...
const FractureAids = () => {
    ...
    const mockProducts = [
        {
            id: 'FRACTUREAIDS_01',
            name: ' Fracture Aids Basic',
            category: ' Fracture Aids',
            description: 'High quality and reliable  Fracture Aids designed for medical professionals.',
            price: 50.00,
        ...
        {
            id: 'FRACTUREAIDS_02',
            name: ' Fracture Aids Premium',
            category: ' Fracture Aids',
            description: 'Advanced  Fracture Aids with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'FRACTUREAIDS_02'
        },
        {
            id: 'FRACTUREAIDS_03',
            name: ' Fracture Aids Professional',
            category: ' Fracture Aids',
            description: 'Industry-standard  Fracture Aids for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'FRACTUREAIDS_03'
        },
        {
            id: 'FRACTUREAIDS_04',
            name: ' Fracture Aids Economy',
            category: ' Fracture Aids',
            description: 'Cost-effective  Fracture Aids solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'FRACTUREAIDS_04'
        }
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Fracture Aids</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Fracture Aids?</h3>

...
const UnderarmCrutches = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'UNDERARMCRUTCHES_01',
            name: ' Underarm Crutches Basic',
            category: ' Underarm Crutches',
            description: 'High quality and reliable  Underarm Crutches designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'UNDERARMCRUTCHES_01'
        },
        {
            id: 'UNDERARMCRUTCHES_02',
            name: ' Underarm Crutches Premium',
            category: ' Underarm Crutches',
            description: 'Advanced  Underarm Crutches with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'UNDERARMCRUTCHES_02'
        },
        {
            id: 'UNDERARMCRUTCHES_03',
            name: ' Underarm Crutches Professional',
            category: ' Underarm Crutches',
            description: 'Industry-standard  Underarm Crutches for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'UNDERARMCRUTCHES_03'
        },
        {
            id: 'UNDERARMCRUTCHES_04',
            name: ' Underarm Crutches Economy',
            category: ' Underarm Crutches',
            description: 'Cost-effective  Underarm Crutches solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'UNDERARMCRUTCHES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Underarm Crutches</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Underarm Crutches?</h3>
...
export default UnderarmCrutches;

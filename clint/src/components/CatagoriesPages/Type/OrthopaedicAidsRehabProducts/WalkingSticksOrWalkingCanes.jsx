...
const WalkingSticksOrWalkingCanes = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'WALKINGSTICKSORWALKINGCANES_01',
            name: ' Walking Sticks Or Walking Canes Basic',
            category: ' Walking Sticks Or Walking Canes',
            description: 'High quality and reliable  Walking Sticks Or Walking Canes designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'WALKINGSTICKSORWALKINGCANES_01'
        },
        {
            id: 'WALKINGSTICKSORWALKINGCANES_02',
            name: ' Walking Sticks Or Walking Canes Premium',
            category: ' Walking Sticks Or Walking Canes',
            description: 'Advanced  Walking Sticks Or Walking Canes with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WALKINGSTICKSORWALKINGCANES_02'
        },
        {
            id: 'WALKINGSTICKSORWALKINGCANES_03',
            name: ' Walking Sticks Or Walking Canes Professional',
            category: ' Walking Sticks Or Walking Canes',
            description: 'Industry-standard  Walking Sticks Or Walking Canes for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WALKINGSTICKSORWALKINGCANES_03'
        },
        {
            id: 'WALKINGSTICKSORWALKINGCANES_04',
            name: ' Walking Sticks Or Walking Canes Economy',
            category: ' Walking Sticks Or Walking Canes',
            description: 'Cost-effective  Walking Sticks Or Walking Canes solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'WALKINGSTICKSORWALKINGCANES_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Walking Sticks Or Walking Canes</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Walking Sticks Or Walking Canes?</h3>
...
export default WalkingSticksOrWalkingCanes;

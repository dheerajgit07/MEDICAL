...
const PelvicTractionKit = () => {
    const { addToCart } = useCart();
    
    // Mock data
    const mockProducts = [
        {
            id: 'PELVICTRACTIONKIT_01',
            name: ' Pelvic Traction Kit Basic',
            category: ' Pelvic Traction Kit',
            description: 'High quality and reliable  Pelvic Traction Kit designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: 'PELVICTRACTIONKIT_01'
        },
        {
            id: 'PELVICTRACTIONKIT_02',
            name: ' Pelvic Traction Kit Premium',
            category: ' Pelvic Traction Kit',
            description: 'Advanced  Pelvic Traction Kit with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PELVICTRACTIONKIT_02'
        },
        {
            id: 'PELVICTRACTIONKIT_03',
            name: ' Pelvic Traction Kit Professional',
            category: ' Pelvic Traction Kit',
            description: 'Industry-standard  Pelvic Traction Kit for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PELVICTRACTIONKIT_03'
        },
        {
            id: 'PELVICTRACTIONKIT_04',
            name: ' Pelvic Traction Kit Economy',
            category: ' Pelvic Traction Kit',
            description: 'Cost-effective  Pelvic Traction Kit solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: 'PELVICTRACTIONKIT_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4"> Pelvic Traction Kit</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for  Pelvic Traction Kit?</h3>
...
export default PelvicTractionKit;

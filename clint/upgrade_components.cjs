...
function camelToDisplayName(camel) {
...
function processDirectory(dirPath) {
    ...
    for (const item of items) {
        ...
        if (stat.isDirectory()) {
            ...
            const compName = item.replace('.jsx', '');
            const displayName = camelToDisplayName(compName);
...
const ${compName} = () => {
    ...
    const mockProducts = [
        {
            id: '${compName.toUpperCase()}_01',
            name: '${displayName} Basic',
            category: '${displayName}',
            description: 'High quality and reliable ${displayName} designed for medical professionals.',
            price: 50.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
            sku: '${compName.toUpperCase()}_01'
        },
        {
            id: '${compName.toUpperCase()}_02',
            name: '${displayName} Premium',
            category: '${displayName}',
            description: 'Advanced ${displayName} with exceptional precision and durability.',
            price: 120.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: '${compName.toUpperCase()}_02'
        },
        {
            id: '${compName.toUpperCase()}_03',
            name: '${displayName} Professional',
            category: '${displayName}',
            description: 'Industry-standard ${displayName} for hospital environments.',
            price: 85.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: '${compName.toUpperCase()}_03'
        },
        {
            id: '${compName.toUpperCase()}_04',
            name: '${displayName} Economy',
            category: '${displayName}',
            description: 'Cost-effective ${displayName} solution without compromising on quality.',
            price: 35.00,
            image: 'https://via.placeholder.com/300?text=Image+Not+Available',
             sku: '${compName.toUpperCase()}_04'
        }
    ];
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 md:p-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-8 border-l-4 border-blue-600 pl-4">${displayName}</h1>
            ...
            <div className="mt-12 bg-blue-50 p-6 rounded-xl border border-blue-100 flex flex-col md:flex-row items-center justify-between shadow-sm">
                <div>
                    <h3 className="text-xl font-bold text-blue-900 mb-2">Need bulk pricing for ${displayName}?</h3>
...
// Start processing from base dir
processDirectory(baseDir);
console.log('All component files updated successfully with mock products and add-to-cart functionality!');
